...
package com.mypage.user.service.persistence.impl.constants;
...
public class MPUPersistenceConstants {

	public static final String BUNDLE_SYMBOLIC_NAME = "com.mypage.user.service";
