...
/**
 * Provides the base implementation for the mypage user local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.user.service.impl.MypageUserLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.mypage.user.service.impl.MypageUserLocalServiceImpl
 * @generated
 */
public abstract class MypageUserLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MypageUserLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MypageUserLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MypageUserLocalServiceUtil</code>.
	 */
	...
	public MypageUser addMypageUser(MypageUser mypageUser) {
		...
		return mypageUserPersistence.update(mypageUser);
	}
	...
	public MypageUser createMypageUser(long mypageUserId) {
		return mypageUserPersistence.create(mypageUserId);
	}
	...
	public MypageUser deleteMypageUser(long mypageUserId)
		...
		return mypageUserPersistence.remove(mypageUserId);
	}
	...
	public MypageUser deleteMypageUser(MypageUser mypageUser) {
		return mypageUserPersistence.remove(mypageUser);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MypageUser.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return mypageUserPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return mypageUserPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return mypageUserPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return mypageUserPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MypageUser fetchMypageUser(long mypageUserId) {
		return mypageUserPersistence.fetchByPrimaryKey(mypageUserId);
	}
	...
	public MypageUser getMypageUser(long mypageUserId) throws PortalException {
		return mypageUserPersistence.findByPrimaryKey(mypageUserId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(mypageUserLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MypageUser.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("mypageUserId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			mypageUserLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MypageUser.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return mypageUserPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return mypageUserLocalService.deleteMypageUser(
			(MypageUser)persistedModel);
	}

	public BasePersistence<MypageUser> getBasePersistence() {
		return mypageUserPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return mypageUserPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MypageUser> getMypageUsers(int start, int end) {
		return mypageUserPersistence.findAll(start, end);
	}
	...
	public int getMypageUsersCount() {
		return mypageUserPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MypageUserLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		mypageUserLocalService = (MypageUserLocalService)aopProxy;

		_setLocalServiceUtilService(mypageUserLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MypageUserLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = mypageUserPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MypageUserLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, mypageUserLocalService);
		}
	...
	protected MypageUserLocalService mypageUserLocalService;
