...
public class UserRegistrationManagementToolbarDisplayContext extends SearchContainerManagementToolbarDisplayContext {
	public UserRegistrationManagementToolbarDisplayContext(HttpServletRequest httpServletRequest,
		...
		_mvcPath = ParamUtil.getString(liferayPortletRequest, "mvcPath", "/user_registration/list.jsp");
	}
	...
	private String _getAddUrl() {
		...
		if (_getPageType().equals("user_registration")) {
			addPath = "/user_registration/add.jsp";
		}
	...
	private String _getEditUrl() {
		...
		if (_getPageType().equals("user_registration")) {
			editPath = "/user_registration/edit.jsp";
		}
	...
	private String _getImportPagePath() {
		if (_getPageType().equals("user")) {
			return "/user_registration/import.jsp";
		}
	...
	private DropdownItemList _getOrderBy() {
		if (_getPageType().equals("user_registration")) {
			return new DropdownItemList() {
				{
					add(dropdownItem -> {
						dropdownItem.setActive(Objects.equals(getOrderByCol(), "userRegistrationId"));
						dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "userRegistrationId");
						dropdownItem.setLabel(LanguageUtil.get(request, "User Registration ID"));
					});
				}
			};
		}
