...
public class MypageUserControlMenuEntry extends BaseProductNavigationControlMenuEntry
implements ProductNavigationControlMenuEntry {
	...
	public boolean isShow(HttpServletRequest httpServletRequest)
		...
		if(httpServletRequest.getRequestURI().endsWith("mypageUserAdmin/mypageuser")) {
