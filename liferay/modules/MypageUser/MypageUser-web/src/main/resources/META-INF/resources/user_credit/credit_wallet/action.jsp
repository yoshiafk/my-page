...
<%
	...
	CreditWallet creditWalletRow = (CreditWallet) row.getObject();
	String publishText = creditWalletRow.getActive() != 1 ? "Publish" : "Unpublish";
	
%>

<portlet:renderURL var="editExistingURL">
	<portlet:param name="creditWalletId"
		value="<%=String.valueOf(creditWalletRow.getCreditWalletId())%>" />
...
<portlet:actionURL name="/user_credit/update_data" var="deleteURL">
    <portlet:param name="entryId" value="<%= String.valueOf(creditWalletRow.getCreditWalletId()) %>" />
    <portlet:param name="<%= Constants.CMD %>" value="<%= Constants.DELETE %>" />
    <portlet:param name="redirect" value="<%= creditWalletURL %>" />
    <portlet:param name="type" value="creditWallet" />
</portlet:actionURL>

<portlet:actionURL name="/user_credit/update_data" var="setStatusURL">
    <portlet:param name="entryId" value="<%= String.valueOf(creditWalletRow.getCreditWalletId()) %>" />
    <portlet:param name="<%= Constants.CMD %>" value="<%= creditWalletRow.getActive()==1?Constants.REMOVE:Constants.PUBLISH %>" />
    <portlet:param name="redirect" value="<%= creditWalletURL %>" />
    <portlet:param name="type" value="creditWallet" />
</portlet:actionURL>
