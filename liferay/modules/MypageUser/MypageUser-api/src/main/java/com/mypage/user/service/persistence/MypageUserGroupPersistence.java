...
/**
 * The persistence interface for the mypage user group service.
 *
 * <p>
 ...
 * @see MypageUserGroupUtil
 * @generated
 */
@ProviderType
public interface MypageUserGroupPersistence
	extends BasePersistence<MypageUserGroup> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MypageUserGroupUtil} to access the mypage user group persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<MypageUserGroup> mypageUserGroups);
	 ...
	 */
	public java.util.List<MypageUserGroup> findAll();
	 ...
	 */
	public java.util.List<MypageUserGroup> findAll(int start, int end);
	...
	public java.util.List<MypageUserGroup> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<MypageUserGroup>
			orderByComparator);
