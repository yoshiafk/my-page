...
public interface UserRegistrationLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.UserRegistrationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user registration local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserRegistrationLocalServiceUtil} if injection and service tracking are not available.
	 */
	public UserRegistration addUserRegistration(
			JSONObject params, ServiceContext serviceContext)
	...
	public List<UserRegistration> checkExistingUserRegistration(
	...
	public UserRegistration setActive(
