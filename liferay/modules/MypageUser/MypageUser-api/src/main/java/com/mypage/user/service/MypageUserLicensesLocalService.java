...
/**
 * Provides the local service interface for MypageUserLicenses. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MypageUserLicensesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MypageUserLicensesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.MypageUserLicensesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mypage user licenses local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MypageUserLicensesLocalServiceUtil} if injection and service tracking are not available.
	 */
	public MypageUserLicenses addMypageUserLicense(
	...
	public MypageUserLicenses addMypageUserLicenses(
	...
	public MypageUserLicenses createMypageUserLicenses(
	...
	public MypageUserLicenses deleteMypageUserLicenses(
			long mypageUserLicensesId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MypageUserLicenses fetchMypageUserLicenses(
		long mypageUserLicensesId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MypageUserLicenses getMypageUserLicenses(long mypageUserLicensesId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MypageUserLicenses> getMypageUserLicenseses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MypageUserLicenses updateMypageUserLicenses(
		MypageUserLicenses mypageUserLicenses);
