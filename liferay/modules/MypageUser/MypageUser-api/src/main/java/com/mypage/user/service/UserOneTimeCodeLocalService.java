...
/**
 * Provides the local service interface for UserOneTimeCode. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserOneTimeCodeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserOneTimeCodeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.UserOneTimeCodeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user one time code local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserOneTimeCodeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public UserOneTimeCode addUserOneTimeCode(UserOneTimeCode userOneTimeCode);

	public UserOneTimeCode addUserOTP(
	...
	public UserOneTimeCode createUserOneTimeCode(long userOneTimeCodeId);
	...
	public UserOneTimeCode deleteUserOneTimeCode(long userOneTimeCodeId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public UserOneTimeCode deleteUserOneTimeCode(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserOneTimeCode fetchUserOneTimeCode(long userOneTimeCodeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserOneTimeCode getUserOneTimeCode(long userOneTimeCodeId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserOneTimeCode> getUserOneTimeCodes(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserOneTimeCode updateUserOneTimeCode(
		UserOneTimeCode userOneTimeCode);
