...
/**
 * Provides the local service interface for MypageUserGracePeriod. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MypageUserGracePeriodLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MypageUserGracePeriodLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.MypageUserGracePeriodLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mypage user grace period local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MypageUserGracePeriodLocalServiceUtil} if injection and service tracking are not available.
	 */
	public MypageUserGracePeriod addGracePeriod(
