...
/**
 * Provides the local service interface for CreditType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreditTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreditTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.CreditTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the credit type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreditTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CreditType addCreditType(
	...
	public CreditType updateCreditType(
