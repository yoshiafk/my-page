...
/**
 * The base model interface for the MypageUserGroup service. Represents a row in the &quot;MypageUserGroup&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.user.model.impl.MypageUserGroupModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.user.model.impl.MypageUserGroupImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface MypageUserGroupModel
	extends BaseModel<MypageUserGroup>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a mypage user group model instance should use the {@link MypageUserGroup} interface instead.
	 */
