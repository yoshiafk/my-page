...
/**
 * Provides the local service interface for MypageGroupUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MypageGroupUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MypageGroupUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.MypageGroupUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mypage group user local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MypageGroupUserLocalServiceUtil} if injection and service tracking are not available.
	 */
	public MypageGroupUser addGroupUser(
	...
	public MypageGroupUser addMypageGroupUser(MypageGroupUser mypageGroupUser);
	...
	public MypageGroupUser createMypageGroupUser(long mypageGroupUserId);
	...
	public MypageGroupUser deleteMypageGroupUser(long mypageGroupUserId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MypageGroupUser deleteMypageGroupUser(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MypageGroupUser fetchMypageGroupUser(long mypageGroupUserId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MypageGroupUser getMypageGroupUser(long mypageGroupUserId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MypageGroupUser> getMypageGroupUsers(int start, int end);
	...
	public MypageGroupUser removeGroupUser(
			long mypageGroupId, List<Long> mypageUserId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MypageGroupUser updateMypageGroupUser(
		MypageGroupUser mypageGroupUser);
