...
/**
 * The persistence utility for the user registration job exp service. This utility wraps <code>com.mypage.user.service.persistence.impl.UserRegistrationJobExpPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see UserRegistrationJobExpPersistence
 * @generated
 */
public class UserRegistrationJobExpUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(userRegistrationJobExp);
	}
	 ...
	 */
	public static Map<Serializable, UserRegistrationJobExp> fetchByPrimaryKeys(
	 ...
	 */
	public static List<UserRegistrationJobExp> findWithDynamicQuery(
	 ...
	 */
	public static UserRegistrationJobExp update(
		UserRegistrationJobExp userRegistrationJobExp) {

		return getPersistence().update(userRegistrationJobExp);
	}
	...
	public static UserRegistrationJobExp update(
		...
		return getPersistence().update(userRegistrationJobExp, serviceContext);
	}
	 ...
	 */
	public static List<UserRegistrationJobExp> findByUserRegistrationId(
	 ...
	 */
	public static UserRegistrationJobExp findByUserRegistrationId_First(
			long userRegistrationId,
			OrderByComparator<UserRegistrationJobExp> orderByComparator)
		throws com.mypage.user.exception.NoSuchUserRegistrationJobExpException {
	 ...
	 */
	public static UserRegistrationJobExp fetchByUserRegistrationId_First(
		long userRegistrationId,
		OrderByComparator<UserRegistrationJobExp> orderByComparator) {
	 ...
	 * @throws NoSuchUserRegistrationJobExpException if a matching user registration job exp could not be found
	 */
	public static UserRegistrationJobExp findByUserRegistrationId_Last(
			long userRegistrationId,
			OrderByComparator<UserRegistrationJobExp> orderByComparator)
		throws com.mypage.user.exception.NoSuchUserRegistrationJobExpException {
	 ...
	 */
	public static UserRegistrationJobExp fetchByUserRegistrationId_Last(
		long userRegistrationId,
		OrderByComparator<UserRegistrationJobExp> orderByComparator) {
	 ...
	 */
	public static UserRegistrationJobExp[] findByUserRegistrationId_PrevAndNext(
			long userRegistrationJobExpId, long userRegistrationId,
			OrderByComparator<UserRegistrationJobExp> orderByComparator)
		throws com.mypage.user.exception.NoSuchUserRegistrationJobExpException {

		return getPersistence().findByUserRegistrationId_PrevAndNext(
			userRegistrationJobExpId, userRegistrationId, orderByComparator);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(userRegistrationJobExp);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(userRegistrationJobExps);
	}
	 ...
	 */
	public static UserRegistrationJobExp create(long userRegistrationJobExpId) {
		return getPersistence().create(userRegistrationJobExpId);
	}
	 ...
	 * @throws NoSuchUserRegistrationJobExpException if a user registration job exp with the primary key could not be found
	 */
	public static UserRegistrationJobExp remove(long userRegistrationJobExpId)
		throws com.mypage.user.exception.NoSuchUserRegistrationJobExpException {

		return getPersistence().remove(userRegistrationJobExpId);
	}

	public static UserRegistrationJobExp updateImpl(
		UserRegistrationJobExp userRegistrationJobExp) {

		return getPersistence().updateImpl(userRegistrationJobExp);
	}
	 ...
	 * @throws NoSuchUserRegistrationJobExpException if a user registration job exp with the primary key could not be found
	 */
	public static UserRegistrationJobExp findByPrimaryKey(
			long userRegistrationJobExpId)
		throws com.mypage.user.exception.NoSuchUserRegistrationJobExpException {

		return getPersistence().findByPrimaryKey(userRegistrationJobExpId);
	}
	 ...
	 */
	public static UserRegistrationJobExp fetchByPrimaryKey(
		long userRegistrationJobExpId) {

		return getPersistence().fetchByPrimaryKey(userRegistrationJobExpId);
	}
	 ...
	 */
	public static List<UserRegistrationJobExp> findAll() {
	 ...
	 */
	public static List<UserRegistrationJobExp> findAll(int start, int end) {
	...
	public static UserRegistrationJobExpPersistence getPersistence() {
		return _persistence;
	}

	private static volatile UserRegistrationJobExpPersistence _persistence;
