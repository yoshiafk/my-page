...
/**
 * Provides the local service utility for UserRegistrationReference. This utility wraps
 * <code>com.mypage.user.service.impl.UserRegistrationReferenceLocalServiceImpl</code> and
 ...
 * @generated
 */
public class UserRegistrationReferenceLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.user.service.impl.UserRegistrationReferenceLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static UserRegistrationReference addUserRegistrationReference(
			String name, String relation, int age, String address, String phone,
			String job, int year, long userRegistrationId)
		throws PortalException {

		return getService().addUserRegistrationReference(
			name, relation, age, address, phone, job, year, userRegistrationId);
	}
	 ...
	 */
	public static UserRegistrationReference createUserRegistrationReference(
		long userRegistrationReferenceId) {

		return getService().createUserRegistrationReference(
	 ...
	 */
	public static UserRegistrationReference deleteUserRegistrationReference(
			long userRegistrationReferenceId)
		throws PortalException {

		return getService().deleteUserRegistrationReference(
			userRegistrationReferenceId);
	}
	...
	public static UserRegistrationReference fetchUserRegistrationReference(
		long userRegistrationReferenceId) {

		return getService().fetchUserRegistrationReference(
			userRegistrationReferenceId);
	}
	 ...
	 * @throws PortalException if a user registration reference with the primary key could not be found
	 */
	public static UserRegistrationReference getUserRegistrationReference(
			long userRegistrationReferenceId)
		throws PortalException {

		return getService().getUserRegistrationReference(
			userRegistrationReferenceId);
	}
	 ...
	 */
	public static List<UserRegistrationReference> getUserRegistrationReferences(
		int start, int end) {

		return getService().getUserRegistrationReferences(start, end);
	}
	 ...
	 */
	public static int getUserRegistrationReferencesCount() {
		return getService().getUserRegistrationReferencesCount();
	}
	 ...
	 */
	public static UserRegistrationReference updateUserRegistrationReference(
		UserRegistrationReference userRegistrationReference) {

		return getService().updateUserRegistrationReference(
			userRegistrationReference);
	}

	public static UserRegistrationReferenceLocalService getService() {
		return _service;
	}

	private static volatile UserRegistrationReferenceLocalService _service;
