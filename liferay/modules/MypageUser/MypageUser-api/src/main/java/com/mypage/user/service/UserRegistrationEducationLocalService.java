...
/**
 * Provides the local service interface for UserRegistrationEducation. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserRegistrationEducationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserRegistrationEducationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.UserRegistrationEducationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user registration education local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserRegistrationEducationLocalServiceUtil} if injection and service tracking are not available.
	 */
	public UserRegistrationEducation addUserRegistrationEducation(
	...
	public UserRegistrationEducation createUserRegistrationEducation(
	...
	public UserRegistrationEducation deleteUserRegistrationEducation(
			long userRegistrationEducationId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRegistrationEducation fetchUserRegistrationEducation(
		long userRegistrationEducationId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRegistrationEducation getUserRegistrationEducation(
			long userRegistrationEducationId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserRegistrationEducation> getUserRegistrationEducations(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserRegistrationEducation updateUserRegistrationEducation(
		UserRegistrationEducation userRegistrationEducation);
