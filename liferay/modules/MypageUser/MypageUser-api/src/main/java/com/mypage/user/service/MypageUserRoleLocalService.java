...
/**
 * Provides the local service interface for MypageUserRole. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MypageUserRoleLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MypageUserRoleLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.MypageUserRoleLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mypage user role local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MypageUserRoleLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MypageUserRole addMypageUserRole(MypageUserRole mypageUserRole);

	public MypageUserRole addUserRole(String name, int active)
	...
	public MypageUserRole createMypageUserRole(long mypageUserRoleId);
	...
	public MypageUserRole deleteMypageUserRole(long mypageUserRoleId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public MypageUserRole deleteMypageUserRole(MypageUserRole mypageUserRole);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MypageUserRole fetchMypageUserRole(long mypageUserRoleId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MypageUserRole getMypageUserRole(long mypageUserRoleId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MypageUserRole> getMypageUserRoles(int start, int end);
	...
	public MypageUserRole setActive(
			long mypageUserRoleId, int active, ServiceContext serviceContext)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public MypageUserRole updateMypageUserRole(MypageUserRole mypageUserRole);

	public MypageUserRole updateUserRole(
