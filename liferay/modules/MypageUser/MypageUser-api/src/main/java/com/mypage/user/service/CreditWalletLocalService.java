...
/**
 * Provides the local service interface for CreditWallet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CreditWalletLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface CreditWalletLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.CreditWalletLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the credit wallet local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CreditWalletLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public CreditWallet addCreditWallet(
		long creditTypeId, Date dateIssued, Date dateExpired, double amount,
		int active);
	...
	public CreditWallet updateCreditWallet(
		long creditWalletId, long creditTypeId, Date dateIssued,
		Date dateExpired, double amount, int active);
