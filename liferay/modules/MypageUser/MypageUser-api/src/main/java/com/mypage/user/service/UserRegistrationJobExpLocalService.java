...
/**
 * Provides the local service interface for UserRegistrationJobExp. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see UserRegistrationJobExpLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface UserRegistrationJobExpLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.UserRegistrationJobExpLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the user registration job exp local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link UserRegistrationJobExpLocalServiceUtil} if injection and service tracking are not available.
	 */
	public UserRegistrationJobExp addUserRegistrationJobExp(
	...
	public UserRegistrationJobExp createUserRegistrationJobExp(
	...
	public UserRegistrationJobExp deleteUserRegistrationJobExp(
			long userRegistrationJobExpId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRegistrationJobExp fetchUserRegistrationJobExp(
		long userRegistrationJobExpId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public UserRegistrationJobExp getUserRegistrationJobExp(
			long userRegistrationJobExpId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<UserRegistrationJobExp> getUserRegistrationJobExps(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public UserRegistrationJobExp updateUserRegistrationJobExp(
		UserRegistrationJobExp userRegistrationJobExp);
