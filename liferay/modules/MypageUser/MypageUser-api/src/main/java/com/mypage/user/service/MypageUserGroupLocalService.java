...
/**
 * Provides the local service interface for MypageUserGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see MypageUserGroupLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MypageUserGroupLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.user.service.impl.MypageUserGroupLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the mypage user group local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MypageUserGroupLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MypageUserGroup addUserGroup(String name, int active)
	...
	public MypageUserGroup findBymypageUserGroupId(long mypageUserGroupId)
	...
	public MypageUserGroup setActive(
			long mypageUserGroupId, int active, ServiceContext serviceContext)
		throws PortalException;
	...
	public MypageUserGroup updateUserGroup(
