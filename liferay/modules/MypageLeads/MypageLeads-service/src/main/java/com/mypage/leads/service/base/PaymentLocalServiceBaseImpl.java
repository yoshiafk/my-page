 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.leads.service.impl.PaymentLocalServiceImpl}.
 * </p>
 *
 * @author Gositus
 * @see com.mypage.leads.service.impl.PaymentLocalServiceImpl
 * @generated
 */
public abstract class PaymentLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PaymentLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PaymentLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PaymentLocalServiceUtil</code>.
	 */
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return paymentPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public BasePersistence<Payment> getBasePersistence() {
	...
	public void setAopProxy(Object aopProxy) {
		...
		_setLocalServiceUtilService(paymentLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PaymentLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, paymentLocalService);
		}
