...
/**
 * Provides the local service interface for DetailPet. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus
 * @see DetailPetLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DetailPetLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.leads.service.impl.DetailPetLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the detail pet local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DetailPetLocalServiceUtil} if injection and service tracking are not available.
	 */
	public DetailPet addDetail(
	...
	public DetailPet setPetCertificatePhoto(
			long leadsId, long petCerfiticatePhotoFileEntryId)
		throws Exception;

	public DetailPet setPetPhoto(long leadsId, long petPhotoFileEntryId)
		throws Exception;
