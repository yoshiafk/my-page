...
public class CustomerLocalServiceWrapper
	 ...
	 */
	@Override
	public com.mypage.leads.model.Customer addCustomer(
		com.mypage.leads.model.Customer customer) {
	...
	public com.mypage.leads.model.Customer addCustomer(
		...
		return _customerLocalService.addCustomer(
			userId, customerId, data, serviceContext);
	}

	@Override
	public com.mypage.leads.model.Customer addCustomerData(
		long userId, long customerId, java.util.HashMap<String, Object> data,
		com.liferay.portal.kernel.service.ServiceContext serviceContext) {

		return _customerLocalService.addCustomerData(
			userId, customerId, data, serviceContext);
	}
	 ...
	 */
	@Override
	public com.mypage.leads.model.Customer createCustomer(long customerId) {
	 ...
	 */
	@Override
	public com.mypage.leads.model.Customer deleteCustomer(
		com.mypage.leads.model.Customer customer) {
	 ...
	 */
	@Override
	public com.mypage.leads.model.Customer deleteCustomer(long customerId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	@Override
	public com.mypage.leads.model.Customer fetchCustomer(long customerId) {
		return _customerLocalService.fetchCustomer(customerId);
	}

	@Override
	public java.util.List<com.mypage.leads.model.Customer> findByLeadsId(
		long LeadsId) {

		return _customerLocalService.findByLeadsId(LeadsId);
	}

	@Override
	public java.util.List<com.mypage.leads.model.Customer>
		findByLeadsIdAndProductCode(long LeadsId, String ProductCode) {

		return _customerLocalService.findByLeadsIdAndProductCode(
			LeadsId, ProductCode);
	}
	 ...
	 */
	@Override
	public com.mypage.leads.model.Customer getCustomer(long customerId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<com.mypage.leads.model.Customer> getCustomers(
		int start, int end) {
	...
	public void removeCustomerByLeadsId(long LeadsId) {
		_customerLocalService.removeCustomerByLeadsId(LeadsId);
	}

	@Override
	public void removeCustomerByLeadsIdAndProductCode(
		long LeadsId, String ProductCode) {

		_customerLocalService.removeCustomerByLeadsIdAndProductCode(
			LeadsId, ProductCode);
	}
	 ...
	 */
	@Override
	public com.mypage.leads.model.Customer updateCustomer(
		com.mypage.leads.model.Customer customer) {
