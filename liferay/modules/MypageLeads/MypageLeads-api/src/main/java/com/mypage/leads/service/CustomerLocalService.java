...
public interface CustomerLocalService
	...
	public Customer addCustomer(
		long userId, long customerId, JSONObject data,
		ServiceContext serviceContext);

	public Customer addCustomerData(
		long userId, long customerId, HashMap<String, Object> data,
		ServiceContext serviceContext);
	...
	public List<Customer> findByLeadsIdAndProductCode(
