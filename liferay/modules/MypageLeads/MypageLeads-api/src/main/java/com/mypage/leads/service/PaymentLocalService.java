...
public interface PaymentLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.leads.service.impl.PaymentLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the payment local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PaymentLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Payment addPayment(
		long userId, long paymentId, JSONObject data,
	...
	public Payment setActive(long id, int active, ServiceContext serviceContext)
		throws PortalException;
