...
/**
 * Provides the local service interface for DetailSmartactive. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus
 * @see DetailSmartactiveLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DetailSmartactiveLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.leads.service.impl.DetailSmartactiveLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the detail smartactive local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DetailSmartactiveLocalServiceUtil} if injection and service tracking are not available.
	 */
	public DetailSmartactive addDetail(
	...
	public DetailSmartactive addDetailSmartactive(
	...
	public DetailSmartactive createDetailSmartactive(long DetailId);
	...
	public DetailSmartactive deleteDetailSmartactive(
		DetailSmartactive detailSmartactive);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DetailSmartactive deleteDetailSmartactive(long DetailId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DetailSmartactive fetchDetailSmartactive(long DetailId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DetailSmartactive getDetailSmartactive(long DetailId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DetailSmartactive> getDetailSmartactives(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DetailSmartactive updateDetailSmartactive(
		DetailSmartactive detailSmartactive);
