...
/**
 * Provides the local service interface for DetailInternationalTravel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus
 * @see DetailInternationalTravelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DetailInternationalTravelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.leads.service.impl.DetailInternationalTravelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the detail international travel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DetailInternationalTravelLocalServiceUtil} if injection and service tracking are not available.
	 */
	public DetailInternationalTravel addDetail(
		long userId, long detailId, JSONObject data,
		ServiceContext serviceContext);

	public DetailInternationalTravel addDetailData(
		long userId, long detailId, HashMap<String, Object> data,
		ServiceContext serviceContext);
