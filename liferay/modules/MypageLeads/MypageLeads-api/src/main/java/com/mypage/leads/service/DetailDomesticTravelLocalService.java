...
/**
 * Provides the local service interface for DetailDomesticTravel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus
 * @see DetailDomesticTravelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DetailDomesticTravelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.leads.service.impl.DetailDomesticTravelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the detail domestic travel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DetailDomesticTravelLocalServiceUtil} if injection and service tracking are not available.
	 */
	public DetailDomesticTravel addDetail(
