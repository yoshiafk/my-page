...
public class LeadsManagementToolbarDisplayContext extends SearchContainerManagementToolbarDisplayContext {
	private final ThemeDisplay _themeDisplay;
	private final HttpServletRequest _httpServletRequest;
	private String _mvcPath;
	
	// Constructor
	public LeadsManagementToolbarDisplayContext(HttpServletRequest httpServletRequest,
		...
		_mvcPath = ParamUtil.getString(liferayPortletRequest, "mvcPath", "/parents/list.jsp");
	}
	...
	private DropdownItemList _getOrderBy() {
		...
		if (_getPageType().equals("leads")) {
			...
			item.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "LeadsId"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "LeadsId");
				dropdownItem.setLabel(LanguageUtil.get(request, "Leads Id"));
			});
