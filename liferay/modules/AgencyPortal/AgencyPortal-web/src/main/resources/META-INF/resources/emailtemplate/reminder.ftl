	...
	<body>
		<div style="max-width: 800px; margin: 0 auto; font-family: Arial;">
            ...
            <div class="body-email" style="padding: 0 30px 0 40px;">
            	<h2>[Reminder AXA MyPage] ${activity}</h2>

				<p>Hai ${name},</p>
				<p>Anda telah membuat notifikasi reminder AXA MyPage <b>${activity}</b> dengan info sebagai berikut:</p>
		
				<table style="border: none;">
					<tr>
						<th style="text-align: left;">Tanggal</th>
						<#if time != "">
							<td><span style="margin-right: 10px;">:</span><span style="margin-right: 10px;">${date} ${time}</span></td>
						<#else>
							<td><span style="margin-right: 10px;">:</span><span style="margin-right: 10px;">${date}</span></td>
						</#if>
					</tr>
					<#if link != "">
						<tr>
