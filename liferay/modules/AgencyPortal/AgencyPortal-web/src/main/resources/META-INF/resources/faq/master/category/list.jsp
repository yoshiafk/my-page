...
<%
	...
	// Search Container
	SearchContainer entriesSearchContainerFaq = faqDisplayContext.faqCategorySearchContainer();
	...
	String product = "faqCategorySearchContainer";
%>
	...
	<div class="row">
		...
		<div class="col-lg-3">
			<%
				...
				final String _editAgentFaqCategoryURL = editAgentFaqCategoryURL;
			%>
		...
		<div class="col-lg-9">
			<div class="sheet sheet-full">
						...
						<liferay-ui:panel-container extended="false"
							...
							<aui:button-row>
								<aui:button name="search[search_button]" type="reset"
									value="Reset" href="<%=agentFaqCategoryURL%>" primary="true"
									icon="icon-repeat" />
				...
				<clay:management-toolbar supportsBulkActions="<%=true%>"
					searchContainerId="faqCategorySearchContainer"
					displayContext="<%=faqManagementToolbarDisplayContext%>" />
				<!--  MANAGEMENT TOOLBAR -->

				<portlet:resourceURL var="exportFaqCategorysURL">
					<portlet:param name="exportFaqCategory"
						value="exportFaqCategory" />
				</portlet:resourceURL>

				<aui:form action="<%=exportFaqCategorysURL%>" name="fmExport">
				...
				<aui:form action="<%=updateURL%>" name="fm">
					<aui:input name="<%=Constants.CMD%>" type="hidden" />
					<aui:input name="redirect" type="hidden" value="<%=agentFaqCategoryURL%>" />
					<aui:input name="entryIds" type="hidden" />
					<aui:input name="type" type="hidden" value="category" />

					<!-- SEARCH CONTAINER -->
					<liferay-ui:search-container id="faqCategorySearchContainer"
						searchContainer="<%=entriesSearchContainerFaq%>">

						<liferay-ui:search-container-row
							className="com.mypage.agencyportal.model.AgentFAQCategory" 
							modelVar="agentFaqCategory" keyProperty="agentFaqCategoryId">
							...
							<%
								String classInactive = agentFaqCategory.getActive() != 1 ? "status-inactive" : "status-active";
							%>
							...
							<liferay-ui:search-container-column-jsp name="Action"
								align="right" path="/faq/master/category/action.jsp" />
