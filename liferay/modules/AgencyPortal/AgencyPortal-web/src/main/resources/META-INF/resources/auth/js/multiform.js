...
//				app.showNextStep(currentParent, nextParent);
	...
	validateForm: function() {
		...
		// 	if ($("input[name=create_new_password]").valid() &&
		// 		$("input[name=confirm_new_password]").valid() &&
		// 		$("input[name=otp_1]").valid() &&
		// 		$("input[name=otp_2]").valid() &&
		// 		$("input[name=otp_3]").valid() &&
		// 		$("input[name=otp_4]").valid() &&
		// 		$("input[name=otp_5]").valid() &&
		// 		$("input[name=otp_6]").valid()) {} else {
		// 		// just show validation errors, dont post 
		// 		$(".error-text-wrapper").addClass('is-error');
		// 	}
		// });
		// $("#otc-1").on("keyup", function() {
		// 	$(".error-text-wrapper").removeClass('is-error');
		// });
...
//			},
			messages: {
				...
				'password_agen': {
					required: 'Kata Kunci belum diisi',
				},
				'email_forgotpassword': {
				...
				'create_new_password': {
					required: 'Harap isi Kata Kunci',
					equalTo: 'Harap isi Kata Kunci',
					minlength: 'Harap masukkan 8 karakter'
				},
				'confirm_new_password': {
					required: 'Harap isi konfirmasi Kata Kunci',
					equalTo: 'Konfirmasi Kata Kunci tidak sama',
					minlength: 'Harap masukkan 8 karakter'
				},
				'profile_old_password': {
					required: 'Harap isi Kata Kunci',
...
//				},
			...
			errorPlacement: function(error, element) {
				...
				else if (element.attr("name") == "TerminologiKodePromo")
