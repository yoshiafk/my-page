...
public class SalesToolsManagementToolbarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

	// Constructor
	public SalesToolsManagementToolbarDisplayContext(HttpServletRequest httpServletRequest,
		...
		_mvcPath = ParamUtil.getString(liferayPortletRequest, "mvcPath", "/salestools/master/salestools/list.jsp");
	}
	...
	private String _getEditUrl() {
		...
		if (_getPageType().equals("sales_tools")) {
			editPath = "/salestools/master/salestools/edit.jsp";
		}
		if (_getPageType().equals("category")) {
			editPath = "/salestools/master/category/edit.jsp";
		}
		return editPath;
	}
	...
	private DropdownItemList _getOrderBy() {
		if (_getPageType().equals("sales_tools")) {
			...
			dropdownItemList.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "agentSalesToolsId"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "agentSalesToolsId");
				dropdownItem.setLabel(LanguageUtil.get(request, "Sales Tools ID"));
			});
			dropdownItemList.add(dropdownItem -> {
		...
		if (_getPageType().equals("category")) {
			...
			dropdownItemList.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "agentCategorySalesToolsId"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "agentCategorySalesToolsId");
				dropdownItem.setLabel(LanguageUtil.get(request, "Sales Tools Category ID"));
			});
			dropdownItemList.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "category"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "category");
