...
public class AgentFAQManagementToolbarDisplayContext extends SearchContainerManagementToolbarDisplayContext {

	// Constructor
	public AgentFAQManagementToolbarDisplayContext(HttpServletRequest httpServletRequest,
		...
		_mvcPath = ParamUtil.getString(liferayPortletRequest, "mvcPath", "/faq/master/faq/list.jsp");
	}
...
//				});
	...
	private String _getEditUrl() {
		...
		if (_getPageType().equals("faq")) {
			editPath = "/faq/master/faq/edit.jsp";
		}
		if (_getPageType().equals("category")) {
			editPath = "/faq/master/category/edit.jsp";
		}
		return editPath;
	}
	...
	private DropdownItemList _getOrderBy() {
		if (_getPageType().equals("faq")) {
			...
			dropdownItemList.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "agentFaqId"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "agentFaqId");
				dropdownItem.setLabel(LanguageUtil.get(request, "FAQ ID"));
			});
			dropdownItemList.add(dropdownItem -> {
		...
		if (_getPageType().equals("category")) {
			...
			dropdownItemList.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "agentFaqCategoryId"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "agentFaqCategoryId");
				dropdownItem.setLabel(LanguageUtil.get(request, "FAQ Category ID"));
			});
			dropdownItemList.add(dropdownItem -> {
				dropdownItem.setActive(Objects.equals(getOrderByCol(), "category"));
				dropdownItem.setHref(_getCurrentSortingURL(), "orderByCol", "category");
