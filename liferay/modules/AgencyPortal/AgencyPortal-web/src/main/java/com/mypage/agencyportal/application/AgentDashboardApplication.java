...
@Component(
	property = {
		JaxrsWhiteboardConstants.JAX_RS_APPLICATION_BASE + "=/dashboard",
		JaxrsWhiteboardConstants.JAX_RS_NAME + "=AgentDashboard.Rest",
		"auth.verifier.guest.allowed=true",
		"liferay.access.control.disable=true"
	},
	service = Application.class
)
public class AgentDashboardApplication extends Application {
