...
@Component(
	property = {
		JaxrsWhiteboardConstants.JAX_RS_APPLICATION_BASE + "=/sales-tools",
		JaxrsWhiteboardConstants.JAX_RS_NAME + "=SalesTools.Rest",
		"auth.verifier.guest.allowed=true",
		"liferay.access.control.disable=true"
	},
	service = Application.class
)
public class SalesToolsApplication extends Application {
