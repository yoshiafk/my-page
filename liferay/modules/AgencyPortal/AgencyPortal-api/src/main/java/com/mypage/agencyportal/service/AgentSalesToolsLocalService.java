...
/**
 * Provides the local service interface for AgentSalesTools. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see AgentSalesToolsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgentSalesToolsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.agencyportal.service.impl.AgentSalesToolsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agent sales tools local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgentSalesToolsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AgentSalesTools addSalesTools(
	...
	public List<AgentSalesTools> findByFilter(
	...
	public AgentSalesTools setActive(
			long agentSalesToolsId, int active, ServiceContext serviceContext)
		throws PortalException;
	...
	public AgentSalesTools updateSalesTools(
