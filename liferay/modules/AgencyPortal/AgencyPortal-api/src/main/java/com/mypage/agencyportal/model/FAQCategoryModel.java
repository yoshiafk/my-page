...
/**
 * The base model interface for the FAQCategory service. Represents a row in the &quot;AP_FAQCategory&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.agencyportal.model.impl.FAQCategoryModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.agencyportal.model.impl.FAQCategoryImpl</code>.
 * </p>
 *
 * @author Gositus Team
 * @see FAQCategory
 ...
 */
@ProviderType
public interface FAQCategoryModel
	extends BaseModel<FAQCategory>, GroupedModel, ShardedModel, TrashedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a faq category model instance should use the {@link FAQCategory} interface instead.
	 */
