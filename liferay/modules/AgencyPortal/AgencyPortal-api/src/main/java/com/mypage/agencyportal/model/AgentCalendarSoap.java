...
/**
 * This class is used by SOAP remote services, specifically {@link com.mypage.agencyportal.service.http.AgentCalendarServiceSoap}.
 *
 * @author Gositus Team
 ...
 */
@Deprecated
public class AgentCalendarSoap implements Serializable {

	public static AgentCalendarSoap toSoapModel(AgentCalendar model) {
		AgentCalendarSoap soapModel = new AgentCalendarSoap();
	...
	public static AgentCalendarSoap[] toSoapModels(AgentCalendar[] models) {
		AgentCalendarSoap[] soapModels = new AgentCalendarSoap[models.length];
	...
	public static AgentCalendarSoap[][] toSoapModels(AgentCalendar[][] models) {
		AgentCalendarSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new AgentCalendarSoap[models.length][models[0].length];
		}
		else {
			soapModels = new AgentCalendarSoap[0][0];
		}
	...
	public static AgentCalendarSoap[] toSoapModels(List<AgentCalendar> models) {
		List<AgentCalendarSoap> soapModels = new ArrayList<AgentCalendarSoap>(
			models.size());

		for (AgentCalendar model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new AgentCalendarSoap[soapModels.size()]);
	}

	public AgentCalendarSoap() {
	}
