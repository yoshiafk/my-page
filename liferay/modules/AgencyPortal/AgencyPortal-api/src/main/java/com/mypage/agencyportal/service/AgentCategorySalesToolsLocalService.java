...
/**
 * Provides the local service interface for AgentCategorySalesTools. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see AgentCategorySalesToolsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgentCategorySalesToolsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.agencyportal.service.impl.AgentCategorySalesToolsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agent category sales tools local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgentCategorySalesToolsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AgentCategorySalesTools addCategorySalesTools(
	...
	public AgentCategorySalesTools setActive(
	...
	public AgentCategorySalesTools updateCategorySalesTools(
