...
/**
 * The base model interface for the AgentToken service. Represents a row in the &quot;AP_AgentToken&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.agencyportal.model.impl.AgentTokenModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.agencyportal.model.impl.AgentTokenImpl</code>.
 * </p>
 *
 * @author Gositus Team
 * @see AgentToken
 ...
 */
@ProviderType
public interface AgentTokenModel
	extends BaseModel<AgentToken>, GroupedModel, ShardedModel, TrashedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a agent token model instance should use the {@link AgentToken} interface instead.
	 */
