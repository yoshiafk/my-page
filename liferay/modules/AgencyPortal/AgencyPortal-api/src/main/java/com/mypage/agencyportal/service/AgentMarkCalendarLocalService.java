...
/**
 * Provides the local service interface for AgentMarkCalendar. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see AgentMarkCalendarLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgentMarkCalendarLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.agencyportal.service.impl.AgentMarkCalendarLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agent mark calendar local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgentMarkCalendarLocalServiceUtil} if injection and service tracking are not available.
	 */
