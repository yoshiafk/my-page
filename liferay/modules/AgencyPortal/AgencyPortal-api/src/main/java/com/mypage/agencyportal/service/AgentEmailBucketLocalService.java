...
/**
 * Provides the local service interface for AgentEmailBucket. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see AgentEmailBucketLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgentEmailBucketLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.agencyportal.service.impl.AgentEmailBucketLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agent email bucket local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgentEmailBucketLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AgentEmailBucket addEmailBucket(
	...
	public AgentEmailBucket setStatus(
