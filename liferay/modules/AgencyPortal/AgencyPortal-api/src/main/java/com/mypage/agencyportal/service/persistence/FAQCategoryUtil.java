...
/**
 * The persistence utility for the faq category service. This utility wraps <code>com.mypage.agencyportal.service.persistence.impl.FAQCategoryPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class FAQCategoryUtil {
	 ...
	 */
	public static Map<Serializable, FAQCategory> fetchByPrimaryKeys(
	 ...
	 */
	public static FAQCategory update(
		FAQCategory faqCategory, ServiceContext serviceContext) {
	 ...
	 */
	public static FAQCategory create(long faqCategoryId) {
		return getPersistence().create(faqCategoryId);
	}
	 ...
	 */
	public static FAQCategory remove(long faqCategoryId)
		throws com.mypage.agencyportal.exception.NoSuchFAQCategoryException {

		return getPersistence().remove(faqCategoryId);
	}
	 ...
	 * @throws NoSuchFAQCategoryException if a faq category with the primary key could not be found
	 */
	public static FAQCategory findByPrimaryKey(long faqCategoryId)
		throws com.mypage.agencyportal.exception.NoSuchFAQCategoryException {

		return getPersistence().findByPrimaryKey(faqCategoryId);
	}
	 ...
	 */
	public static FAQCategory fetchByPrimaryKey(long faqCategoryId) {
		return getPersistence().fetchByPrimaryKey(faqCategoryId);
	}
	...
	private static volatile FAQCategoryPersistence _persistence;
