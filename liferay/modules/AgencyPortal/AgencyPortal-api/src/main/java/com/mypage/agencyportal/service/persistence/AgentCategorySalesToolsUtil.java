...
/**
 * The persistence utility for the agent category sales tools service. This utility wraps <code>com.mypage.agencyportal.service.persistence.impl.AgentCategorySalesToolsPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author Gositus Team
 * @see AgentCategorySalesToolsPersistence
 * @generated
 */
public class AgentCategorySalesToolsUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(agentCategorySalesTools);
	}
	 ...
	 */
	public static Map<Serializable, AgentCategorySalesTools> fetchByPrimaryKeys(
	 ...
	 */
	public static List<AgentCategorySalesTools> findWithDynamicQuery(
	 ...
	 */
	public static AgentCategorySalesTools update(
		AgentCategorySalesTools agentCategorySalesTools) {

		return getPersistence().update(agentCategorySalesTools);
	}
	...
	public static AgentCategorySalesTools update(
		...
		return getPersistence().update(agentCategorySalesTools, serviceContext);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(agentCategorySalesTools);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(agentCategorySalesToolses);
	}
	 ...
	 */
	public static AgentCategorySalesTools create(
		long agentCategorySalesToolsId) {

		return getPersistence().create(agentCategorySalesToolsId);
	}
	 ...
	 */
	public static AgentCategorySalesTools remove(long agentCategorySalesToolsId)
		throws com.mypage.agencyportal.exception.
			NoSuchAgentCategorySalesToolsException {

		return getPersistence().remove(agentCategorySalesToolsId);
	}

	public static AgentCategorySalesTools updateImpl(
		AgentCategorySalesTools agentCategorySalesTools) {

		return getPersistence().updateImpl(agentCategorySalesTools);
	}
	 ...
	 * @throws NoSuchAgentCategorySalesToolsException if a agent category sales tools with the primary key could not be found
	 */
	public static AgentCategorySalesTools findByPrimaryKey(
			long agentCategorySalesToolsId)
		throws com.mypage.agencyportal.exception.
			NoSuchAgentCategorySalesToolsException {

		return getPersistence().findByPrimaryKey(agentCategorySalesToolsId);
	}
	 ...
	 */
	public static AgentCategorySalesTools fetchByPrimaryKey(
		long agentCategorySalesToolsId) {

		return getPersistence().fetchByPrimaryKey(agentCategorySalesToolsId);
	}
	 ...
	 */
	public static List<AgentCategorySalesTools> findAll() {
	 ...
	 */
	public static List<AgentCategorySalesTools> findAll(int start, int end) {
	...
	public static AgentCategorySalesToolsPersistence getPersistence() {
		return _persistence;
	}

	private static volatile AgentCategorySalesToolsPersistence _persistence;
