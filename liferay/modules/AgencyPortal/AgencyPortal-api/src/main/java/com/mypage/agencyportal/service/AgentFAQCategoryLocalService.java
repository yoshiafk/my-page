...
/**
 * Provides the local service interface for AgentFAQCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see AgentFAQCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AgentFAQCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.agencyportal.service.impl.AgentFAQCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the agent faq category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AgentFAQCategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AgentFAQCategory addFaqCategory(String category, int active)
	...
	public AgentFAQCategory setActive(
			long agentFaqCategoryId, int active, ServiceContext serviceContext)
		throws PortalException;
	...
	public AgentFAQCategory updateFaqCategory(
