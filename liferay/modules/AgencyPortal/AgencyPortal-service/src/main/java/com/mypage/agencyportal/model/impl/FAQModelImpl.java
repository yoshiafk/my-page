...
import com.mypage.agencyportal.model.FAQModel;
...
/**
 * The base model implementation for the FAQ service. Represents a row in the &quot;AP_FAQ&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class FAQModelImpl extends BaseModelImpl<FAQ> implements FAQModel {
	 ...
	 */
	public static final String TABLE_NAME = "AP_FAQ";

	public static final Object[][] TABLE_COLUMNS = {
		{"faqId", Types.BIGINT}, {"title", Types.VARCHAR},
	...
	public static final String TABLE_SQL_CREATE =
		"create table AP_FAQ (faqId LONG not null primary key,title VARCHAR(75) null,description VARCHAR(75) null,categoryId LONG,category VARCHAR(75) null,active_ INTEGER,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null)";

	public static final String TABLE_SQL_DROP = "drop table AP_FAQ";

	public static final String ORDER_BY_JPQL = " ORDER BY faq.faqId ASC";

	public static final String ORDER_BY_SQL = " ORDER BY AP_FAQ.faqId ASC";
	 ...
	 */
	@Deprecated
	public static final long FAQID_COLUMN_BITMASK = 2L;
	...
	static {
		...
		attributeGetterFunctions.put("categoryId", FAQ::getCategoryId);
		attributeSetterBiConsumers.put(
			"categoryId", (BiConsumer<FAQ, Long>)FAQ::setCategoryId);
		attributeGetterFunctions.put("category", FAQ::getCategory);
		attributeSetterBiConsumers.put(
			"category", (BiConsumer<FAQ, String>)FAQ::setCategory);
		attributeGetterFunctions.put("active", FAQ::getActive);
		attributeSetterBiConsumers.put(
			"active", (BiConsumer<FAQ, Integer>)FAQ::setActive);
	...
	public Object clone() {
		...
		faqImpl.setCategoryId(getCategoryId());
		faqImpl.setCategory(getCategory());
		faqImpl.setActive(getActive());
	...
	public CacheModel<FAQ> toCacheModel() {
		...
		faqCacheModel.categoryId = getCategoryId();

		faqCacheModel.category = getCategory();

		String category = faqCacheModel.category;

		if ((category != null) && (category.length() == 0)) {
			faqCacheModel.category = null;
		}

		faqCacheModel.active = getActive();
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<FAQ, Object>> entry :
			...
			Object value = attributeGetterFunction.apply((FAQ)this);
	...
	public <T> T getColumnValue(String columnName) {
		...
		Function<FAQ, Object> function = _attributeGetterFunctions.get(
			columnName);
		...
		return (T)function.apply((FAQ)this);
	}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("faqId", _faqId);
