$(document).ready(function () {
          ...
          if (response.Status) {
            if (response.Data.Calculation.AvailablePlans.length > 0) {
              ...
              response.Data.Calculation.AvailablePlans.forEach((plan) => {
                ...
                if (currency === "USD") {
                  formattedAmount = plan.TotalMainBenefitPremium.toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD",
                  });
                  ...
                  let fullBenefitAmount = plan.TotalMainBenefitPremium + plan.TotalAdditionalBenefitPremiumAllChecked;
                  ...
                  formattedConvertAmount = plan.TotalMainBenefitPremiumInIDR.toLocaleString("id-ID", {
                    style: "currency",
                    currency: "IDR",
                    minimumFractionDigits: 0,
                    maximumFractionDigits: 0,
                  ...
                  let fullBenefitAmountInIDR = plan.TotalMainBenefitPremiumInIDR + plan.TotalAdditionalBenefitPremiumAllCheckedInIDR;
  ...
  $('input[name="Currency"]').on("change", function () {
    ...
    $.ajax({
      url: _apiURL + "/o/api/sti/compareplan",
      type: "GET",
      success: function (response) {
