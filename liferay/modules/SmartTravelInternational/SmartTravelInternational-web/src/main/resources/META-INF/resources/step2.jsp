														...
														<div class="mt-4level w-400px">
															...
															<div id="travel-type-wrapper" class="position-relative">
															    ...
															    <div class="display-inline-flex align-items-center align-self-center it-purchase_before_departs_container">
															    	...
															    	<label for="it-purchase-before-departs-checkbox" class="mb-0 it-purchase-before-departs-label"><span>Anda harus membeli asuransi sebelum berangkat dari Indonesia</span><span class="agency__text-axa-sienna-400 agency__text-xs">*</span></label>
															    </div>
														</div>
