...
import com.mypage.admin.product.service.TravelDomesticRelationshipLocalService;
import com.mypage.admin.product.service.TravelDomesticRelationshipLocalServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic relationship local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticRelationshipLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticRelationshipLocalServiceImpl
 * @generated
 */
public abstract class TravelDomesticRelationshipLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticRelationshipLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticRelationshipLocalServiceUtil</code>.
	 */
	...
	@Override
	public TravelDomesticRelationship addTravelDomesticRelationship(
		TravelDomesticRelationship travelDomesticRelationship) {

		travelDomesticRelationship.setNew(true);

		return travelDomesticRelationshipPersistence.update(
	...
	public TravelDomesticRelationship createTravelDomesticRelationship(
		long travelDomesticRelationshipId) {

		return travelDomesticRelationshipPersistence.create(
	...
	@Override
	public TravelDomesticRelationship deleteTravelDomesticRelationship(
			long travelDomesticRelationshipId)
		throws PortalException {

		return travelDomesticRelationshipPersistence.remove(
			travelDomesticRelationshipId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelDomesticRelationship.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDomesticRelationshipPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDomesticRelationshipPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TravelDomesticRelationship fetchTravelDomesticRelationship(
		long travelDomesticRelationshipId) {

		return travelDomesticRelationshipPersistence.fetchByPrimaryKey(
			travelDomesticRelationshipId);
	}
	 ...
	 */
	@Override
	public TravelDomesticRelationship getTravelDomesticRelationship(
			long travelDomesticRelationshipId)
		throws PortalException {

		return travelDomesticRelationshipPersistence.findByPrimaryKey(
			travelDomesticRelationshipId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelDomesticRelationship.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TravelDomesticRelationship.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelDomesticRelationshipLocalService.
			deleteTravelDomesticRelationship(
				(TravelDomesticRelationship)persistedModel);
	}

	public BasePersistence<TravelDomesticRelationship> getBasePersistence() {
		return travelDomesticRelationshipPersistence;
	}
	 ...
	 */
	@Override
	public List<TravelDomesticRelationship> getTravelDomesticRelationships(
		int start, int end) {

		return travelDomesticRelationshipPersistence.findAll(start, end);
	}
	...
	public int getTravelDomesticRelationshipsCount() {
		return travelDomesticRelationshipPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TravelDomesticRelationship updateTravelDomesticRelationship(
		TravelDomesticRelationship travelDomesticRelationship) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticRelationshipLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticRelationshipLocalService =
			(TravelDomesticRelationshipLocalService)aopProxy;

		_setLocalServiceUtilService(travelDomesticRelationshipLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticRelationshipLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return TravelDomesticRelationship.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelDomesticRelationshipPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticRelationshipLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, travelDomesticRelationshipLocalService);
		}
	...
	protected TravelDomesticRelationshipLocalService
		travelDomesticRelationshipLocalService;
