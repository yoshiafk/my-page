...
import com.mypage.admin.product.service.TravelDomesticPremiLocalService;
...
/**
 * Provides the base implementation for the travel domestic premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticPremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticPremiLocalServiceImpl
 * @generated
 */
public abstract class TravelDomesticPremiLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticPremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticPremiLocalServiceUtil</code>.
	 */
	...
	public TravelDomesticPremi createTravelDomesticPremi(
		long travelDomesticPremiId) {

		return travelDomesticPremiPersistence.create(travelDomesticPremiId);
	}
	...
	@Override
	public TravelDomesticPremi deleteTravelDomesticPremi(
			long travelDomesticPremiId)
		throws PortalException {

		return travelDomesticPremiPersistence.remove(travelDomesticPremiId);
	}
	...
	public TravelDomesticPremi deleteTravelDomesticPremi(
		...
		return travelDomesticPremiPersistence.remove(travelDomesticPremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelDomesticPremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDomesticPremiPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDomesticPremiPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TravelDomesticPremi fetchTravelDomesticPremi(
		long travelDomesticPremiId) {

		return travelDomesticPremiPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public TravelDomesticPremi getTravelDomesticPremi(
			long travelDomesticPremiId)
		throws PortalException {

		return travelDomesticPremiPersistence.findByPrimaryKey(
			travelDomesticPremiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelDomesticPremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return travelDomesticPremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelDomesticPremiLocalService.deleteTravelDomesticPremi(
			(TravelDomesticPremi)persistedModel);
	}

	public BasePersistence<TravelDomesticPremi> getBasePersistence() {
		return travelDomesticPremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return travelDomesticPremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TravelDomesticPremi> getTravelDomesticPremis(
		int start, int end) {

		return travelDomesticPremiPersistence.findAll(start, end);
	}
	...
	public int getTravelDomesticPremisCount() {
		return travelDomesticPremiPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticPremiLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticPremiLocalService =
			(TravelDomesticPremiLocalService)aopProxy;

		_setLocalServiceUtilService(travelDomesticPremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticPremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelDomesticPremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticPremiLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticPremiLocalService);
		}
	...
	protected TravelDomesticPremiLocalService travelDomesticPremiLocalService;
