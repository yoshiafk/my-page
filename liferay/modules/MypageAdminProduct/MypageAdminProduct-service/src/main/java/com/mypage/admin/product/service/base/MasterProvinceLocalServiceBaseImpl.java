...
/**
 * Provides the base implementation for the master province local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterProvinceLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterProvinceLocalServiceImpl
 * @generated
 */
public abstract class MasterProvinceLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterProvinceLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterProvinceLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterProvinceLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterProvince addMasterProvince(MasterProvince masterProvince) {
		masterProvince.setNew(true);

		return masterProvincePersistence.update(masterProvince);
	}
	...
	public MasterProvince createMasterProvince(long masterProvinceId) {
		return masterProvincePersistence.create(masterProvinceId);
	}
	...
	@Override
	public MasterProvince deleteMasterProvince(long masterProvinceId)
		throws PortalException {

		return masterProvincePersistence.remove(masterProvinceId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterProvince deleteMasterProvince(MasterProvince masterProvince) {
		return masterProvincePersistence.remove(masterProvince);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterProvince.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterProvincePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterProvincePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterProvincePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterProvincePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterProvince fetchMasterProvince(long masterProvinceId) {
		return masterProvincePersistence.fetchByPrimaryKey(masterProvinceId);
	}
	 ...
	 */
	@Override
	public MasterProvince getMasterProvince(long masterProvinceId)
		throws PortalException {

		return masterProvincePersistence.findByPrimaryKey(masterProvinceId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterProvinceLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterProvince.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterProvinceId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterProvinceLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterProvince.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterProvincePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterProvinceLocalService.deleteMasterProvince(
			(MasterProvince)persistedModel);
	}

	public BasePersistence<MasterProvince> getBasePersistence() {
		return masterProvincePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterProvincePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterProvince> getMasterProvinces(int start, int end) {
		return masterProvincePersistence.findAll(start, end);
	}
	...
	public int getMasterProvincesCount() {
		return masterProvincePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterProvince updateMasterProvince(MasterProvince masterProvince) {
		return masterProvincePersistence.update(masterProvince);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterProvinceLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterProvinceLocalService = (MasterProvinceLocalService)aopProxy;

		_setLocalServiceUtilService(masterProvinceLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterProvinceLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterProvincePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterProvinceLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterProvinceLocalService);
		}
	...
	protected MasterProvinceLocalService masterProvinceLocalService;
