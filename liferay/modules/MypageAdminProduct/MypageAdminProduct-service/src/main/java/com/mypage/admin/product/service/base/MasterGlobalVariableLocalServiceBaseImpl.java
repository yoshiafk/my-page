...
/**
 * Provides the base implementation for the master global variable local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterGlobalVariableLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterGlobalVariableLocalServiceImpl
 * @generated
 */
public abstract class MasterGlobalVariableLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MasterGlobalVariableLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterGlobalVariableLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterGlobalVariableLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterGlobalVariable addMasterGlobalVariable(
		MasterGlobalVariable masterGlobalVariable) {

		masterGlobalVariable.setNew(true);

		return masterGlobalVariablePersistence.update(masterGlobalVariable);
	}
	...
	public MasterGlobalVariable createMasterGlobalVariable(
		long masterGlobalVariableId) {

		return masterGlobalVariablePersistence.create(masterGlobalVariableId);
	}
	...
	@Override
	public MasterGlobalVariable deleteMasterGlobalVariable(
			long masterGlobalVariableId)
		throws PortalException {

		return masterGlobalVariablePersistence.remove(masterGlobalVariableId);
	}
	...
	public MasterGlobalVariable deleteMasterGlobalVariable(
		...
		return masterGlobalVariablePersistence.remove(masterGlobalVariable);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterGlobalVariable.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterGlobalVariablePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterGlobalVariablePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public MasterGlobalVariable fetchMasterGlobalVariable(
		long masterGlobalVariableId) {

		return masterGlobalVariablePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public MasterGlobalVariable getMasterGlobalVariable(
			long masterGlobalVariableId)
		throws PortalException {

		return masterGlobalVariablePersistence.findByPrimaryKey(
			masterGlobalVariableId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MasterGlobalVariable.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterGlobalVariablePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterGlobalVariableLocalService.deleteMasterGlobalVariable(
			(MasterGlobalVariable)persistedModel);
	}

	public BasePersistence<MasterGlobalVariable> getBasePersistence() {
		return masterGlobalVariablePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterGlobalVariablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterGlobalVariable> getMasterGlobalVariables(
		int start, int end) {

		return masterGlobalVariablePersistence.findAll(start, end);
	}
	...
	public int getMasterGlobalVariablesCount() {
		return masterGlobalVariablePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterGlobalVariable updateMasterGlobalVariable(
		MasterGlobalVariable masterGlobalVariable) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterGlobalVariableLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterGlobalVariableLocalService =
			(MasterGlobalVariableLocalService)aopProxy;

		_setLocalServiceUtilService(masterGlobalVariableLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterGlobalVariableLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				masterGlobalVariablePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterGlobalVariableLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterGlobalVariableLocalService);
		}
	...
	protected MasterGlobalVariableLocalService masterGlobalVariableLocalService;
