...
import com.mypage.admin.product.service.PetPlanService;
import com.mypage.admin.product.service.PetPlanServiceUtil;
...
/**
 * Provides the base implementation for the pet plan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetPlanServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetPlanServiceImpl
 * @generated
 */
public abstract class PetPlanServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PetPlanService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetPlanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetPlanServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetPlanService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		petPlanService = (PetPlanService)aopProxy;

		_setServiceUtilService(petPlanService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetPlanService.class.getName();
	}
	...
	private void _setServiceUtilService(PetPlanService petPlanService) {
		try {
			Field field = PetPlanServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, petPlanService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PetPlanLocalService
		petPlanLocalService;

	protected PetPlanService petPlanService;
