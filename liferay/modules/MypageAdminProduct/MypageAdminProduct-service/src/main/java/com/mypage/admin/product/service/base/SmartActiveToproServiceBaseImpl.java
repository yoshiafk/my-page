...
import com.mypage.admin.product.service.SmartActiveToproService;
import com.mypage.admin.product.service.SmartActiveToproServiceUtil;
...
/**
 * Provides the base implementation for the smart active topro remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveToproServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveToproServiceImpl
 * @generated
 */
public abstract class SmartActiveToproServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartActiveToproService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveToproService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveToproServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveToproService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveToproService = (SmartActiveToproService)aopProxy;

		_setServiceUtilService(smartActiveToproService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveToproService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = smartActiveToproPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		SmartActiveToproService smartActiveToproService) {

		try {
			Field field = SmartActiveToproServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartActiveToproService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveToproLocalService
		smartActiveToproLocalService;

	protected SmartActiveToproService smartActiveToproService;
