...
/**
 * Provides the base implementation for the pet plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetPlanLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetPlanLocalServiceImpl
 * @generated
 */
public abstract class PetPlanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PetPlanLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetPlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetPlanLocalServiceUtil</code>.
	 */
	...
	@Override
	public PetPlan addPetPlan(PetPlan petPlan) {
		petPlan.setNew(true);

		return petPlanPersistence.update(petPlan);
	}
	...
	public PetPlan createPetPlan(long petPlanId) {
		return petPlanPersistence.create(petPlanId);
	}
	...
	@Override
	public PetPlan deletePetPlan(long petPlanId) throws PortalException {
		return petPlanPersistence.remove(petPlanId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PetPlan deletePetPlan(PetPlan petPlan) {
		return petPlanPersistence.remove(petPlan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PetPlan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return petPlanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return petPlanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return petPlanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return petPlanPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PetPlan fetchPetPlan(long petPlanId) {
		return petPlanPersistence.fetchByPrimaryKey(petPlanId);
	}
	 ...
	 */
	@Override
	public PetPlan fetchPetPlanByUuidAndGroupId(String uuid, long groupId) {
		return petPlanPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public PetPlan getPetPlan(long petPlanId) throws PortalException {
		return petPlanPersistence.findByPrimaryKey(petPlanId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(petPlanLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PetPlan.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("petPlanId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PetPlan.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("petPlanId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(
			new ActionableDynamicQuery.PerformActionMethod<PetPlan>() {

				@Override
				public void performAction(PetPlan petPlan)
					throws PortalException {

					StagedModelDataHandlerUtil.exportStagedModel(
						portletDataContext, petPlan);
				}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return petPlanPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return petPlanLocalService.deletePetPlan((PetPlan)persistedModel);
	}

	public BasePersistence<PetPlan> getBasePersistence() {
		return petPlanPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return petPlanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PetPlan> getPetPlansByUuidAndCompanyId(
		String uuid, long companyId) {

		return petPlanPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<PetPlan> getPetPlansByUuidAndCompanyId(
		...
		return petPlanPersistence.findByUuid_C(
	 ...
	 */
	@Override
	public PetPlan getPetPlanByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {

		return petPlanPersistence.findByUUID_G(uuid, groupId);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PetPlan updatePetPlan(PetPlan petPlan) {
		return petPlanPersistence.update(petPlan);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetPlanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		petPlanLocalService = (PetPlanLocalService)aopProxy;

		_setLocalServiceUtilService(petPlanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetPlanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = petPlanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		PetPlanLocalService petPlanLocalService) {

		try {
			Field field = PetPlanLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petPlanLocalService);
		}
	...
	protected PetPlanLocalService petPlanLocalService;
