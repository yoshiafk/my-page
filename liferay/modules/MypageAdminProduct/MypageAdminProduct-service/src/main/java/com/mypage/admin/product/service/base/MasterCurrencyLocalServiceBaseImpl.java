...
/**
 * Provides the base implementation for the master currency local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterCurrencyLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterCurrencyLocalServiceImpl
 * @generated
 */
public abstract class MasterCurrencyLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterCurrencyLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterCurrencyLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterCurrencyLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterCurrency addMasterCurrency(MasterCurrency masterCurrency) {
		masterCurrency.setNew(true);

		return masterCurrencyPersistence.update(masterCurrency);
	}
	...
	public MasterCurrency createMasterCurrency(long currencyId) {
		return masterCurrencyPersistence.create(currencyId);
	}
	...
	@Override
	public MasterCurrency deleteMasterCurrency(long currencyId)
		throws PortalException {

		return masterCurrencyPersistence.remove(currencyId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterCurrency deleteMasterCurrency(MasterCurrency masterCurrency) {
		return masterCurrencyPersistence.remove(masterCurrency);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterCurrency.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterCurrencyPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterCurrencyPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterCurrencyPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterCurrencyPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterCurrency fetchMasterCurrency(long currencyId) {
		return masterCurrencyPersistence.fetchByPrimaryKey(currencyId);
	}
	 ...
	 */
	@Override
	public MasterCurrency getMasterCurrency(long currencyId)
		throws PortalException {

		return masterCurrencyPersistence.findByPrimaryKey(currencyId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterCurrencyLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterCurrency.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterCurrencyLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterCurrency.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterCurrencyPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterCurrencyLocalService.deleteMasterCurrency(
			(MasterCurrency)persistedModel);
	}

	public BasePersistence<MasterCurrency> getBasePersistence() {
		return masterCurrencyPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterCurrencyPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterCurrency> getMasterCurrencies(int start, int end) {
		return masterCurrencyPersistence.findAll(start, end);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterCurrency updateMasterCurrency(MasterCurrency masterCurrency) {
		return masterCurrencyPersistence.update(masterCurrency);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterCurrencyLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterCurrencyLocalService = (MasterCurrencyLocalService)aopProxy;

		_setLocalServiceUtilService(masterCurrencyLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterCurrencyLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterCurrencyPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterCurrencyLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterCurrencyLocalService);
		}
	...
	protected MasterCurrencyLocalService masterCurrencyLocalService;
