...
import com.mypage.admin.product.service.CompanyTypeService;
import com.mypage.admin.product.service.CompanyTypeServiceUtil;
...
/**
 * Provides the base implementation for the company type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.CompanyTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.CompanyTypeServiceImpl
 * @generated
 */
public abstract class CompanyTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CompanyTypeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanyTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CompanyTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanyTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		companyTypeService = (CompanyTypeService)aopProxy;

		_setServiceUtilService(companyTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(CompanyTypeService companyTypeService) {
		try {
			Field field = CompanyTypeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, companyTypeService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.CompanyTypeLocalService
