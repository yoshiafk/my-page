...
import com.mypage.admin.product.service.SmartTravelIntPlanService;
import com.mypage.admin.product.service.SmartTravelIntPlanServiceUtil;
...
/**
 * Provides the base implementation for the smart travel int plan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartTravelIntPlanServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartTravelIntPlanServiceImpl
 * @generated
 */
public abstract class SmartTravelIntPlanServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartTravelIntPlanService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartTravelIntPlanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartTravelIntPlanServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartTravelIntPlanService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartTravelIntPlanService = (SmartTravelIntPlanService)aopProxy;

		_setServiceUtilService(smartTravelIntPlanService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartTravelIntPlanService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = SmartTravelIntPlanServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartTravelIntPlanService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartTravelIntPlanLocalService
		smartTravelIntPlanLocalService;

	protected SmartTravelIntPlanService smartTravelIntPlanService;
