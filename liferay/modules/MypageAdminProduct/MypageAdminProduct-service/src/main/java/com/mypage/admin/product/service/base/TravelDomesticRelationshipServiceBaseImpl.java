...
import com.mypage.admin.product.service.TravelDomesticRelationshipService;
import com.mypage.admin.product.service.TravelDomesticRelationshipServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic relationship remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticRelationshipServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticRelationshipServiceImpl
 * @generated
 */
public abstract class TravelDomesticRelationshipServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticRelationshipService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticRelationshipServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticRelationshipService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticRelationshipService =
			(TravelDomesticRelationshipService)aopProxy;

		_setServiceUtilService(travelDomesticRelationshipService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticRelationshipService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticRelationshipServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticRelationshipService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.TravelDomesticRelationshipLocalService
			travelDomesticRelationshipLocalService;

	protected TravelDomesticRelationshipService
		travelDomesticRelationshipService;
