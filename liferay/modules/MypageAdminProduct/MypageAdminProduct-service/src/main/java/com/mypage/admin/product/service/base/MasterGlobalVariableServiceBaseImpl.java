...
import com.mypage.admin.product.service.MasterGlobalVariableService;
import com.mypage.admin.product.service.MasterGlobalVariableServiceUtil;
...
/**
 * Provides the base implementation for the master global variable remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterGlobalVariableServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterGlobalVariableServiceImpl
 * @generated
 */
public abstract class MasterGlobalVariableServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MasterGlobalVariableService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterGlobalVariableService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterGlobalVariableServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterGlobalVariableService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterGlobalVariableService = (MasterGlobalVariableService)aopProxy;

		_setServiceUtilService(masterGlobalVariableService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterGlobalVariableService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				MasterGlobalVariableServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterGlobalVariableService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterGlobalVariableLocalService
		masterGlobalVariableLocalService;

	protected MasterGlobalVariableService masterGlobalVariableService;
