...
import com.mypage.admin.product.service.BenefitService;
import com.mypage.admin.product.service.BenefitServiceUtil;
...
/**
 * Provides the base implementation for the benefit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BenefitServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BenefitServiceImpl
 * @generated
 */
public abstract class BenefitServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BenefitService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BenefitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BenefitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BenefitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		benefitService = (BenefitService)aopProxy;

		_setServiceUtilService(benefitService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenefitService.class.getName();
	}
	...
	private void _setServiceUtilService(BenefitService benefitService) {
		try {
			Field field = BenefitServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, benefitService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.BenefitLocalService
		benefitLocalService;
