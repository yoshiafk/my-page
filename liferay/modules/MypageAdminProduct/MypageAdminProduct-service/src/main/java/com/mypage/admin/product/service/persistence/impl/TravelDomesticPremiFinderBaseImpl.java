 ...
 * @generated
 */
public abstract class TravelDomesticPremiFinderBaseImpl
	extends BasePersistenceImpl<TravelDomesticPremi> {

	public TravelDomesticPremiFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return travelDomesticPremiPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		TravelDomesticPremiFinderBaseImpl.class);
