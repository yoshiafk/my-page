...
/**
 * Provides the base implementation for the reference number local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.ReferenceNumberLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.ReferenceNumberLocalServiceImpl
 * @generated
 */
public abstract class ReferenceNumberLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ReferenceNumberLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReferenceNumberLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReferenceNumberLocalServiceUtil</code>.
	 */
	...
	public ReferenceNumber addReferenceNumber(ReferenceNumber referenceNumber) {
		...
		return referenceNumberPersistence.update(referenceNumber);
	}
	...
	public ReferenceNumber createReferenceNumber(long referenceNumberId) {
		return referenceNumberPersistence.create(referenceNumberId);
	}
	...
	public ReferenceNumber deleteReferenceNumber(long referenceNumberId)
		...
		return referenceNumberPersistence.remove(referenceNumberId);
	}
	...
	public ReferenceNumber deleteReferenceNumber(
		...
		return referenceNumberPersistence.remove(referenceNumber);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ReferenceNumber.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return referenceNumberPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return referenceNumberPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return referenceNumberPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return referenceNumberPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public ReferenceNumber fetchReferenceNumber(long referenceNumberId) {
		return referenceNumberPersistence.fetchByPrimaryKey(referenceNumberId);
	}
	...
	public ReferenceNumber getReferenceNumber(long referenceNumberId)
		...
		return referenceNumberPersistence.findByPrimaryKey(referenceNumberId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(referenceNumberLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ReferenceNumber.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("referenceNumberId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(ReferenceNumber.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return referenceNumberPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return referenceNumberLocalService.deleteReferenceNumber(
			(ReferenceNumber)persistedModel);
	}

	public BasePersistence<ReferenceNumber> getBasePersistence() {
		return referenceNumberPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return referenceNumberPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ReferenceNumber> getReferenceNumbers(int start, int end) {
		return referenceNumberPersistence.findAll(start, end);
	}
	...
	public int getReferenceNumbersCount() {
		return referenceNumberPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReferenceNumberLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		referenceNumberLocalService = (ReferenceNumberLocalService)aopProxy;

		_setLocalServiceUtilService(referenceNumberLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReferenceNumberLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = referenceNumberPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ReferenceNumberLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, referenceNumberLocalService);
		}
	...
	protected ReferenceNumberLocalService referenceNumberLocalService;
