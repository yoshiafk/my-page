...
/**
 * Provides the base implementation for the smart active benefit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveBenefit addSmartActiveBenefit(
		SmartActiveBenefit smartActiveBenefit) {

		smartActiveBenefit.setNew(true);

		return smartActiveBenefitPersistence.update(smartActiveBenefit);
	}
	...
	public SmartActiveBenefit createSmartActiveBenefit(
		long smartActiveBenefitId) {

		return smartActiveBenefitPersistence.create(smartActiveBenefitId);
	}
	...
	@Override
	public SmartActiveBenefit deleteSmartActiveBenefit(
			long smartActiveBenefitId)
		throws PortalException {

		return smartActiveBenefitPersistence.remove(smartActiveBenefitId);
	}
	...
	public SmartActiveBenefit deleteSmartActiveBenefit(
		...
		return smartActiveBenefitPersistence.remove(smartActiveBenefit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveBenefit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveBenefitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartActiveBenefitPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveBenefitPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartActiveBenefit fetchSmartActiveBenefit(
		long smartActiveBenefitId) {

		return smartActiveBenefitPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SmartActiveBenefit getSmartActiveBenefit(long smartActiveBenefitId)
		throws PortalException {

		return smartActiveBenefitPersistence.findByPrimaryKey(
			smartActiveBenefitId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartActiveBenefit.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartActiveBenefit.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveBenefitPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveBenefitLocalService.deleteSmartActiveBenefit(
			(SmartActiveBenefit)persistedModel);
	}

	public BasePersistence<SmartActiveBenefit> getBasePersistence() {
		return smartActiveBenefitPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveBenefitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartActiveBenefit> getSmartActiveBenefits(int start, int end) {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveBenefit updateSmartActiveBenefit(
		SmartActiveBenefit smartActiveBenefit) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitLocalService =
			(SmartActiveBenefitLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveBenefitLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveBenefitPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitLocalService);
		}
	...
	protected SmartActiveBenefitLocalService smartActiveBenefitLocalService;
