...
import com.mypage.admin.product.service.TravelDomesticPremiService;
import com.mypage.admin.product.service.TravelDomesticPremiServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticPremiServiceImpl
 * @generated
 */
public abstract class TravelDomesticPremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TravelDomesticPremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticPremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		travelDomesticPremiService = (TravelDomesticPremiService)aopProxy;

		_setServiceUtilService(travelDomesticPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = TravelDomesticPremiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticPremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.TravelDomesticPremiLocalService
		travelDomesticPremiLocalService;

	protected TravelDomesticPremiService travelDomesticPremiService;
