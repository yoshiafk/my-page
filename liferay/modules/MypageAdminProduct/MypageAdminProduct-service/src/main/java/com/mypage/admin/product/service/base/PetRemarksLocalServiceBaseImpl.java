...
/**
 * Provides the base implementation for the pet remarks local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetRemarksLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetRemarksLocalServiceImpl
 * @generated
 */
public abstract class PetRemarksLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PetRemarksLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetRemarksLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetRemarksLocalServiceUtil</code>.
	 */
	...
	@Override
	public PetRemarks addPetRemarks(PetRemarks petRemarks) {
		petRemarks.setNew(true);

		return petRemarksPersistence.update(petRemarks);
	}
	...
	public PetRemarks createPetRemarks(long petRemarksId) {
		return petRemarksPersistence.create(petRemarksId);
	}
	...
	@Override
	public PetRemarks deletePetRemarks(long petRemarksId)
		throws PortalException {

		return petRemarksPersistence.remove(petRemarksId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PetRemarks deletePetRemarks(PetRemarks petRemarks) {
		return petRemarksPersistence.remove(petRemarks);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PetRemarks.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return petRemarksPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return petRemarksPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return petRemarksPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return petRemarksPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PetRemarks fetchPetRemarks(long petRemarksId) {
		return petRemarksPersistence.fetchByPrimaryKey(petRemarksId);
	}
	 ...
	 */
	@Override
	public PetRemarks getPetRemarks(long petRemarksId) throws PortalException {
		return petRemarksPersistence.findByPrimaryKey(petRemarksId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(petRemarksLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PetRemarks.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("petRemarksId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			petRemarksLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PetRemarks.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return petRemarksPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return petRemarksLocalService.deletePetRemarks(
			(PetRemarks)persistedModel);
	}

	public BasePersistence<PetRemarks> getBasePersistence() {
		return petRemarksPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return petRemarksPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PetRemarks> getPetRemarkses(int start, int end) {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PetRemarks updatePetRemarks(PetRemarks petRemarks) {
		return petRemarksPersistence.update(petRemarks);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetRemarksLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		petRemarksLocalService = (PetRemarksLocalService)aopProxy;

		_setLocalServiceUtilService(petRemarksLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetRemarksLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = petRemarksPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PetRemarksLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petRemarksLocalService);
		}
	...
	protected PetRemarksLocalService petRemarksLocalService;
