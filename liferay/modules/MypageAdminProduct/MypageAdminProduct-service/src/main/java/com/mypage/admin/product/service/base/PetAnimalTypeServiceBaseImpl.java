...
import com.mypage.admin.product.service.PetAnimalTypeService;
import com.mypage.admin.product.service.PetAnimalTypeServiceUtil;
...
/**
 * Provides the base implementation for the pet animal type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetAnimalTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetAnimalTypeServiceImpl
 * @generated
 */
public abstract class PetAnimalTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PetAnimalTypeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetAnimalTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetAnimalTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetAnimalTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		petAnimalTypeService = (PetAnimalTypeService)aopProxy;

		_setServiceUtilService(petAnimalTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetAnimalTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		PetAnimalTypeService petAnimalTypeService) {

		try {
			Field field = PetAnimalTypeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petAnimalTypeService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PetAnimalTypeLocalService
		petAnimalTypeLocalService;

	protected PetAnimalTypeService petAnimalTypeService;
