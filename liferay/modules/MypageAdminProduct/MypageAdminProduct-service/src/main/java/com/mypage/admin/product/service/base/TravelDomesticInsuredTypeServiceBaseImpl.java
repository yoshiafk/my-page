...
import com.mypage.admin.product.service.TravelDomesticInsuredTypeService;
import com.mypage.admin.product.service.TravelDomesticInsuredTypeServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic insured type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticInsuredTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticInsuredTypeServiceImpl
 * @generated
 */
public abstract class TravelDomesticInsuredTypeServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticInsuredTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticInsuredTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticInsuredTypeService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticInsuredTypeService =
			(TravelDomesticInsuredTypeService)aopProxy;

		_setServiceUtilService(travelDomesticInsuredTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticInsuredTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticInsuredTypeServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticInsuredTypeService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.TravelDomesticInsuredTypeLocalService
			travelDomesticInsuredTypeLocalService;

	protected TravelDomesticInsuredTypeService travelDomesticInsuredTypeService;
