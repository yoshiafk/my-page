...
import com.mypage.admin.product.service.MasterOccupationService;
import com.mypage.admin.product.service.MasterOccupationServiceUtil;
...
/**
 * Provides the base implementation for the master occupation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterOccupationServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterOccupationServiceImpl
 * @generated
 */
public abstract class MasterOccupationServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterOccupationService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterOccupationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterOccupationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterOccupationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterOccupationService = (MasterOccupationService)aopProxy;

		_setServiceUtilService(masterOccupationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterOccupationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		MasterOccupationService masterOccupationService) {

		try {
			Field field = MasterOccupationServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterOccupationService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterOccupationLocalService
		masterOccupationLocalService;

	protected MasterOccupationService masterOccupationService;
