...
import com.mypage.admin.product.service.PersonalAccidentPremiService;
import com.mypage.admin.product.service.PersonalAccidentPremiServiceUtil;
...
/**
 * Provides the base implementation for the personal accident premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PersonalAccidentPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PersonalAccidentPremiServiceImpl
 * @generated
 */
public abstract class PersonalAccidentPremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PersonalAccidentPremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersonalAccidentPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PersonalAccidentPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersonalAccidentPremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		personalAccidentPremiService = (PersonalAccidentPremiService)aopProxy;

		_setServiceUtilService(personalAccidentPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersonalAccidentPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		PersonalAccidentPremiService personalAccidentPremiService) {

		try {
			Field field =
				PersonalAccidentPremiServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, personalAccidentPremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PersonalAccidentPremiLocalService
		personalAccidentPremiLocalService;

	protected PersonalAccidentPremiService personalAccidentPremiService;
