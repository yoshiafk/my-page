...
import com.mypage.admin.product.service.SmartHealthPremiService;
import com.mypage.admin.product.service.SmartHealthPremiServiceUtil;
...
/**
 * Provides the base implementation for the smart health premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthPremiServiceImpl
 * @generated
 */
public abstract class SmartHealthPremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartHealthPremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthPremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartHealthPremiService = (SmartHealthPremiService)aopProxy;

		_setServiceUtilService(smartHealthPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = SmartHealthPremiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartHealthPremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartHealthPremiLocalService
		smartHealthPremiLocalService;

	protected SmartHealthPremiService smartHealthPremiService;
