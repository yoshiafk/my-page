...
import com.mypage.admin.product.service.HealthSmeFacilityLocalService;
import com.mypage.admin.product.service.HealthSmeFacilityLocalServiceUtil;
...
/**
 * Provides the base implementation for the health sme facility local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmeFacilityLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmeFacilityLocalServiceImpl
 * @generated
 */
public abstract class HealthSmeFacilityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthSmeFacilityLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmeFacilityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmeFacilityLocalServiceUtil</code>.
	 */
	...
	public HealthSmeFacility addHealthSmeFacility(
		...
		return healthSmeFacilityPersistence.update(healthSmeFacility);
	}
	...
	public HealthSmeFacility createHealthSmeFacility(long healthSmeFacilityId) {
		return healthSmeFacilityPersistence.create(healthSmeFacilityId);
	}
	...
	public HealthSmeFacility deleteHealthSmeFacility(long healthSmeFacilityId)
		...
		return healthSmeFacilityPersistence.remove(healthSmeFacilityId);
	}
	...
	public HealthSmeFacility deleteHealthSmeFacility(
		...
		return healthSmeFacilityPersistence.remove(healthSmeFacility);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthSmeFacility.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthSmeFacilityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return healthSmeFacilityPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthSmeFacilityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return healthSmeFacilityPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public HealthSmeFacility fetchHealthSmeFacility(long healthSmeFacilityId) {
		return healthSmeFacilityPersistence.fetchByPrimaryKey(
			healthSmeFacilityId);
	}
	...
	public HealthSmeFacility getHealthSmeFacility(long healthSmeFacilityId)
		...
		return healthSmeFacilityPersistence.findByPrimaryKey(
			healthSmeFacilityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			healthSmeFacilityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HealthSmeFacility.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("healthSmeFacilityId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(HealthSmeFacility.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmeFacilityPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return healthSmeFacilityLocalService.deleteHealthSmeFacility(
			(HealthSmeFacility)persistedModel);
	}

	public BasePersistence<HealthSmeFacility> getBasePersistence() {
		return healthSmeFacilityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmeFacilityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<HealthSmeFacility> getHealthSmeFacilities(int start, int end) {
		return healthSmeFacilityPersistence.findAll(start, end);
	}
	...
	public int getHealthSmeFacilitiesCount() {
		return healthSmeFacilityPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmeFacilityLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		healthSmeFacilityLocalService = (HealthSmeFacilityLocalService)aopProxy;

		_setLocalServiceUtilService(healthSmeFacilityLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmeFacilityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				healthSmeFacilityPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		HealthSmeFacilityLocalService healthSmeFacilityLocalService) {

		try {
			Field field =
				HealthSmeFacilityLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, healthSmeFacilityLocalService);
		}
	...
	protected HealthSmeFacilityLocalService healthSmeFacilityLocalService;
