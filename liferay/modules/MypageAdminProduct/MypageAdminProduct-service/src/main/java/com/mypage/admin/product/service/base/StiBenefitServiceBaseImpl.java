...
import com.mypage.admin.product.service.StiBenefitService;
import com.mypage.admin.product.service.StiBenefitServiceUtil;
...
/**
 * Provides the base implementation for the sti benefit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.StiBenefitServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.StiBenefitServiceImpl
 * @generated
 */
public abstract class StiBenefitServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, StiBenefitService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StiBenefitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StiBenefitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StiBenefitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		stiBenefitService = (StiBenefitService)aopProxy;

		_setServiceUtilService(stiBenefitService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StiBenefitService.class.getName();
	}
	...
	private void _setServiceUtilService(StiBenefitService stiBenefitService) {
		try {
			Field field = StiBenefitServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stiBenefitService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.StiBenefitLocalService
		stiBenefitLocalService;

	protected StiBenefitService stiBenefitService;
