...
import com.mypage.admin.product.service.MasterPromoCodeService;
import com.mypage.admin.product.service.MasterPromoCodeServiceUtil;
...
/**
 * Provides the base implementation for the master promo code remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterPromoCodeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterPromoCodeServiceImpl
 * @generated
 */
public abstract class MasterPromoCodeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterPromoCodeService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterPromoCodeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterPromoCodeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterPromoCodeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterPromoCodeService = (MasterPromoCodeService)aopProxy;

		_setServiceUtilService(masterPromoCodeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterPromoCodeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = MasterPromoCodeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterPromoCodeService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterPromoCodeLocalService
		masterPromoCodeLocalService;

	protected MasterPromoCodeService masterPromoCodeService;
