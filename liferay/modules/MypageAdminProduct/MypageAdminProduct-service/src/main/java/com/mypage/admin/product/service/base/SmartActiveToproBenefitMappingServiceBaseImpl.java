...
import com.mypage.admin.product.service.SmartActiveToproBenefitMappingService;
import com.mypage.admin.product.service.SmartActiveToproBenefitMappingServiceUtil;
...
/**
 * Provides the base implementation for the smart active topro benefit mapping remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveToproBenefitMappingServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveToproBenefitMappingServiceImpl
 * @generated
 */
public abstract class SmartActiveToproBenefitMappingServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveToproBenefitMappingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveToproBenefitMappingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveToproBenefitMappingService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveToproBenefitMappingService =
			(SmartActiveToproBenefitMappingService)aopProxy;

		_setServiceUtilService(smartActiveToproBenefitMappingService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveToproBenefitMappingService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartActiveToproBenefitMappingServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, smartActiveToproBenefitMappingService);
		}
	...
	protected SmartActiveToproBenefitMappingService
		smartActiveToproBenefitMappingService;
