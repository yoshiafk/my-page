...
import com.mypage.admin.product.service.SmartTravelIntLinkLocalService;
...
/**
 * Provides the base implementation for the smart travel int link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartTravelIntLinkLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartTravelIntLinkLocalServiceImpl
 * @generated
 */
public abstract class SmartTravelIntLinkLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartTravelIntLinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartTravelIntLinkLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartTravelIntLink addSmartTravelIntLink(
		SmartTravelIntLink smartTravelIntLink) {

		smartTravelIntLink.setNew(true);

		return smartTravelIntLinkPersistence.update(smartTravelIntLink);
	}
	...
	public SmartTravelIntLink createSmartTravelIntLink(
		long smartTravelIntLinkId) {

		return smartTravelIntLinkPersistence.create(smartTravelIntLinkId);
	}
	...
	@Override
	public SmartTravelIntLink deleteSmartTravelIntLink(
			long smartTravelIntLinkId)
		throws PortalException {

		return smartTravelIntLinkPersistence.remove(smartTravelIntLinkId);
	}
	...
	public SmartTravelIntLink deleteSmartTravelIntLink(
		...
		return smartTravelIntLinkPersistence.remove(smartTravelIntLink);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartTravelIntLink.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartTravelIntLinkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartTravelIntLinkPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartTravelIntLinkPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartTravelIntLink fetchSmartTravelIntLink(
		long smartTravelIntLinkId) {

		return smartTravelIntLinkPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SmartTravelIntLink getSmartTravelIntLink(long smartTravelIntLinkId)
		throws PortalException {

		return smartTravelIntLinkPersistence.findByPrimaryKey(
			smartTravelIntLinkId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartTravelIntLink.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartTravelIntLink.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartTravelIntLinkPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartTravelIntLinkLocalService.deleteSmartTravelIntLink(
			(SmartTravelIntLink)persistedModel);
	}

	public BasePersistence<SmartTravelIntLink> getBasePersistence() {
		return smartTravelIntLinkPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartTravelIntLinkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartTravelIntLink> getSmartTravelIntLinks(int start, int end) {
		return smartTravelIntLinkPersistence.findAll(start, end);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartTravelIntLink updateSmartTravelIntLink(
		SmartTravelIntLink smartTravelIntLink) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartTravelIntLinkLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartTravelIntLinkLocalService =
			(SmartTravelIntLinkLocalService)aopProxy;

		_setLocalServiceUtilService(smartTravelIntLinkLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartTravelIntLinkLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartTravelIntLinkPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartTravelIntLinkLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartTravelIntLinkLocalService);
		}
	...
	protected SmartTravelIntLinkLocalService smartTravelIntLinkLocalService;
