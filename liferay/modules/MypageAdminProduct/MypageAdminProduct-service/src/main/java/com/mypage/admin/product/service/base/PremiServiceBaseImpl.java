...
import com.mypage.admin.product.service.PremiService;
import com.mypage.admin.product.service.PremiServiceUtil;
...
/**
 * Provides the base implementation for the premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PremiServiceImpl
 * @generated
 */
public abstract class PremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		premiService = (PremiService)aopProxy;

		_setServiceUtilService(premiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PremiService.class.getName();
	}
	...
	private void _setServiceUtilService(PremiService premiService) {
		try {
			Field field = PremiServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, premiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PremiLocalService
		premiLocalService;

	protected PremiService premiService;
