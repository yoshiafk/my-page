...
import com.mypage.admin.product.service.TravelDomesticBenefitGroupLocalService;
...
/**
 * Provides the base implementation for the travel domestic benefit group local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticBenefitGroupLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticBenefitGroupLocalServiceImpl
 * @generated
 */
public abstract class TravelDomesticBenefitGroupLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticBenefitGroupLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticBenefitGroupLocalServiceUtil</code>.
	 */
	...
	public TravelDomesticBenefitGroup addTravelDomesticBenefitGroup(
		...
		return travelDomesticBenefitGroupPersistence.update(
	...
	public TravelDomesticBenefitGroup createTravelDomesticBenefitGroup(
		...
		return travelDomesticBenefitGroupPersistence.create(
	...
	public TravelDomesticBenefitGroup deleteTravelDomesticBenefitGroup(
		...
		return travelDomesticBenefitGroupPersistence.remove(
			travelDomesticBenefitGroupId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelDomesticBenefitGroup.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDomesticBenefitGroupPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDomesticBenefitGroupPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TravelDomesticBenefitGroup fetchTravelDomesticBenefitGroup(
		...
		return travelDomesticBenefitGroupPersistence.fetchByPrimaryKey(
			travelDomesticBenefitGroupId);
	}
	...
	public TravelDomesticBenefitGroup getTravelDomesticBenefitGroup(
		...
		return travelDomesticBenefitGroupPersistence.findByPrimaryKey(
			travelDomesticBenefitGroupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelDomesticBenefitGroup.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TravelDomesticBenefitGroup.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelDomesticBenefitGroupLocalService.
			deleteTravelDomesticBenefitGroup(
				(TravelDomesticBenefitGroup)persistedModel);
	}

	public BasePersistence<TravelDomesticBenefitGroup> getBasePersistence() {
		return travelDomesticBenefitGroupPersistence;
	}
	...
	public List<TravelDomesticBenefitGroup> getTravelDomesticBenefitGroups(
		...
		return travelDomesticBenefitGroupPersistence.findAll(start, end);
	}
	...
	public int getTravelDomesticBenefitGroupsCount() {
		return travelDomesticBenefitGroupPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticBenefitGroupLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticBenefitGroupLocalService =
			(TravelDomesticBenefitGroupLocalService)aopProxy;

		_setLocalServiceUtilService(travelDomesticBenefitGroupLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticBenefitGroupLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return TravelDomesticBenefitGroup.class;
	}

	protected String getModelClassName() {
		return TravelDomesticBenefitGroup.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelDomesticBenefitGroupPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticBenefitGroupLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, travelDomesticBenefitGroupLocalService);
		}
	...
	protected TravelDomesticBenefitGroupLocalService
		travelDomesticBenefitGroupLocalService;
