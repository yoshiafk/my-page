...
/**
 * Provides the base implementation for the smart active premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActivePremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActivePremiLocalServiceImpl
 * @generated
 */
public abstract class SmartActivePremiLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActivePremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActivePremiLocalServiceUtil</code>.
	 */
	...
	public SmartActivePremi addSmartActivePremi(
		...
		return smartActivePremiPersistence.update(smartActivePremi);
	}
	...
	public SmartActivePremi createSmartActivePremi(long smartActivePremiId) {
		return smartActivePremiPersistence.create(smartActivePremiId);
	}
	...
	public SmartActivePremi deleteSmartActivePremi(long smartActivePremiId)
		...
		return smartActivePremiPersistence.remove(smartActivePremiId);
	}
	...
	public SmartActivePremi deleteSmartActivePremi(
		...
		return smartActivePremiPersistence.remove(smartActivePremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActivePremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActivePremiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartActivePremiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActivePremiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return smartActivePremiPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SmartActivePremi fetchSmartActivePremi(long smartActivePremiId) {
		return smartActivePremiPersistence.fetchByPrimaryKey(
			smartActivePremiId);
	}
	...
	public SmartActivePremi getSmartActivePremi(long smartActivePremiId)
		...
		return smartActivePremiPersistence.findByPrimaryKey(smartActivePremiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartActivePremi.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("smartActivePremiId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartActivePremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartActivePremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActivePremiLocalService.deleteSmartActivePremi(
			(SmartActivePremi)persistedModel);
	}

	public BasePersistence<SmartActivePremi> getBasePersistence() {
		return smartActivePremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartActivePremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActivePremiLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActivePremiLocalService = (SmartActivePremiLocalService)aopProxy;

		_setLocalServiceUtilService(smartActivePremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActivePremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = smartActivePremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActivePremiLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActivePremiLocalService);
		}
	...
	protected SmartActivePremiLocalService smartActivePremiLocalService;
