...
import com.mypage.admin.product.service.JobPositionService;
import com.mypage.admin.product.service.JobPositionServiceUtil;
...
/**
 * Provides the base implementation for the job position remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.JobPositionServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.JobPositionServiceImpl
 * @generated
 */
public abstract class JobPositionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, JobPositionService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JobPositionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JobPositionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JobPositionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		jobPositionService = (JobPositionService)aopProxy;

		_setServiceUtilService(jobPositionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return JobPositionService.class.getName();
	}
	...
	private void _setServiceUtilService(JobPositionService jobPositionService) {
		try {
			Field field = JobPositionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, jobPositionService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.JobPositionLocalService
