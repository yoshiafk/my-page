...
/**
 * Provides the base implementation for the smart health benefit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthBenefitLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthBenefitLocalServiceImpl
 * @generated
 */
public abstract class SmartHealthBenefitLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthBenefitLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthBenefitLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartHealthBenefit addSmartHealthBenefit(
		SmartHealthBenefit smartHealthBenefit) {

		smartHealthBenefit.setNew(true);

		return smartHealthBenefitPersistence.update(smartHealthBenefit);
	}
	...
	public SmartHealthBenefit createSmartHealthBenefit(
		long smartHealthBenefitId) {

		return smartHealthBenefitPersistence.create(smartHealthBenefitId);
	}
	...
	@Override
	public SmartHealthBenefit deleteSmartHealthBenefit(
			long smartHealthBenefitId)
		throws PortalException {

		return smartHealthBenefitPersistence.remove(smartHealthBenefitId);
	}
	...
	public SmartHealthBenefit deleteSmartHealthBenefit(
		...
		return smartHealthBenefitPersistence.remove(smartHealthBenefit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartHealthBenefit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartHealthBenefitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartHealthBenefitPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartHealthBenefitPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartHealthBenefit fetchSmartHealthBenefit(
		long smartHealthBenefitId) {

		return smartHealthBenefitPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SmartHealthBenefit getSmartHealthBenefit(long smartHealthBenefitId)
		throws PortalException {

		return smartHealthBenefitPersistence.findByPrimaryKey(
			smartHealthBenefitId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartHealthBenefit.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartHealthBenefit.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartHealthBenefitPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartHealthBenefitLocalService.deleteSmartHealthBenefit(
			(SmartHealthBenefit)persistedModel);
	}

	public BasePersistence<SmartHealthBenefit> getBasePersistence() {
		return smartHealthBenefitPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartHealthBenefitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartHealthBenefit> getSmartHealthBenefits(int start, int end) {
		return smartHealthBenefitPersistence.findAll(start, end);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartHealthBenefit updateSmartHealthBenefit(
		SmartHealthBenefit smartHealthBenefit) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthBenefitLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartHealthBenefitLocalService =
			(SmartHealthBenefitLocalService)aopProxy;

		_setLocalServiceUtilService(smartHealthBenefitLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthBenefitLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartHealthBenefitPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartHealthBenefitLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartHealthBenefitLocalService);
		}
	...
	protected SmartHealthBenefitLocalService smartHealthBenefitLocalService;
