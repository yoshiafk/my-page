...
import com.mypage.admin.product.service.StiBenefitValueMappingService;
import com.mypage.admin.product.service.StiBenefitValueMappingServiceUtil;
...
/**
 * Provides the base implementation for the sti benefit value mapping remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.StiBenefitValueMappingServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.StiBenefitValueMappingServiceImpl
 * @generated
 */
public abstract class StiBenefitValueMappingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   StiBenefitValueMappingService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StiBenefitValueMappingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StiBenefitValueMappingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StiBenefitValueMappingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		stiBenefitValueMappingService = (StiBenefitValueMappingService)aopProxy;

		_setServiceUtilService(stiBenefitValueMappingService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StiBenefitValueMappingService.class.getName();
	}
	...
	private void _setServiceUtilService(
		StiBenefitValueMappingService stiBenefitValueMappingService) {

		try {
			Field field =
				StiBenefitValueMappingServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, stiBenefitValueMappingService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.StiBenefitValueMappingLocalService
			stiBenefitValueMappingLocalService;

	protected StiBenefitValueMappingService stiBenefitValueMappingService;
