...
import com.mypage.admin.product.service.TravelInternationalPremiService;
import com.mypage.admin.product.service.TravelInternationalPremiServiceUtil;
...
/**
 * Provides the base implementation for the travel international premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelInternationalPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelInternationalPremiServiceImpl
 * @generated
 */
public abstract class TravelInternationalPremiServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelInternationalPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelInternationalPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelInternationalPremiService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		travelInternationalPremiService =
			(TravelInternationalPremiService)aopProxy;

		_setServiceUtilService(travelInternationalPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelInternationalPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelInternationalPremiServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelInternationalPremiService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.TravelInternationalPremiLocalService
			travelInternationalPremiLocalService;

	protected TravelInternationalPremiService travelInternationalPremiService;
