...
/**
 * Provides the base implementation for the travel international premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelInternationalPremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelInternationalPremiLocalServiceImpl
 * @generated
 */
public abstract class TravelInternationalPremiLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelInternationalPremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelInternationalPremiLocalServiceUtil</code>.
	 */
	...
	public TravelInternationalPremi addTravelInternationalPremi(
		...
		return travelInternationalPremiPersistence.update(
	...
	public TravelInternationalPremi createTravelInternationalPremi(
		...
		return travelInternationalPremiPersistence.create(premiId);
	}
	...
	public TravelInternationalPremi deleteTravelInternationalPremi(long premiId)
		...
		return travelInternationalPremiPersistence.remove(premiId);
	}
	...
	public TravelInternationalPremi deleteTravelInternationalPremi(
		...
		return travelInternationalPremiPersistence.remove(
			travelInternationalPremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelInternationalPremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelInternationalPremiPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelInternationalPremiPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TravelInternationalPremi fetchTravelInternationalPremi(
		long premiId) {

		return travelInternationalPremiPersistence.fetchByPrimaryKey(premiId);
	}
	...
	public TravelInternationalPremi getTravelInternationalPremi(long premiId)
		...
		return travelInternationalPremiPersistence.findByPrimaryKey(premiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelInternationalPremi.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("premiId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			TravelInternationalPremi.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("premiId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return travelInternationalPremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelInternationalPremiLocalService.
			deleteTravelInternationalPremi(
				(TravelInternationalPremi)persistedModel);
	}

	public BasePersistence<TravelInternationalPremi> getBasePersistence() {
		return travelInternationalPremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return travelInternationalPremiPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	...
	public List<TravelInternationalPremi> getTravelInternationalPremis(
		...
		return travelInternationalPremiPersistence.findAll(start, end);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelInternationalPremiLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelInternationalPremiLocalService =
			(TravelInternationalPremiLocalService)aopProxy;

		_setLocalServiceUtilService(travelInternationalPremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelInternationalPremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelInternationalPremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelInternationalPremiLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelInternationalPremiLocalService);
		}
	...
	protected TravelInternationalPremiLocalService
		travelInternationalPremiLocalService;
