...
import com.mypage.admin.product.service.MasterCurrencyService;
import com.mypage.admin.product.service.MasterCurrencyServiceUtil;
...
/**
 * Provides the base implementation for the master currency remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterCurrencyServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterCurrencyServiceImpl
 * @generated
 */
public abstract class MasterCurrencyServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterCurrencyService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterCurrencyService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterCurrencyServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterCurrencyService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterCurrencyService = (MasterCurrencyService)aopProxy;

		_setServiceUtilService(masterCurrencyService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterCurrencyService.class.getName();
	}
	...
	private void _setServiceUtilService(
		MasterCurrencyService masterCurrencyService) {

		try {
			Field field = MasterCurrencyServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterCurrencyService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterCurrencyLocalService
		masterCurrencyLocalService;

	protected MasterCurrencyService masterCurrencyService;
