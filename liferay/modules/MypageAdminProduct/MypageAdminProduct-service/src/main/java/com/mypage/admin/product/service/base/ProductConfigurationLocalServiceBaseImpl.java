...
/**
 * Provides the base implementation for the product configuration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.ProductConfigurationLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.ProductConfigurationLocalServiceImpl
 * @generated
 */
public abstract class ProductConfigurationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   ProductConfigurationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductConfigurationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductConfigurationLocalServiceUtil</code>.
	 */
	...
	public ProductConfiguration addProductConfiguration(
		...
		return productConfigurationPersistence.update(productConfiguration);
	}
	...
	public ProductConfiguration createProductConfiguration(long productId) {
		return productConfigurationPersistence.create(productId);
	}
	...
	public ProductConfiguration deleteProductConfiguration(long productId)
		...
		return productConfigurationPersistence.remove(productId);
	}
	...
	public ProductConfiguration deleteProductConfiguration(
		...
		return productConfigurationPersistence.remove(productConfiguration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			ProductConfiguration.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return productConfigurationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return productConfigurationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public ProductConfiguration fetchProductConfiguration(long productId) {
		return productConfigurationPersistence.fetchByPrimaryKey(productId);
	}
	...
	public ProductConfiguration getProductConfiguration(long productId)
		...
		return productConfigurationPersistence.findByPrimaryKey(productId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(ProductConfiguration.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return productConfigurationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return productConfigurationLocalService.deleteProductConfiguration(
			(ProductConfiguration)persistedModel);
	}

	public BasePersistence<ProductConfiguration> getBasePersistence() {
		return productConfigurationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return productConfigurationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProductConfiguration> getProductConfigurations(
		...
		return productConfigurationPersistence.findAll(start, end);
	}
	...
	public int getProductConfigurationsCount() {
		return productConfigurationPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductConfigurationLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		productConfigurationLocalService =
			(ProductConfigurationLocalService)aopProxy;

		_setLocalServiceUtilService(productConfigurationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductConfigurationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				productConfigurationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				ProductConfigurationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, productConfigurationLocalService);
		}
	...
	protected ProductConfigurationLocalService productConfigurationLocalService;
