...
import com.mypage.admin.product.service.TravelDomesticTravellerTypeService;
import com.mypage.admin.product.service.TravelDomesticTravellerTypeServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic traveller type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticTravellerTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticTravellerTypeServiceImpl
 * @generated
 */
public abstract class TravelDomesticTravellerTypeServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticTravellerTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticTravellerTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticTravellerTypeService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticTravellerTypeService =
			(TravelDomesticTravellerTypeService)aopProxy;

		_setServiceUtilService(travelDomesticTravellerTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticTravellerTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticTravellerTypeServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticTravellerTypeService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.TravelDomesticTravellerTypeLocalService
			travelDomesticTravellerTypeLocalService;

	protected TravelDomesticTravellerTypeService
		travelDomesticTravellerTypeService;
