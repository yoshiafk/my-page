...
import com.mypage.admin.product.service.HealthIndividuPlanLocalService;
...
/**
 * Provides the base implementation for the health individu plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthIndividuPlanLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthIndividuPlanLocalServiceImpl
 * @generated
 */
public abstract class HealthIndividuPlanLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthIndividuPlanLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthIndividuPlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthIndividuPlanLocalServiceUtil</code>.
	 */
	...
	@Override
	public HealthIndividuPlan addHealthIndividuPlan(
		HealthIndividuPlan healthIndividuPlan) {

		healthIndividuPlan.setNew(true);

		return healthIndividuPlanPersistence.update(healthIndividuPlan);
	}
	...
	public HealthIndividuPlan createHealthIndividuPlan(
		long healthIndividuPlanId) {

		return healthIndividuPlanPersistence.create(healthIndividuPlanId);
	}
	...
	@Override
	public HealthIndividuPlan deleteHealthIndividuPlan(
			long healthIndividuPlanId)
		throws PortalException {

		return healthIndividuPlanPersistence.remove(healthIndividuPlanId);
	}
	...
	public HealthIndividuPlan deleteHealthIndividuPlan(
		...
		return healthIndividuPlanPersistence.remove(healthIndividuPlan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthIndividuPlan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthIndividuPlanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return healthIndividuPlanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthIndividuPlanPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public HealthIndividuPlan fetchHealthIndividuPlan(
		long healthIndividuPlanId) {

		return healthIndividuPlanPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public HealthIndividuPlan getHealthIndividuPlan(long healthIndividuPlanId)
		throws PortalException {

		return healthIndividuPlanPersistence.findByPrimaryKey(
			healthIndividuPlanId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(HealthIndividuPlan.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(HealthIndividuPlan.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return healthIndividuPlanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return healthIndividuPlanLocalService.deleteHealthIndividuPlan(
			(HealthIndividuPlan)persistedModel);
	}

	public BasePersistence<HealthIndividuPlan> getBasePersistence() {
		return healthIndividuPlanPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return healthIndividuPlanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HealthIndividuPlan> getHealthIndividuPlans(int start, int end) {
		return healthIndividuPlanPersistence.findAll(start, end);
	}
	...
	public int getHealthIndividuPlansCount() {
		return healthIndividuPlanPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HealthIndividuPlan updateHealthIndividuPlan(
		HealthIndividuPlan healthIndividuPlan) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthIndividuPlanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		healthIndividuPlanLocalService =
			(HealthIndividuPlanLocalService)aopProxy;

		_setLocalServiceUtilService(healthIndividuPlanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthIndividuPlanLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				HealthIndividuPlanLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, healthIndividuPlanLocalService);
		}
	...
	protected HealthIndividuPlanLocalService healthIndividuPlanLocalService;
