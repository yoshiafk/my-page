...
import com.mypage.admin.product.service.SmartTravelIntPlanLocalService;
...
/**
 * Provides the base implementation for the smart travel int plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartTravelIntPlanLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartTravelIntPlanLocalServiceImpl
 * @generated
 */
public abstract class SmartTravelIntPlanLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartTravelIntPlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartTravelIntPlanLocalServiceUtil</code>.
	 */
	...
	public SmartTravelIntPlan addSmartTravelIntPlan(
		...
		return smartTravelIntPlanPersistence.update(smartTravelIntPlan);
	}
	...
	public SmartTravelIntPlan createSmartTravelIntPlan(
		...
		return smartTravelIntPlanPersistence.create(smartTravelIntPlanId);
	}
	...
	public SmartTravelIntPlan deleteSmartTravelIntPlan(
		...
		return smartTravelIntPlanPersistence.remove(smartTravelIntPlanId);
	}
	...
	public SmartTravelIntPlan deleteSmartTravelIntPlan(
		...
		return smartTravelIntPlanPersistence.remove(smartTravelIntPlan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartTravelIntPlan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartTravelIntPlanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartTravelIntPlanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartTravelIntPlanPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SmartTravelIntPlan fetchSmartTravelIntPlan(
		...
		return smartTravelIntPlanPersistence.fetchByPrimaryKey(
	...
	public SmartTravelIntPlan getSmartTravelIntPlan(long smartTravelIntPlanId)
		...
		return smartTravelIntPlanPersistence.findByPrimaryKey(
			smartTravelIntPlanId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartTravelIntPlan.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartTravelIntPlan.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartTravelIntPlanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartTravelIntPlanLocalService.deleteSmartTravelIntPlan(
			(SmartTravelIntPlan)persistedModel);
	}

	public BasePersistence<SmartTravelIntPlan> getBasePersistence() {
		return smartTravelIntPlanPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartTravelIntPlanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartTravelIntPlanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartTravelIntPlanLocalService =
			(SmartTravelIntPlanLocalService)aopProxy;

		_setLocalServiceUtilService(smartTravelIntPlanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartTravelIntPlanLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return SmartTravelIntPlan.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartTravelIntPlanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartTravelIntPlanLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartTravelIntPlanLocalService);
		}
	...
	protected SmartTravelIntPlanLocalService smartTravelIntPlanLocalService;
