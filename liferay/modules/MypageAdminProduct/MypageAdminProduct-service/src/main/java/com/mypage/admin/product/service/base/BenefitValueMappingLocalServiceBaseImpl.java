...
/**
 * Provides the base implementation for the benefit value mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BenefitValueMappingLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BenefitValueMappingLocalServiceImpl
 * @generated
 */
public abstract class BenefitValueMappingLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BenefitValueMappingLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BenefitValueMappingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BenefitValueMappingLocalServiceUtil</code>.
	 */
	...
	@Override
	public BenefitValueMapping addBenefitValueMapping(
		BenefitValueMapping benefitValueMapping) {

		benefitValueMapping.setNew(true);

		return benefitValueMappingPersistence.update(benefitValueMapping);
	}
	...
	public BenefitValueMapping createBenefitValueMapping(
		long benefitValueMappingId) {

		return benefitValueMappingPersistence.create(benefitValueMappingId);
	}
	...
	@Override
	public BenefitValueMapping deleteBenefitValueMapping(
			long benefitValueMappingId)
		throws PortalException {

		return benefitValueMappingPersistence.remove(benefitValueMappingId);
	}
	...
	public BenefitValueMapping deleteBenefitValueMapping(
		...
		return benefitValueMappingPersistence.remove(benefitValueMapping);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BenefitValueMapping.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return benefitValueMappingPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return benefitValueMappingPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public BenefitValueMapping fetchBenefitValueMapping(
		long benefitValueMappingId) {

		return benefitValueMappingPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public BenefitValueMapping getBenefitValueMapping(
			long benefitValueMappingId)
		throws PortalException {

		return benefitValueMappingPersistence.findByPrimaryKey(
			benefitValueMappingId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			benefitValueMappingLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BenefitValueMapping.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return benefitValueMappingPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return benefitValueMappingLocalService.deleteBenefitValueMapping(
			(BenefitValueMapping)persistedModel);
	}

	public BasePersistence<BenefitValueMapping> getBasePersistence() {
		return benefitValueMappingPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return benefitValueMappingPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<BenefitValueMapping> getBenefitValueMappings(
		int start, int end) {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public BenefitValueMapping updateBenefitValueMapping(
		BenefitValueMapping benefitValueMapping) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BenefitValueMappingLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		benefitValueMappingLocalService =
			(BenefitValueMappingLocalService)aopProxy;

		_setLocalServiceUtilService(benefitValueMappingLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenefitValueMappingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				benefitValueMappingPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				BenefitValueMappingLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, benefitValueMappingLocalService);
		}
	...
	protected BenefitValueMappingLocalService benefitValueMappingLocalService;
