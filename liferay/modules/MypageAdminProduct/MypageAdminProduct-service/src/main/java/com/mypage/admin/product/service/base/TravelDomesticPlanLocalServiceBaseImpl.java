...
import com.mypage.admin.product.service.TravelDomesticPlanLocalService;
...
/**
 * Provides the base implementation for the travel domestic plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticPlanLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticPlanLocalServiceImpl
 * @generated
 */
public abstract class TravelDomesticPlanLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticPlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticPlanLocalServiceUtil</code>.
	 */
	...
	public TravelDomesticPlan createTravelDomesticPlan(
		...
		return travelDomesticPlanPersistence.create(travelDomesticPlanId);
	}
	...
	public TravelDomesticPlan deleteTravelDomesticPlan(
		...
		return travelDomesticPlanPersistence.remove(travelDomesticPlanId);
	}
	...
	public TravelDomesticPlan deleteTravelDomesticPlan(
		...
		return travelDomesticPlanPersistence.remove(travelDomesticPlan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelDomesticPlan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDomesticPlanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return travelDomesticPlanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDomesticPlanPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public TravelDomesticPlan fetchTravelDomesticPlan(
		...
		return travelDomesticPlanPersistence.fetchByPrimaryKey(
	...
	public TravelDomesticPlan getTravelDomesticPlan(long travelDomesticPlanId)
		...
		return travelDomesticPlanPersistence.findByPrimaryKey(
			travelDomesticPlanId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelDomesticPlan.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TravelDomesticPlan.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return travelDomesticPlanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelDomesticPlanLocalService.deleteTravelDomesticPlan(
			(TravelDomesticPlan)persistedModel);
	}

	public BasePersistence<TravelDomesticPlan> getBasePersistence() {
		return travelDomesticPlanPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return travelDomesticPlanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<TravelDomesticPlan> getTravelDomesticPlans(int start, int end) {
		return travelDomesticPlanPersistence.findAll(start, end);
	}
	...
	public int getTravelDomesticPlansCount() {
		return travelDomesticPlanPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticPlanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticPlanLocalService =
			(TravelDomesticPlanLocalService)aopProxy;

		_setLocalServiceUtilService(travelDomesticPlanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticPlanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelDomesticPlanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticPlanLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticPlanLocalService);
		}
	...
	protected TravelDomesticPlanLocalService travelDomesticPlanLocalService;
