 ...
 * @generated
 */
public abstract class PetRateFinderBaseImpl
	extends BasePersistenceImpl<PetRate> {

	public PetRateFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return petRatePersistence.getBadColumnNames();
	}
