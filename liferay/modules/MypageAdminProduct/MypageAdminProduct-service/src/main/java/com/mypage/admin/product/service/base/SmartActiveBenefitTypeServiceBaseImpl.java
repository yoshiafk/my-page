...
import com.mypage.admin.product.service.SmartActiveBenefitTypeService;
import com.mypage.admin.product.service.SmartActiveBenefitTypeServiceUtil;
...
/**
 * Provides the base implementation for the smart active benefit type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitTypeServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitTypeServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitTypeService = (SmartActiveBenefitTypeService)aopProxy;

		_setServiceUtilService(smartActiveBenefitTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitTypeServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitTypeService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.SmartActiveBenefitTypeLocalService
			smartActiveBenefitTypeLocalService;

	protected SmartActiveBenefitTypeService smartActiveBenefitTypeService;
