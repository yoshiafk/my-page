...
import com.mypage.admin.product.service.MasterCountryService;
import com.mypage.admin.product.service.MasterCountryServiceUtil;
...
/**
 * Provides the base implementation for the master country remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterCountryServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterCountryServiceImpl
 * @generated
 */
public abstract class MasterCountryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterCountryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterCountryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterCountryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterCountryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterCountryService = (MasterCountryService)aopProxy;

		_setServiceUtilService(masterCountryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterCountryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = MasterCountryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterCountryService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterCountryLocalService
		masterCountryLocalService;

	protected MasterCountryService masterCountryService;
