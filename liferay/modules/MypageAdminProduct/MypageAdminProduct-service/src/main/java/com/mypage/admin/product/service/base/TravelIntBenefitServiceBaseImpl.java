...
import com.mypage.admin.product.service.TravelIntBenefitService;
import com.mypage.admin.product.service.TravelIntBenefitServiceUtil;
...
/**
 * Provides the base implementation for the travel int benefit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelIntBenefitServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelIntBenefitServiceImpl
 * @generated
 */
public abstract class TravelIntBenefitServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TravelIntBenefitService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelIntBenefitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelIntBenefitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelIntBenefitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		travelIntBenefitService = (TravelIntBenefitService)aopProxy;

		_setServiceUtilService(travelIntBenefitService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelIntBenefitService.class.getName();
	}
	...
	private void _setServiceUtilService(
		TravelIntBenefitService travelIntBenefitService) {

		try {
			Field field = TravelIntBenefitServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, travelIntBenefitService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.TravelIntBenefitLocalService
		travelIntBenefitLocalService;

	protected TravelIntBenefitService travelIntBenefitService;
