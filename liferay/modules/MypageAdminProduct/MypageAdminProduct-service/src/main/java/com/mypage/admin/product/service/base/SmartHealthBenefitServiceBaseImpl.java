...
import com.mypage.admin.product.service.SmartHealthBenefitService;
import com.mypage.admin.product.service.SmartHealthBenefitServiceUtil;
...
/**
 * Provides the base implementation for the smart health benefit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthBenefitServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthBenefitServiceImpl
 * @generated
 */
public abstract class SmartHealthBenefitServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartHealthBenefitService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthBenefitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthBenefitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthBenefitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartHealthBenefitService = (SmartHealthBenefitService)aopProxy;

		_setServiceUtilService(smartHealthBenefitService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthBenefitService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartHealthBenefitService smartHealthBenefitService) {

		try {
			Field field = SmartHealthBenefitServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartHealthBenefitService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartHealthBenefitLocalService
		smartHealthBenefitLocalService;

	protected SmartHealthBenefitService smartHealthBenefitService;
