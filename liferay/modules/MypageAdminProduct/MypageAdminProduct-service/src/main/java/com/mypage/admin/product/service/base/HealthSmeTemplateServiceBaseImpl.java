...
import com.mypage.admin.product.service.HealthSmeTemplateService;
import com.mypage.admin.product.service.HealthSmeTemplateServiceUtil;
...
/**
 * Provides the base implementation for the health sme template remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmeTemplateServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmeTemplateServiceImpl
 * @generated
 */
public abstract class HealthSmeTemplateServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthSmeTemplateService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmeTemplateService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmeTemplateServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmeTemplateService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthSmeTemplateService = (HealthSmeTemplateService)aopProxy;

		_setServiceUtilService(healthSmeTemplateService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmeTemplateService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = HealthSmeTemplateServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthSmeTemplateService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.HealthSmeTemplateLocalService
		healthSmeTemplateLocalService;

	protected HealthSmeTemplateService healthSmeTemplateService;
