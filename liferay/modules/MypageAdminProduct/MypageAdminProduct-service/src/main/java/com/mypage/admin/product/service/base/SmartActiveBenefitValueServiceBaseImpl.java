...
import com.mypage.admin.product.service.SmartActiveBenefitValueService;
import com.mypage.admin.product.service.SmartActiveBenefitValueServiceUtil;
...
/**
 * Provides the base implementation for the smart active benefit value remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitValueServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitValueServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitValueServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitValueService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitValueServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitValueService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitValueService =
			(SmartActiveBenefitValueService)aopProxy;

		_setServiceUtilService(smartActiveBenefitValueService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitValueService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitValueServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitValueService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.SmartActiveBenefitValueLocalService
			smartActiveBenefitValueLocalService;

	protected SmartActiveBenefitValueService smartActiveBenefitValueService;
