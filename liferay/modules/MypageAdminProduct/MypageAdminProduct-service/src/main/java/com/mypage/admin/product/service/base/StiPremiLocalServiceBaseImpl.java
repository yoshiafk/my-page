...
import com.mypage.admin.product.service.StiPremiLocalService;
...
/**
 * Provides the base implementation for the sti premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.StiPremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.StiPremiLocalServiceImpl
 * @generated
 */
public abstract class StiPremiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, StiPremiLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StiPremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StiPremiLocalServiceUtil</code>.
	 */
	...
	public StiPremi addStiPremi(StiPremi stiPremi) {
		...
		return stiPremiPersistence.update(stiPremi);
	}
	...
	public StiPremi createStiPremi(long premiId) {
		return stiPremiPersistence.create(premiId);
	}
	...
	public StiPremi deleteStiPremi(long premiId) throws PortalException {
		return stiPremiPersistence.remove(premiId);
	}
	...
	public StiPremi deleteStiPremi(StiPremi stiPremi) {
		return stiPremiPersistence.remove(stiPremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			StiPremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return stiPremiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return stiPremiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return stiPremiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return stiPremiPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public StiPremi fetchStiPremi(long premiId) {
		return stiPremiPersistence.fetchByPrimaryKey(premiId);
	}
	...
	public StiPremi getStiPremi(long premiId) throws PortalException {
		return stiPremiPersistence.findByPrimaryKey(premiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(stiPremiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(StiPremi.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			stiPremiLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(StiPremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return stiPremiPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return stiPremiLocalService.deleteStiPremi((StiPremi)persistedModel);
	}

	public BasePersistence<StiPremi> getBasePersistence() {
		return stiPremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return stiPremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StiPremiLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		stiPremiLocalService = (StiPremiLocalService)aopProxy;

		_setLocalServiceUtilService(stiPremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StiPremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = stiPremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = StiPremiLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stiPremiLocalService);
		}
	...
	protected StiPremiLocalService stiPremiLocalService;
