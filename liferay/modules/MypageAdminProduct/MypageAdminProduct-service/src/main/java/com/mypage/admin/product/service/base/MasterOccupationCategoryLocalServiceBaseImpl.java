...
/**
 * Provides the base implementation for the master occupation category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterOccupationCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterOccupationCategoryLocalServiceImpl
 * @generated
 */
public abstract class MasterOccupationCategoryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterOccupationCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterOccupationCategoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterOccupationCategory addMasterOccupationCategory(
		MasterOccupationCategory masterOccupationCategory) {

		masterOccupationCategory.setNew(true);

		return masterOccupationCategoryPersistence.update(
	...
	public MasterOccupationCategory createMasterOccupationCategory(
		long masterOccupationCategoryId) {

		return masterOccupationCategoryPersistence.create(
	...
	@Override
	public MasterOccupationCategory deleteMasterOccupationCategory(
			long masterOccupationCategoryId)
		throws PortalException {

		return masterOccupationCategoryPersistence.remove(
			masterOccupationCategoryId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterOccupationCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterOccupationCategoryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterOccupationCategoryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public MasterOccupationCategory fetchMasterOccupationCategory(
		long masterOccupationCategoryId) {

		return masterOccupationCategoryPersistence.fetchByPrimaryKey(
			masterOccupationCategoryId);
	}
	 ...
	 */
	@Override
	public MasterOccupationCategory getMasterOccupationCategory(
			long masterOccupationCategoryId)
		throws PortalException {

		return masterOccupationCategoryPersistence.findByPrimaryKey(
			masterOccupationCategoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MasterOccupationCategory.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(
			MasterOccupationCategory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterOccupationCategoryLocalService.
			deleteMasterOccupationCategory(
				(MasterOccupationCategory)persistedModel);
	}

	public BasePersistence<MasterOccupationCategory> getBasePersistence() {
		return masterOccupationCategoryPersistence;
	}
	 ...
	 */
	@Override
	public List<MasterOccupationCategory> getMasterOccupationCategories(
		int start, int end) {

		return masterOccupationCategoryPersistence.findAll(start, end);
	}
	...
	public int getMasterOccupationCategoriesCount() {
		return masterOccupationCategoryPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterOccupationCategory updateMasterOccupationCategory(
		MasterOccupationCategory masterOccupationCategory) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterOccupationCategoryLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterOccupationCategoryLocalService =
			(MasterOccupationCategoryLocalService)aopProxy;

		_setLocalServiceUtilService(masterOccupationCategoryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterOccupationCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				masterOccupationCategoryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterOccupationCategoryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterOccupationCategoryLocalService);
		}
	...
	protected MasterOccupationCategoryLocalService
		masterOccupationCategoryLocalService;
