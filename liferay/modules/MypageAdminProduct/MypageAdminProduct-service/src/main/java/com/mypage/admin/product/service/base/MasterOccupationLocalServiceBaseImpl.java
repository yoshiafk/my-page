...
/**
 * Provides the base implementation for the master occupation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterOccupationLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterOccupationLocalServiceImpl
 * @generated
 */
public abstract class MasterOccupationLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MasterOccupationLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterOccupationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterOccupationLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterOccupation addMasterOccupation(
	...
	public MasterOccupation createMasterOccupation(long masterOccupationId) {
		return masterOccupationPersistence.create(masterOccupationId);
	}
	...
	@Override
	public MasterOccupation deleteMasterOccupation(long masterOccupationId)
		throws PortalException {

		return masterOccupationPersistence.remove(masterOccupationId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterOccupation deleteMasterOccupation(
		MasterOccupation masterOccupation) {

		return masterOccupationPersistence.remove(masterOccupation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterOccupation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterOccupationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterOccupationPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterOccupationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterOccupationPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterOccupation fetchMasterOccupation(long masterOccupationId) {
		return masterOccupationPersistence.fetchByPrimaryKey(
			masterOccupationId);
	}
	 ...
	 */
	@Override
	public MasterOccupation getMasterOccupation(long masterOccupationId)
		throws PortalException {

		return masterOccupationPersistence.findByPrimaryKey(masterOccupationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(MasterOccupation.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterOccupationId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MasterOccupation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterOccupationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterOccupationLocalService.deleteMasterOccupation(
			(MasterOccupation)persistedModel);
	}

	public BasePersistence<MasterOccupation> getBasePersistence() {
		return masterOccupationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterOccupationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterOccupation> getMasterOccupations(int start, int end) {
		return masterOccupationPersistence.findAll(start, end);
	}
	...
	public int getMasterOccupationsCount() {
		return masterOccupationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterOccupation updateMasterOccupation(
		MasterOccupation masterOccupation) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterOccupationLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterOccupationLocalService = (MasterOccupationLocalService)aopProxy;

		_setLocalServiceUtilService(masterOccupationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterOccupationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterOccupationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterOccupationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterOccupationLocalService);
		}
	...
	protected MasterOccupationLocalService masterOccupationLocalService;
