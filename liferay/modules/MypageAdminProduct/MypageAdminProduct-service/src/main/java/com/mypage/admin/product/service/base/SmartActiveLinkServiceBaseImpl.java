...
import com.mypage.admin.product.service.SmartActiveLinkService;
import com.mypage.admin.product.service.SmartActiveLinkServiceUtil;
...
/**
 * Provides the base implementation for the smart active link remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveLinkServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveLinkServiceImpl
 * @generated
 */
public abstract class SmartActiveLinkServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartActiveLinkService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveLinkService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveLinkServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveLinkService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveLinkService = (SmartActiveLinkService)aopProxy;

		_setServiceUtilService(smartActiveLinkService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveLinkService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartActiveLinkService smartActiveLinkService) {

		try {
			Field field = SmartActiveLinkServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartActiveLinkService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveLinkLocalService
		smartActiveLinkLocalService;

	protected SmartActiveLinkService smartActiveLinkService;
