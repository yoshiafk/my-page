...
/**
 * Provides the base implementation for the smart active benefit type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitTypeLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitTypeLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitTypeLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitTypeLocalServiceUtil</code>.
	 */
	...
	public SmartActiveBenefitType addSmartActiveBenefitType(
		...
		return smartActiveBenefitTypePersistence.update(smartActiveBenefitType);
	}
	...
	public SmartActiveBenefitType createSmartActiveBenefitType(
		...
		return smartActiveBenefitTypePersistence.create(
	...
	public SmartActiveBenefitType deleteSmartActiveBenefitType(
		...
		return smartActiveBenefitTypePersistence.remove(
			smartActiveBenefitTypeId);
	}
	...
	public SmartActiveBenefitType deleteSmartActiveBenefitType(
		...
		return smartActiveBenefitTypePersistence.remove(smartActiveBenefitType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveBenefitType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveBenefitTypePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveBenefitTypePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public SmartActiveBenefitType fetchSmartActiveBenefitType(
		...
		return smartActiveBenefitTypePersistence.fetchByPrimaryKey(
			smartActiveBenefitTypeId);
	}
	...
	public SmartActiveBenefitType getSmartActiveBenefitType(
		...
		return smartActiveBenefitTypePersistence.findByPrimaryKey(
			smartActiveBenefitTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartActiveBenefitType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveBenefitTypeLocalService.deleteSmartActiveBenefitType(
			(SmartActiveBenefitType)persistedModel);
	}

	public BasePersistence<SmartActiveBenefitType> getBasePersistence() {
		return smartActiveBenefitTypePersistence;
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitTypeLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitTypeLocalService =
			(SmartActiveBenefitTypeLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveBenefitTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveBenefitTypePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitTypeLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitTypeLocalService);
		}
	...
	protected SmartActiveBenefitTypeLocalService
		smartActiveBenefitTypeLocalService;
