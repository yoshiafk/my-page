...
import com.mypage.admin.product.service.TravelIntBenefitValueService;
import com.mypage.admin.product.service.TravelIntBenefitValueServiceUtil;
...
/**
 * Provides the base implementation for the travel int benefit value remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelIntBenefitValueServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelIntBenefitValueServiceImpl
 * @generated
 */
public abstract class TravelIntBenefitValueServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelIntBenefitValueService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelIntBenefitValueServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelIntBenefitValueService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		travelIntBenefitValueService = (TravelIntBenefitValueService)aopProxy;

		_setServiceUtilService(travelIntBenefitValueService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelIntBenefitValueService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelIntBenefitValuePersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelIntBenefitValueServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelIntBenefitValueService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.TravelIntBenefitValueLocalService
		travelIntBenefitValueLocalService;

	protected TravelIntBenefitValueService travelIntBenefitValueService;
