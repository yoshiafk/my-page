...
import com.mypage.admin.product.service.SmartHealthBenefitGroupService;
import com.mypage.admin.product.service.SmartHealthBenefitGroupServiceUtil;
...
/**
 * Provides the base implementation for the smart health benefit group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthBenefitGroupServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthBenefitGroupServiceImpl
 * @generated
 */
public abstract class SmartHealthBenefitGroupServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthBenefitGroupService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthBenefitGroupServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthBenefitGroupService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		smartHealthBenefitGroupService =
			(SmartHealthBenefitGroupService)aopProxy;

		_setServiceUtilService(smartHealthBenefitGroupService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthBenefitGroupService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartHealthBenefitGroupPersistence.getDataSource();
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartHealthBenefitGroupServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartHealthBenefitGroupService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.SmartHealthBenefitGroupLocalService
			smartHealthBenefitGroupLocalService;

	protected SmartHealthBenefitGroupService smartHealthBenefitGroupService;
