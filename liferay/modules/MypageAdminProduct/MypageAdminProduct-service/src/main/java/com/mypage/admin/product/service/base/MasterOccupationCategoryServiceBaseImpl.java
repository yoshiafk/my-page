...
import com.mypage.admin.product.service.MasterOccupationCategoryService;
import com.mypage.admin.product.service.MasterOccupationCategoryServiceUtil;
...
/**
 * Provides the base implementation for the master occupation category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterOccupationCategoryServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterOccupationCategoryServiceImpl
 * @generated
 */
public abstract class MasterOccupationCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MasterOccupationCategoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterOccupationCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterOccupationCategoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterOccupationCategoryService.class, IdentifiableOSGiService.class
		};
	}
	...
	public void setAopProxy(Object aopProxy) {
		masterOccupationCategoryService =
			(MasterOccupationCategoryService)aopProxy;

		_setServiceUtilService(masterOccupationCategoryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterOccupationCategoryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		MasterOccupationCategoryService masterOccupationCategoryService) {

		try {
			Field field =
				MasterOccupationCategoryServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterOccupationCategoryService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.MasterOccupationCategoryLocalService
			masterOccupationCategoryLocalService;

	protected MasterOccupationCategoryService masterOccupationCategoryService;
