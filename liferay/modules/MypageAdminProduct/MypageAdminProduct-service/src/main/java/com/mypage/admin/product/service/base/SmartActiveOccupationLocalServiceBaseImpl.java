...
/**
 * Provides the base implementation for the smart active occupation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveOccupationLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveOccupationLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveOccupationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveOccupationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveOccupationLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveOccupation addSmartActiveOccupation(
		SmartActiveOccupation smartActiveOccupation) {

		smartActiveOccupation.setNew(true);

		return smartActiveOccupationPersistence.update(smartActiveOccupation);
	}
	...
	public SmartActiveOccupation createSmartActiveOccupation(
		long smartActiveOccupationId) {

		return smartActiveOccupationPersistence.create(smartActiveOccupationId);
	}
	...
	@Override
	public SmartActiveOccupation deleteSmartActiveOccupation(
			long smartActiveOccupationId)
		throws PortalException {

		return smartActiveOccupationPersistence.remove(smartActiveOccupationId);
	}
	...
	public SmartActiveOccupation deleteSmartActiveOccupation(
		...
		return smartActiveOccupationPersistence.remove(smartActiveOccupation);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveOccupation.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveOccupationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveOccupationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartActiveOccupation fetchSmartActiveOccupation(
		long smartActiveOccupationId) {

		return smartActiveOccupationPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SmartActiveOccupation getSmartActiveOccupation(
			long smartActiveOccupationId)
		throws PortalException {

		return smartActiveOccupationPersistence.findByPrimaryKey(
			smartActiveOccupationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartActiveOccupation.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveOccupationPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveOccupationLocalService.deleteSmartActiveOccupation(
			(SmartActiveOccupation)persistedModel);
	}

	public BasePersistence<SmartActiveOccupation> getBasePersistence() {
		return smartActiveOccupationPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveOccupationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartActiveOccupation> getSmartActiveOccupations(
		int start, int end) {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveOccupation updateSmartActiveOccupation(
		SmartActiveOccupation smartActiveOccupation) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveOccupationLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveOccupationLocalService =
			(SmartActiveOccupationLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveOccupationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveOccupationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveOccupationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveOccupationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveOccupationLocalService);
		}
	...
	protected SmartActiveOccupationLocalService
		smartActiveOccupationLocalService;
