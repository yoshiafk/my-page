...
import com.mypage.admin.product.service.PromocodesService;
import com.mypage.admin.product.service.PromocodesServiceUtil;
...
/**
 * Provides the base implementation for the promocodes remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PromocodesServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PromocodesServiceImpl
 * @generated
 */
public abstract class PromocodesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PromocodesService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PromocodesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PromocodesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PromocodesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		promocodesService = (PromocodesService)aopProxy;

		_setServiceUtilService(promocodesService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PromocodesService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = promocodesPersistence.getDataSource();
	...
	private void _setServiceUtilService(PromocodesService promocodesService) {
		try {
			Field field = PromocodesServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, promocodesService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PromocodesLocalService
		promocodesLocalService;

	protected PromocodesService promocodesService;
