...
import com.mypage.admin.product.service.SmartActiveFeatureService;
import com.mypage.admin.product.service.SmartActiveFeatureServiceUtil;
...
/**
 * Provides the base implementation for the smart active feature remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveFeatureServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveFeatureServiceImpl
 * @generated
 */
public abstract class SmartActiveFeatureServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartActiveFeatureService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveFeatureService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveFeatureServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveFeatureService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveFeatureService = (SmartActiveFeatureService)aopProxy;

		_setServiceUtilService(smartActiveFeatureService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveFeatureService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartActiveFeatureService smartActiveFeatureService) {

		try {
			Field field = SmartActiveFeatureServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartActiveFeatureService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveFeatureLocalService
		smartActiveFeatureLocalService;

	protected SmartActiveFeatureService smartActiveFeatureService;
