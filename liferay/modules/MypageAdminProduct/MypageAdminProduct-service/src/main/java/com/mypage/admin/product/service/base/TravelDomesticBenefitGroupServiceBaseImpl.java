...
import com.mypage.admin.product.service.TravelDomesticBenefitGroupService;
import com.mypage.admin.product.service.TravelDomesticBenefitGroupServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic benefit group remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticBenefitGroupServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticBenefitGroupServiceImpl
 * @generated
 */
public abstract class TravelDomesticBenefitGroupServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticBenefitGroupService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticBenefitGroupServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticBenefitGroupService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticBenefitGroupService =
			(TravelDomesticBenefitGroupService)aopProxy;

		_setServiceUtilService(travelDomesticBenefitGroupService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticBenefitGroupService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticBenefitGroupServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticBenefitGroupService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.TravelDomesticBenefitGroupLocalService
			travelDomesticBenefitGroupLocalService;

	protected TravelDomesticBenefitGroupService
		travelDomesticBenefitGroupService;
