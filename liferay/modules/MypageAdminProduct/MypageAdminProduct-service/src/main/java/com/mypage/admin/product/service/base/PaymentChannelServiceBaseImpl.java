...
import com.mypage.admin.product.service.PaymentChannelService;
import com.mypage.admin.product.service.PaymentChannelServiceUtil;
...
/**
 * Provides the base implementation for the payment channel remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PaymentChannelServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PaymentChannelServiceImpl
 * @generated
 */
public abstract class PaymentChannelServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PaymentChannelService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PaymentChannelService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PaymentChannelServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PaymentChannelService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		paymentChannelService = (PaymentChannelService)aopProxy;

		_setServiceUtilService(paymentChannelService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PaymentChannelService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = PaymentChannelServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, paymentChannelService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PaymentChannelLocalService
