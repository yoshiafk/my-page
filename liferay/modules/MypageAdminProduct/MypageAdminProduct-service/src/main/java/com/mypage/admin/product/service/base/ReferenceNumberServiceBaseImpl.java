...
import com.mypage.admin.product.service.ReferenceNumberService;
import com.mypage.admin.product.service.ReferenceNumberServiceUtil;
...
/**
 * Provides the base implementation for the reference number remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.ReferenceNumberServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.ReferenceNumberServiceImpl
 * @generated
 */
public abstract class ReferenceNumberServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, ReferenceNumberService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ReferenceNumberService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ReferenceNumberServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ReferenceNumberService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		referenceNumberService = (ReferenceNumberService)aopProxy;

		_setServiceUtilService(referenceNumberService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ReferenceNumberService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = ReferenceNumberServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, referenceNumberService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.ReferenceNumberLocalService
