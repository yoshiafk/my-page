...
/**
 * Provides the base implementation for the smart active benefit value local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitValueLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitValueLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitValueLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitValueLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitValueLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveBenefitValue addSmartActiveBenefitValue(
		SmartActiveBenefitValue smartActiveBenefitValue) {

		smartActiveBenefitValue.setNew(true);

		return smartActiveBenefitValuePersistence.update(
	...
	public SmartActiveBenefitValue createSmartActiveBenefitValue(
		long smartActiveBenefitValueId) {

		return smartActiveBenefitValuePersistence.create(
	...
	@Override
	public SmartActiveBenefitValue deleteSmartActiveBenefitValue(
			long smartActiveBenefitValueId)
		throws PortalException {

		return smartActiveBenefitValuePersistence.remove(
			smartActiveBenefitValueId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveBenefitValue.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveBenefitValuePersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveBenefitValuePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartActiveBenefitValue fetchSmartActiveBenefitValue(
		long smartActiveBenefitValueId) {

		return smartActiveBenefitValuePersistence.fetchByPrimaryKey(
			smartActiveBenefitValueId);
	}
	 ...
	 */
	@Override
	public SmartActiveBenefitValue getSmartActiveBenefitValue(
			long smartActiveBenefitValueId)
		throws PortalException {

		return smartActiveBenefitValuePersistence.findByPrimaryKey(
			smartActiveBenefitValueId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartActiveBenefitValue.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveBenefitValueLocalService.
			deleteSmartActiveBenefitValue(
				(SmartActiveBenefitValue)persistedModel);
	}

	public BasePersistence<SmartActiveBenefitValue> getBasePersistence() {
		return smartActiveBenefitValuePersistence;
	}
	 ...
	 */
	@Override
	public List<SmartActiveBenefitValue> getSmartActiveBenefitValues(
		int start, int end) {

		return smartActiveBenefitValuePersistence.findAll(start, end);
	}
	...
	public int getSmartActiveBenefitValuesCount() {
		return smartActiveBenefitValuePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveBenefitValue updateSmartActiveBenefitValue(
		SmartActiveBenefitValue smartActiveBenefitValue) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitValueLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitValueLocalService =
			(SmartActiveBenefitValueLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveBenefitValueLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitValueLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveBenefitValuePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitValueLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitValueLocalService);
		}
	...
	protected SmartActiveBenefitValueLocalService
		smartActiveBenefitValueLocalService;
