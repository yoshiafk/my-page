...
import com.mypage.admin.product.service.TravelDomesticDurationService;
import com.mypage.admin.product.service.TravelDomesticDurationServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic duration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticDurationServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticDurationServiceImpl
 * @generated
 */
public abstract class TravelDomesticDurationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticDurationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticDurationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticDurationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		travelDomesticDurationService = (TravelDomesticDurationService)aopProxy;

		_setServiceUtilService(travelDomesticDurationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticDurationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticDurationServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticDurationService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.TravelDomesticDurationLocalService
			travelDomesticDurationLocalService;

	protected TravelDomesticDurationService travelDomesticDurationService;
