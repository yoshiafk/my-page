...
/**
 * Provides the base implementation for the industry category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.IndustryCategoryLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.IndustryCategoryLocalServiceImpl
 * @generated
 */
public abstract class IndustryCategoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   IndustryCategoryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IndustryCategoryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>IndustryCategoryLocalServiceUtil</code>.
	 */
	...
	@Override
	public IndustryCategory addIndustryCategory(
		IndustryCategory industryCategory) {

		industryCategory.setNew(true);

		return industryCategoryPersistence.update(industryCategory);
	}
	...
	public IndustryCategory createIndustryCategory(long industryCategoryId) {
		return industryCategoryPersistence.create(industryCategoryId);
	}
	...
	@Override
	public IndustryCategory deleteIndustryCategory(long industryCategoryId)
		throws PortalException {

		return industryCategoryPersistence.remove(industryCategoryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public IndustryCategory deleteIndustryCategory(
		IndustryCategory industryCategory) {

		return industryCategoryPersistence.remove(industryCategory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			IndustryCategory.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return industryCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return industryCategoryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return industryCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return industryCategoryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public IndustryCategory fetchIndustryCategory(long industryCategoryId) {
		return industryCategoryPersistence.fetchByPrimaryKey(
			industryCategoryId);
	}
	 ...
	 */
	@Override
	public IndustryCategory getIndustryCategory(long industryCategoryId)
		throws PortalException {

		return industryCategoryPersistence.findByPrimaryKey(industryCategoryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(IndustryCategory.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("industryCategoryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(IndustryCategory.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return industryCategoryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return industryCategoryLocalService.deleteIndustryCategory(
			(IndustryCategory)persistedModel);
	}

	public BasePersistence<IndustryCategory> getBasePersistence() {
		return industryCategoryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return industryCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public IndustryCategory updateIndustryCategory(
		IndustryCategory industryCategory) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IndustryCategoryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		industryCategoryLocalService = (IndustryCategoryLocalService)aopProxy;

		_setLocalServiceUtilService(industryCategoryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IndustryCategoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = industryCategoryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				IndustryCategoryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, industryCategoryLocalService);
		}
	...
	protected IndustryCategoryLocalService industryCategoryLocalService;
