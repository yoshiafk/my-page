...
import com.mypage.admin.product.service.TravelDomesticBenefitService;
import com.mypage.admin.product.service.TravelDomesticBenefitServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic benefit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticBenefitServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticBenefitServiceImpl
 * @generated
 */
public abstract class TravelDomesticBenefitServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticBenefitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticBenefitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticBenefitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		travelDomesticBenefitService = (TravelDomesticBenefitService)aopProxy;

		_setServiceUtilService(travelDomesticBenefitService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticBenefitService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticBenefitServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticBenefitService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.TravelDomesticBenefitLocalService
		travelDomesticBenefitLocalService;

	protected TravelDomesticBenefitService travelDomesticBenefitService;
