...
import com.mypage.admin.product.service.MasterCityService;
import com.mypage.admin.product.service.MasterCityServiceUtil;
...
/**
 * Provides the base implementation for the master city remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterCityServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterCityServiceImpl
 * @generated
 */
public abstract class MasterCityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterCityService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterCityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterCityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterCityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterCityService = (MasterCityService)aopProxy;

		_setServiceUtilService(masterCityService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterCityService.class.getName();
	}
	...
	private void _setServiceUtilService(MasterCityService masterCityService) {
		try {
			Field field = MasterCityServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterCityService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterCityLocalService
		masterCityLocalService;

	protected MasterCityService masterCityService;
