...
import com.mypage.admin.product.service.TravelDomesticBenefitLocalService;
...
/**
 * Provides the base implementation for the travel domestic benefit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticBenefitLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticBenefitLocalServiceImpl
 * @generated
 */
public abstract class TravelDomesticBenefitLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticBenefitLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticBenefitLocalServiceUtil</code>.
	 */
	...
	public TravelDomesticBenefit createTravelDomesticBenefit(
		long travelDomesticBenefitId) {

		return travelDomesticBenefitPersistence.create(travelDomesticBenefitId);
	}
	...
	@Override
	public TravelDomesticBenefit deleteTravelDomesticBenefit(
			long travelDomesticBenefitId)
		throws PortalException {

		return travelDomesticBenefitPersistence.remove(travelDomesticBenefitId);
	}
	...
	public TravelDomesticBenefit deleteTravelDomesticBenefit(
		...
		return travelDomesticBenefitPersistence.remove(travelDomesticBenefit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelDomesticBenefit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDomesticBenefitPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDomesticBenefitPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TravelDomesticBenefit fetchTravelDomesticBenefit(
		long travelDomesticBenefitId) {

		return travelDomesticBenefitPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public TravelDomesticBenefit getTravelDomesticBenefit(
			long travelDomesticBenefitId)
		throws PortalException {

		return travelDomesticBenefitPersistence.findByPrimaryKey(
			travelDomesticBenefitId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelDomesticBenefit.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return travelDomesticBenefitPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelDomesticBenefitLocalService.deleteTravelDomesticBenefit(
			(TravelDomesticBenefit)persistedModel);
	}

	public BasePersistence<TravelDomesticBenefit> getBasePersistence() {
		return travelDomesticBenefitPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return travelDomesticBenefitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TravelDomesticBenefit> getTravelDomesticBenefits(
		int start, int end) {

		return travelDomesticBenefitPersistence.findAll(start, end);
	}
	...
	public int getTravelDomesticBenefitsCount() {
		return travelDomesticBenefitPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticBenefitLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticBenefitLocalService =
			(TravelDomesticBenefitLocalService)aopProxy;

		_setLocalServiceUtilService(travelDomesticBenefitLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticBenefitLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return TravelDomesticBenefit.class;
	}

	protected String getModelClassName() {
		return TravelDomesticBenefit.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelDomesticBenefitPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticBenefitLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticBenefitLocalService);
		}
	...
	protected TravelDomesticBenefitLocalService
		travelDomesticBenefitLocalService;
