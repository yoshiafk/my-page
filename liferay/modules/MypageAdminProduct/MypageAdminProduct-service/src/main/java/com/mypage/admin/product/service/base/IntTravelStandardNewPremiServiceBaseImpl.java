...
import com.mypage.admin.product.service.IntTravelStandardNewPremiService;
import com.mypage.admin.product.service.IntTravelStandardNewPremiServiceUtil;
...
/**
 * Provides the base implementation for the int travel standard new premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.IntTravelStandardNewPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.IntTravelStandardNewPremiServiceImpl
 * @generated
 */
public abstract class IntTravelStandardNewPremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService,
			   IntTravelStandardNewPremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IntTravelStandardNewPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>IntTravelStandardNewPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IntTravelStandardNewPremiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		intTravelStandardNewPremiService =
			(IntTravelStandardNewPremiService)aopProxy;

		_setServiceUtilService(intTravelStandardNewPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IntTravelStandardNewPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		IntTravelStandardNewPremiService intTravelStandardNewPremiService) {

		try {
			Field field =
				IntTravelStandardNewPremiServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, intTravelStandardNewPremiService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.IntTravelStandardNewPremiLocalService
			intTravelStandardNewPremiLocalService;

	protected IntTravelStandardNewPremiService intTravelStandardNewPremiService;
