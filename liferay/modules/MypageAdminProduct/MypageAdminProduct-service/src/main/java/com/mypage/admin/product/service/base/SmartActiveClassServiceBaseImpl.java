...
import com.mypage.admin.product.service.SmartActiveClassService;
import com.mypage.admin.product.service.SmartActiveClassServiceUtil;
...
/**
 * Provides the base implementation for the smart active class remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveClassServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveClassServiceImpl
 * @generated
 */
public abstract class SmartActiveClassServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartActiveClassService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveClassService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveClassServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveClassService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveClassService = (SmartActiveClassService)aopProxy;

		_setServiceUtilService(smartActiveClassService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveClassService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartActiveClassService smartActiveClassService) {

		try {
			Field field = SmartActiveClassServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartActiveClassService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveClassLocalService
		smartActiveClassLocalService;

	protected SmartActiveClassService smartActiveClassService;
