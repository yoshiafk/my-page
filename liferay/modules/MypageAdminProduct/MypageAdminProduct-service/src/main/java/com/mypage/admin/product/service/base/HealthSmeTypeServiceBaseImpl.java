...
import com.mypage.admin.product.service.HealthSmeTypeService;
import com.mypage.admin.product.service.HealthSmeTypeServiceUtil;
...
/**
 * Provides the base implementation for the health sme type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmeTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmeTypeServiceImpl
 * @generated
 */
public abstract class HealthSmeTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthSmeTypeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmeTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmeTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmeTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthSmeTypeService = (HealthSmeTypeService)aopProxy;

		_setServiceUtilService(healthSmeTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmeTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = HealthSmeTypeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthSmeTypeService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.HealthSmeTypeLocalService
		healthSmeTypeLocalService;

	protected HealthSmeTypeService healthSmeTypeService;
