...
/**
 * Provides the base implementation for the personal accident premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PersonalAccidentPremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PersonalAccidentPremiLocalServiceImpl
 * @generated
 */
public abstract class PersonalAccidentPremiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PersonalAccidentPremiLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PersonalAccidentPremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PersonalAccidentPremiLocalServiceUtil</code>.
	 */
	...
	public PersonalAccidentPremi addPersonalAccidentPremi(
		...
		return personalAccidentPremiPersistence.update(personalAccidentPremi);
	}
	...
	public PersonalAccidentPremi createPersonalAccidentPremi(
		...
		return personalAccidentPremiPersistence.create(personalAccidentPremiId);
	}
	...
	public PersonalAccidentPremi deletePersonalAccidentPremi(
		...
		return personalAccidentPremiPersistence.remove(personalAccidentPremiId);
	}
	...
	public PersonalAccidentPremi deletePersonalAccidentPremi(
		...
		return personalAccidentPremiPersistence.remove(personalAccidentPremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PersonalAccidentPremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return personalAccidentPremiPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return personalAccidentPremiPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PersonalAccidentPremi fetchPersonalAccidentPremi(
		...
		return personalAccidentPremiPersistence.fetchByPrimaryKey(
	...
	public PersonalAccidentPremi getPersonalAccidentPremi(
		...
		return personalAccidentPremiPersistence.findByPrimaryKey(
			personalAccidentPremiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PersonalAccidentPremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return personalAccidentPremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return personalAccidentPremiLocalService.deletePersonalAccidentPremi(
			(PersonalAccidentPremi)persistedModel);
	}

	public BasePersistence<PersonalAccidentPremi> getBasePersistence() {
		return personalAccidentPremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return personalAccidentPremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PersonalAccidentPremi> getPersonalAccidentPremis(
		...
		return personalAccidentPremiPersistence.findAll(start, end);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PersonalAccidentPremiLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		personalAccidentPremiLocalService =
			(PersonalAccidentPremiLocalService)aopProxy;

		_setLocalServiceUtilService(personalAccidentPremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PersonalAccidentPremiLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return PersonalAccidentPremi.class;
	}

	protected String getModelClassName() {
		return PersonalAccidentPremi.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				personalAccidentPremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				PersonalAccidentPremiLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, personalAccidentPremiLocalService);
		}
	...
	protected PersonalAccidentPremiLocalService
		personalAccidentPremiLocalService;
