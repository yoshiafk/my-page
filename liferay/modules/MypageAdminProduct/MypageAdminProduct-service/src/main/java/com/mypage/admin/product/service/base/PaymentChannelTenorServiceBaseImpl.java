...
import com.mypage.admin.product.service.PaymentChannelTenorService;
import com.mypage.admin.product.service.PaymentChannelTenorServiceUtil;
...
/**
 * Provides the base implementation for the payment channel tenor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PaymentChannelTenorServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PaymentChannelTenorServiceImpl
 * @generated
 */
public abstract class PaymentChannelTenorServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PaymentChannelTenorService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PaymentChannelTenorService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PaymentChannelTenorServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PaymentChannelTenorService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		paymentChannelTenorService = (PaymentChannelTenorService)aopProxy;

		_setServiceUtilService(paymentChannelTenorService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PaymentChannelTenorService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = PaymentChannelTenorServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, paymentChannelTenorService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PaymentChannelTenorLocalService
		paymentChannelTenorLocalService;

	protected PaymentChannelTenorService paymentChannelTenorService;
