...
/**
 * Provides the base implementation for the smart health premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthPremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthPremiLocalServiceImpl
 * @generated
 */
public abstract class SmartHealthPremiLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthPremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthPremiLocalServiceUtil</code>.
	 */
	...
	public SmartHealthPremi addSmartHealthPremi(
		...
		return smartHealthPremiPersistence.update(smartHealthPremi);
	}
	...
	public SmartHealthPremi createSmartHealthPremi(long smartHealthPremiId) {
		return smartHealthPremiPersistence.create(smartHealthPremiId);
	}
	...
	public SmartHealthPremi deleteSmartHealthPremi(long smartHealthPremiId)
		...
		return smartHealthPremiPersistence.remove(smartHealthPremiId);
	}
	...
	public SmartHealthPremi deleteSmartHealthPremi(
		...
		return smartHealthPremiPersistence.remove(smartHealthPremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartHealthPremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartHealthPremiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartHealthPremiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartHealthPremiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return smartHealthPremiPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SmartHealthPremi fetchSmartHealthPremi(long smartHealthPremiId) {
		return smartHealthPremiPersistence.fetchByPrimaryKey(
			smartHealthPremiId);
	}
	...
	public SmartHealthPremi getSmartHealthPremi(long smartHealthPremiId)
		...
		return smartHealthPremiPersistence.findByPrimaryKey(smartHealthPremiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartHealthPremi.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("smartHealthPremiId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartHealthPremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartHealthPremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartHealthPremiLocalService.deleteSmartHealthPremi(
			(SmartHealthPremi)persistedModel);
	}

	public BasePersistence<SmartHealthPremi> getBasePersistence() {
		return smartHealthPremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartHealthPremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<SmartHealthPremi> getSmartHealthPremis(int start, int end) {
		return smartHealthPremiPersistence.findAll(start, end);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthPremiLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartHealthPremiLocalService = (SmartHealthPremiLocalService)aopProxy;

		_setLocalServiceUtilService(smartHealthPremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthPremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = smartHealthPremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartHealthPremiLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartHealthPremiLocalService);
		}
	...
	protected SmartHealthPremiLocalService smartHealthPremiLocalService;
