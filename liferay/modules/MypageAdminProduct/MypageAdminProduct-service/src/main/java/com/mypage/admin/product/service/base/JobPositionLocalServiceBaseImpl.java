...
/**
 * Provides the base implementation for the job position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.JobPositionLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.JobPositionLocalServiceImpl
 * @generated
 */
public abstract class JobPositionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, JobPositionLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>JobPositionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>JobPositionLocalServiceUtil</code>.
	 */
	...
	public JobPosition addJobPosition(JobPosition jobPosition) {
		...
		return jobPositionPersistence.update(jobPosition);
	}
	...
	public JobPosition createJobPosition(long jobPositionId) {
		return jobPositionPersistence.create(jobPositionId);
	}
	...
	@Override
	public JobPosition deleteJobPosition(long jobPositionId)
		throws PortalException {

		return jobPositionPersistence.remove(jobPositionId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public JobPosition deleteJobPosition(JobPosition jobPosition) {
		return jobPositionPersistence.remove(jobPosition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			JobPosition.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return jobPositionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return jobPositionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return jobPositionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return jobPositionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public JobPosition fetchJobPosition(long jobPositionId) {
		return jobPositionPersistence.fetchByPrimaryKey(jobPositionId);
	}
	 ...
	 */
	@Override
	public JobPosition getJobPosition(long jobPositionId)
		throws PortalException {

		return jobPositionPersistence.findByPrimaryKey(jobPositionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(jobPositionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(JobPosition.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("jobPositionId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			jobPositionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(JobPosition.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return jobPositionPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return jobPositionLocalService.deleteJobPosition(
			(JobPosition)persistedModel);
	}

	public BasePersistence<JobPosition> getBasePersistence() {
		return jobPositionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return jobPositionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			JobPositionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		jobPositionLocalService = (JobPositionLocalService)aopProxy;

		_setLocalServiceUtilService(jobPositionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return JobPositionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = jobPositionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = JobPositionLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, jobPositionLocalService);
		}
	...
	protected JobPositionLocalService jobPositionLocalService;
