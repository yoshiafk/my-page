...
import com.mypage.admin.product.service.HealthSmeTemplateLocalService;
...
/**
 * Provides the base implementation for the health sme template local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmeTemplateLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmeTemplateLocalServiceImpl
 * @generated
 */
public abstract class HealthSmeTemplateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthSmeTemplateLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmeTemplateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmeTemplateLocalServiceUtil</code>.
	 */
	...
	@Override
	public HealthSmeTemplate addHealthSmeTemplate(
		HealthSmeTemplate healthSmeTemplate) {

		healthSmeTemplate.setNew(true);

		return healthSmeTemplatePersistence.update(healthSmeTemplate);
	}
	...
	public HealthSmeTemplate createHealthSmeTemplate(long healthSmeTemplateId) {
		return healthSmeTemplatePersistence.create(healthSmeTemplateId);
	}
	...
	@Override
	public HealthSmeTemplate deleteHealthSmeTemplate(long healthSmeTemplateId)
		throws PortalException {

		return healthSmeTemplatePersistence.remove(healthSmeTemplateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HealthSmeTemplate deleteHealthSmeTemplate(
		HealthSmeTemplate healthSmeTemplate) {

		return healthSmeTemplatePersistence.remove(healthSmeTemplate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthSmeTemplate.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthSmeTemplatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return healthSmeTemplatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthSmeTemplatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return healthSmeTemplatePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public HealthSmeTemplate fetchHealthSmeTemplate(long healthSmeTemplateId) {
		return healthSmeTemplatePersistence.fetchByPrimaryKey(
			healthSmeTemplateId);
	}
	 ...
	 */
	@Override
	public HealthSmeTemplate getHealthSmeTemplate(long healthSmeTemplateId)
		throws PortalException {

		return healthSmeTemplatePersistence.findByPrimaryKey(
			healthSmeTemplateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			healthSmeTemplateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HealthSmeTemplate.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("healthSmeTemplateId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(HealthSmeTemplate.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmeTemplatePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return healthSmeTemplateLocalService.deleteHealthSmeTemplate(
			(HealthSmeTemplate)persistedModel);
	}

	public BasePersistence<HealthSmeTemplate> getBasePersistence() {
		return healthSmeTemplatePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmeTemplatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HealthSmeTemplate> getHealthSmeTemplates(int start, int end) {
		return healthSmeTemplatePersistence.findAll(start, end);
	}
	...
	public int getHealthSmeTemplatesCount() {
		return healthSmeTemplatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HealthSmeTemplate updateHealthSmeTemplate(
		HealthSmeTemplate healthSmeTemplate) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmeTemplateLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		healthSmeTemplateLocalService = (HealthSmeTemplateLocalService)aopProxy;

		_setLocalServiceUtilService(healthSmeTemplateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmeTemplateLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return HealthSmeTemplate.class;
	}

	protected String getModelClassName() {
		return HealthSmeTemplate.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				healthSmeTemplatePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				HealthSmeTemplateLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, healthSmeTemplateLocalService);
		}
	...
	protected HealthSmeTemplateLocalService healthSmeTemplateLocalService;
