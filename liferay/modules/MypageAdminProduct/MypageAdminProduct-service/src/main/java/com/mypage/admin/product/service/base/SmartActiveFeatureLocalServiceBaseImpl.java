...
/**
 * Provides the base implementation for the smart active feature local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveFeatureLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveFeatureLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveFeatureLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveFeatureLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveFeatureLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveFeature addSmartActiveFeature(
		SmartActiveFeature smartActiveFeature) {

		smartActiveFeature.setNew(true);

		return smartActiveFeaturePersistence.update(smartActiveFeature);
	}
	...
	public SmartActiveFeature createSmartActiveFeature(
		long smartActiveFeatureId) {

		return smartActiveFeaturePersistence.create(smartActiveFeatureId);
	}
	...
	@Override
	public SmartActiveFeature deleteSmartActiveFeature(
			long smartActiveFeatureId)
		throws PortalException {

		return smartActiveFeaturePersistence.remove(smartActiveFeatureId);
	}
	...
	public SmartActiveFeature deleteSmartActiveFeature(
		...
		return smartActiveFeaturePersistence.remove(smartActiveFeature);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveFeature.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveFeaturePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartActiveFeaturePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveFeaturePersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartActiveFeature fetchSmartActiveFeature(
		long smartActiveFeatureId) {

		return smartActiveFeaturePersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public SmartActiveFeature getSmartActiveFeature(long smartActiveFeatureId)
		throws PortalException {

		return smartActiveFeaturePersistence.findByPrimaryKey(
			smartActiveFeatureId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(SmartActiveFeature.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartActiveFeature.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveFeaturePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveFeatureLocalService.deleteSmartActiveFeature(
			(SmartActiveFeature)persistedModel);
	}

	public BasePersistence<SmartActiveFeature> getBasePersistence() {
		return smartActiveFeaturePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveFeaturePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartActiveFeature> getSmartActiveFeatures(int start, int end) {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveFeature updateSmartActiveFeature(
		SmartActiveFeature smartActiveFeature) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveFeatureLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveFeatureLocalService =
			(SmartActiveFeatureLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveFeatureLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveFeatureLocalService.class.getName();
	}

	protected Class<?> getModelClass() {
		return SmartActiveFeature.class;
	}

	protected String getModelClassName() {
		return SmartActiveFeature.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveFeaturePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveFeatureLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveFeatureLocalService);
		}
	...
	protected SmartActiveFeatureLocalService smartActiveFeatureLocalService;
