...
import com.mypage.admin.product.service.SmartActiveOccupationService;
import com.mypage.admin.product.service.SmartActiveOccupationServiceUtil;
...
/**
 * Provides the base implementation for the smart active occupation remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveOccupationServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveOccupationServiceImpl
 * @generated
 */
public abstract class SmartActiveOccupationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveOccupationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveOccupationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveOccupationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveOccupationService = (SmartActiveOccupationService)aopProxy;

		_setServiceUtilService(smartActiveOccupationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveOccupationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartActiveOccupationServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveOccupationService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveOccupationLocalService
		smartActiveOccupationLocalService;

	protected SmartActiveOccupationService smartActiveOccupationService;
