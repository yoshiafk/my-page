...
/**
 * Provides the base implementation for the pet rate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetRateLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetRateLocalServiceImpl
 * @generated
 */
public abstract class PetRateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PetRateLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetRateLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetRateLocalServiceUtil</code>.
	 */
	...
	@Override
	public PetRate addPetRate(PetRate petRate) {
		petRate.setNew(true);

		return petRatePersistence.update(petRate);
	}
	...
	public PetRate createPetRate(long petRateId) {
		return petRatePersistence.create(petRateId);
	}
	...
	@Override
	public PetRate deletePetRate(long petRateId) throws PortalException {
		return petRatePersistence.remove(petRateId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PetRate deletePetRate(PetRate petRate) {
		return petRatePersistence.remove(petRate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PetRate.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return petRatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return petRatePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return petRatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return petRatePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PetRate fetchPetRate(long petRateId) {
	 ...
	 */
	@Override
	public PetRate getPetRate(long petRateId) throws PortalException {
		return petRatePersistence.findByPrimaryKey(petRateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(petRateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PetRate.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("petRateId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(PetRate.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("petRateId");
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return petRatePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return petRateLocalService.deletePetRate((PetRate)persistedModel);
	}

	public BasePersistence<PetRate> getBasePersistence() {
		return petRatePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return petRatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PetRate updatePetRate(PetRate petRate) {
		return petRatePersistence.update(petRate);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetRateLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		petRateLocalService = (PetRateLocalService)aopProxy;

		_setLocalServiceUtilService(petRateLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetRateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = petRatePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		PetRateLocalService petRateLocalService) {

		try {
			Field field = PetRateLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petRateLocalService);
		}
	...
	protected PetRateLocalService petRateLocalService;
