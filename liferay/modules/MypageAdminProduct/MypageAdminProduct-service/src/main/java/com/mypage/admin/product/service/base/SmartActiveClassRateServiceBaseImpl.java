...
import com.mypage.admin.product.service.SmartActiveClassRateService;
import com.mypage.admin.product.service.SmartActiveClassRateServiceUtil;
...
/**
 * Provides the base implementation for the smart active class rate remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveClassRateServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveClassRateServiceImpl
 * @generated
 */
public abstract class SmartActiveClassRateServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveClassRateService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveClassRateServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveClassRateService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveClassRateService = (SmartActiveClassRateService)aopProxy;

		_setServiceUtilService(smartActiveClassRateService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveClassRateService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartActiveClassRateServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveClassRateService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveClassRateLocalService
		smartActiveClassRateLocalService;

	protected SmartActiveClassRateService smartActiveClassRateService;
