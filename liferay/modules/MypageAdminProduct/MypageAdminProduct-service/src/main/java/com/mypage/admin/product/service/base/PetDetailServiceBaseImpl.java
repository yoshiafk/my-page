...
import com.mypage.admin.product.service.PetDetailService;
import com.mypage.admin.product.service.PetDetailServiceUtil;
...
/**
 * Provides the base implementation for the pet detail remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetDetailServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetDetailServiceImpl
 * @generated
 */
public abstract class PetDetailServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PetDetailService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetDetailService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetDetailServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetDetailService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		petDetailService = (PetDetailService)aopProxy;

		_setServiceUtilService(petDetailService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetDetailService.class.getName();
	}
	...
	private void _setServiceUtilService(PetDetailService petDetailService) {
		try {
			Field field = PetDetailServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petDetailService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PetDetailLocalService
		petDetailLocalService;

	protected PetDetailService petDetailService;
