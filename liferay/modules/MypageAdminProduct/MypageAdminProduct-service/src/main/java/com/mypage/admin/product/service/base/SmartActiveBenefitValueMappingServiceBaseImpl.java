...
import com.mypage.admin.product.service.SmartActiveBenefitValueMappingService;
import com.mypage.admin.product.service.SmartActiveBenefitValueMappingServiceUtil;
...
/**
 * Provides the base implementation for the smart active benefit value mapping remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitValueMappingServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitValueMappingServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitValueMappingServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitValueMappingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitValueMappingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitValueMappingService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitValueMappingService =
			(SmartActiveBenefitValueMappingService)aopProxy;

		_setServiceUtilService(smartActiveBenefitValueMappingService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitValueMappingService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitValueMappingServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitValueMappingService);
		}
	...
	@Reference
	protected
		com.mypage.admin.product.service.
			SmartActiveBenefitValueMappingLocalService
				smartActiveBenefitValueMappingLocalService;

	protected SmartActiveBenefitValueMappingService
		smartActiveBenefitValueMappingService;
