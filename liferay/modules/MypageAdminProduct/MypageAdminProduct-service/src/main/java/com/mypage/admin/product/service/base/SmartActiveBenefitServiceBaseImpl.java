...
import com.mypage.admin.product.service.SmartActiveBenefitService;
import com.mypage.admin.product.service.SmartActiveBenefitServiceUtil;
...
/**
 * Provides the base implementation for the smart active benefit remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartActiveBenefitService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitService = (SmartActiveBenefitService)aopProxy;

		_setServiceUtilService(smartActiveBenefitService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartActiveBenefitService smartActiveBenefitService) {

		try {
			Field field = SmartActiveBenefitServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActiveBenefitLocalService
		smartActiveBenefitLocalService;

	protected SmartActiveBenefitService smartActiveBenefitService;
