...
import com.mypage.admin.product.service.TravelDomesticDurationLocalService;
...
/**
 * Provides the base implementation for the travel domestic duration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticDurationLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticDurationLocalServiceImpl
 * @generated
 */
public abstract class TravelDomesticDurationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticDurationLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticDurationLocalServiceUtil</code>.
	 */
	...
	@Override
	public TravelDomesticDuration addTravelDomesticDuration(
		TravelDomesticDuration travelDomesticDuration) {

		travelDomesticDuration.setNew(true);

		return travelDomesticDurationPersistence.update(travelDomesticDuration);
	}
	...
	public TravelDomesticDuration createTravelDomesticDuration(
		long travelDomesticDurationId) {

		return travelDomesticDurationPersistence.create(
	...
	@Override
	public TravelDomesticDuration deleteTravelDomesticDuration(
			long travelDomesticDurationId)
		throws PortalException {

		return travelDomesticDurationPersistence.remove(
			travelDomesticDurationId);
	}
	...
	public TravelDomesticDuration deleteTravelDomesticDuration(
		...
		return travelDomesticDurationPersistence.remove(travelDomesticDuration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelDomesticDuration.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelDomesticDurationPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelDomesticDurationPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public TravelDomesticDuration fetchTravelDomesticDuration(
		long travelDomesticDurationId) {

		return travelDomesticDurationPersistence.fetchByPrimaryKey(
			travelDomesticDurationId);
	}
	 ...
	 */
	@Override
	public TravelDomesticDuration getTravelDomesticDuration(
			long travelDomesticDurationId)
		throws PortalException {

		return travelDomesticDurationPersistence.findByPrimaryKey(
			travelDomesticDurationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelDomesticDuration.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelDomesticDurationLocalService.deleteTravelDomesticDuration(
			(TravelDomesticDuration)persistedModel);
	}

	public BasePersistence<TravelDomesticDuration> getBasePersistence() {
		return travelDomesticDurationPersistence;
	}
	 ...
	 */
	@Override
	public List<TravelDomesticDuration> getTravelDomesticDurations(
		int start, int end) {

		return travelDomesticDurationPersistence.findAll(start, end);
	}
	...
	public int getTravelDomesticDurationsCount() {
		return travelDomesticDurationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TravelDomesticDuration updateTravelDomesticDuration(
		TravelDomesticDuration travelDomesticDuration) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticDurationLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelDomesticDurationLocalService =
			(TravelDomesticDurationLocalService)aopProxy;

		_setLocalServiceUtilService(travelDomesticDurationLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticDurationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				travelDomesticDurationPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelDomesticDurationLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticDurationLocalService);
		}
	...
	protected TravelDomesticDurationLocalService
		travelDomesticDurationLocalService;
