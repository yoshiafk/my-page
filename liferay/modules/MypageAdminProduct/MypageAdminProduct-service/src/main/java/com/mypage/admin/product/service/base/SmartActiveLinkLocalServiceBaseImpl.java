...
/**
 * Provides the base implementation for the smart active link local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveLinkLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveLinkLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveLinkLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveLinkLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveLinkLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveLink addSmartActiveLink(SmartActiveLink smartActiveLink) {
		smartActiveLink.setNew(true);

		return smartActiveLinkPersistence.update(smartActiveLink);
	}
	...
	public SmartActiveLink createSmartActiveLink(long smartActiveLinkId) {
		return smartActiveLinkPersistence.create(smartActiveLinkId);
	}
	...
	@Override
	public SmartActiveLink deleteSmartActiveLink(long smartActiveLinkId)
		throws PortalException {

		return smartActiveLinkPersistence.remove(smartActiveLinkId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SmartActiveLink deleteSmartActiveLink(
		SmartActiveLink smartActiveLink) {

		return smartActiveLinkPersistence.remove(smartActiveLink);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveLink.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveLinkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartActiveLinkPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveLinkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return smartActiveLinkPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SmartActiveLink fetchSmartActiveLink(long smartActiveLinkId) {
		return smartActiveLinkPersistence.fetchByPrimaryKey(smartActiveLinkId);
	}
	 ...
	 */
	@Override
	public SmartActiveLink getSmartActiveLink(long smartActiveLinkId)
		throws PortalException {

		return smartActiveLinkPersistence.findByPrimaryKey(smartActiveLinkId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(smartActiveLinkLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SmartActiveLink.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("smartActiveLinkId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartActiveLink.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveLinkPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveLinkLocalService.deleteSmartActiveLink(
			(SmartActiveLink)persistedModel);
	}

	public BasePersistence<SmartActiveLink> getBasePersistence() {
		return smartActiveLinkPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartActiveLinkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartActiveLink> getSmartActiveLinks(int start, int end) {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveLink updateSmartActiveLink(
		SmartActiveLink smartActiveLink) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveLinkLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveLinkLocalService = (SmartActiveLinkLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveLinkLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveLinkLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = smartActiveLinkPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveLinkLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartActiveLinkLocalService);
		}
	...
	protected SmartActiveLinkLocalService smartActiveLinkLocalService;
