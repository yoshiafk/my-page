...
import com.mypage.admin.product.service.HealthIndividuPremiService;
import com.mypage.admin.product.service.HealthIndividuPremiServiceUtil;
...
/**
 * Provides the base implementation for the health individu premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthIndividuPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthIndividuPremiServiceImpl
 * @generated
 */
public abstract class HealthIndividuPremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthIndividuPremiService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthIndividuPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthIndividuPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthIndividuPremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthIndividuPremiService = (HealthIndividuPremiService)aopProxy;

		_setServiceUtilService(healthIndividuPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthIndividuPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = HealthIndividuPremiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthIndividuPremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.HealthIndividuPremiLocalService
		healthIndividuPremiLocalService;

	protected HealthIndividuPremiService healthIndividuPremiService;
