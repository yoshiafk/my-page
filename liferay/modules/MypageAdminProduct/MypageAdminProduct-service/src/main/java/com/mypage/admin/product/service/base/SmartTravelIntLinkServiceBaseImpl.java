...
import com.mypage.admin.product.service.SmartTravelIntLinkService;
import com.mypage.admin.product.service.SmartTravelIntLinkServiceUtil;
...
/**
 * Provides the base implementation for the smart travel int link remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartTravelIntLinkServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartTravelIntLinkServiceImpl
 * @generated
 */
public abstract class SmartTravelIntLinkServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartTravelIntLinkService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartTravelIntLinkService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartTravelIntLinkServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartTravelIntLinkService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartTravelIntLinkService = (SmartTravelIntLinkService)aopProxy;

		_setServiceUtilService(smartTravelIntLinkService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartTravelIntLinkService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartTravelIntLinkService smartTravelIntLinkService) {

		try {
			Field field = SmartTravelIntLinkServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartTravelIntLinkService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartTravelIntLinkLocalService
		smartTravelIntLinkLocalService;

	protected SmartTravelIntLinkService smartTravelIntLinkService;
