...
import com.mypage.admin.product.service.HealthSmePremiLocalService;
import com.mypage.admin.product.service.HealthSmePremiLocalServiceUtil;
...
/**
 * Provides the base implementation for the health sme premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmePremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmePremiLocalServiceImpl
 * @generated
 */
public abstract class HealthSmePremiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthSmePremiLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmePremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmePremiLocalServiceUtil</code>.
	 */
	...
	public HealthSmePremi addHealthSmePremi(HealthSmePremi healthSmePremi) {
		...
		return healthSmePremiPersistence.update(healthSmePremi);
	}
	...
	public HealthSmePremi createHealthSmePremi(long healthSmePremiId) {
		return healthSmePremiPersistence.create(healthSmePremiId);
	}
	...
	public HealthSmePremi deleteHealthSmePremi(long healthSmePremiId)
		...
		return healthSmePremiPersistence.remove(healthSmePremiId);
	}
	...
	public HealthSmePremi deleteHealthSmePremi(HealthSmePremi healthSmePremi) {
		return healthSmePremiPersistence.remove(healthSmePremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthSmePremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthSmePremiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return healthSmePremiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthSmePremiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return healthSmePremiPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public HealthSmePremi fetchHealthSmePremi(long healthSmePremiId) {
		return healthSmePremiPersistence.fetchByPrimaryKey(healthSmePremiId);
	}
	...
	public HealthSmePremi getHealthSmePremi(long healthSmePremiId)
		...
		return healthSmePremiPersistence.findByPrimaryKey(healthSmePremiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(healthSmePremiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HealthSmePremi.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("healthSmePremiId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			healthSmePremiLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(HealthSmePremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmePremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return healthSmePremiLocalService.deleteHealthSmePremi(
			(HealthSmePremi)persistedModel);
	}

	public BasePersistence<HealthSmePremi> getBasePersistence() {
		return healthSmePremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmePremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<HealthSmePremi> getHealthSmePremis(int start, int end) {
		return healthSmePremiPersistence.findAll(start, end);
	}
	...
	public int getHealthSmePremisCount() {
		return healthSmePremiPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmePremiLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		healthSmePremiLocalService = (HealthSmePremiLocalService)aopProxy;

		_setLocalServiceUtilService(healthSmePremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmePremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = healthSmePremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = HealthSmePremiLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthSmePremiLocalService);
		}
	...
	protected HealthSmePremiLocalService healthSmePremiLocalService;
