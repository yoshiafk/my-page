...
import com.mypage.admin.product.service.PetRemarksService;
import com.mypage.admin.product.service.PetRemarksServiceUtil;
...
/**
 * Provides the base implementation for the pet remarks remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetRemarksServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetRemarksServiceImpl
 * @generated
 */
public abstract class PetRemarksServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PetRemarksService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetRemarksService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetRemarksServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetRemarksService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		petRemarksService = (PetRemarksService)aopProxy;

		_setServiceUtilService(petRemarksService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetRemarksService.class.getName();
	}
	...
	private void _setServiceUtilService(PetRemarksService petRemarksService) {
		try {
			Field field = PetRemarksServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petRemarksService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PetRemarksLocalService
		petRemarksLocalService;

	protected PetRemarksService petRemarksService;
