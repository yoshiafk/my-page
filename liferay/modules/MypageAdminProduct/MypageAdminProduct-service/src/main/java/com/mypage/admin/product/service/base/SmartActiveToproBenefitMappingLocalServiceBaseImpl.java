...
/**
 * Provides the base implementation for the smart active topro benefit mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveToproBenefitMappingLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveToproBenefitMappingLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveToproBenefitMappingLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveToproBenefitMappingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveToproBenefitMappingLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveToproBenefitMapping addSmartActiveToproBenefitMapping(
		SmartActiveToproBenefitMapping smartActiveToproBenefitMapping) {

		smartActiveToproBenefitMapping.setNew(true);

		return smartActiveToproBenefitMappingPersistence.update(
	...
	public SmartActiveToproBenefitMapping createSmartActiveToproBenefitMapping(
		long smartActiveToproBenefitMappingId) {

		return smartActiveToproBenefitMappingPersistence.create(
	...
	@Override
	public SmartActiveToproBenefitMapping deleteSmartActiveToproBenefitMapping(
			long smartActiveToproBenefitMappingId)
		throws PortalException {

		return smartActiveToproBenefitMappingPersistence.remove(
			smartActiveToproBenefitMappingId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveToproBenefitMapping.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveToproBenefitMappingPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveToproBenefitMappingPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartActiveToproBenefitMapping fetchSmartActiveToproBenefitMapping(
		long smartActiveToproBenefitMappingId) {

		return smartActiveToproBenefitMappingPersistence.fetchByPrimaryKey(
			smartActiveToproBenefitMappingId);
	}
	 ...
	 */
	@Override
	public SmartActiveToproBenefitMapping getSmartActiveToproBenefitMapping(
			long smartActiveToproBenefitMappingId)
		throws PortalException {

		return smartActiveToproBenefitMappingPersistence.findByPrimaryKey(
			smartActiveToproBenefitMappingId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveToproBenefitMappingLocalService.
			deleteSmartActiveToproBenefitMapping(
				(SmartActiveToproBenefitMapping)persistedModel);
	}

	public BasePersistence<SmartActiveToproBenefitMapping>
		getBasePersistence() {

		return smartActiveToproBenefitMappingPersistence;
	}
	 ...
	 */
	@Override
	public List<SmartActiveToproBenefitMapping>
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveToproBenefitMapping updateSmartActiveToproBenefitMapping(
		SmartActiveToproBenefitMapping smartActiveToproBenefitMapping) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveToproBenefitMappingLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveToproBenefitMappingLocalService =
			(SmartActiveToproBenefitMappingLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveToproBenefitMappingLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveToproBenefitMappingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveToproBenefitMappingPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveToproBenefitMappingLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, smartActiveToproBenefitMappingLocalService);
		}
	...
	protected SmartActiveToproBenefitMappingLocalService
		smartActiveToproBenefitMappingLocalService;
