...
/**
 * Provides the base implementation for the master bank local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterBankLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterBankLocalServiceImpl
 * @generated
 */
public abstract class MasterBankLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterBankLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterBankLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterBankLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterBank addMasterBank(MasterBank masterBank) {
		masterBank.setNew(true);

		return masterBankPersistence.update(masterBank);
	}
	...
	public MasterBank createMasterBank(long masterBankId) {
		return masterBankPersistence.create(masterBankId);
	}
	...
	@Override
	public MasterBank deleteMasterBank(long masterBankId)
		throws PortalException {

		return masterBankPersistence.remove(masterBankId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterBank deleteMasterBank(MasterBank masterBank) {
		return masterBankPersistence.remove(masterBank);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterBank.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterBankPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterBankPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterBankPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterBankPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterBank fetchMasterBank(long masterBankId) {
		return masterBankPersistence.fetchByPrimaryKey(masterBankId);
	}
	 ...
	 */
	@Override
	public MasterBank getMasterBank(long masterBankId) throws PortalException {
		return masterBankPersistence.findByPrimaryKey(masterBankId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterBankLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterBank.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterBankId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterBankLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterBank.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterBankPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterBankLocalService.deleteMasterBank(
			(MasterBank)persistedModel);
	}

	public BasePersistence<MasterBank> getBasePersistence() {
		return masterBankPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterBankPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterBank> getMasterBanks(int start, int end) {
		return masterBankPersistence.findAll(start, end);
	}
	...
	public int getMasterBanksCount() {
		return masterBankPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterBank updateMasterBank(MasterBank masterBank) {
		return masterBankPersistence.update(masterBank);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterBankLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterBankLocalService = (MasterBankLocalService)aopProxy;

		_setLocalServiceUtilService(masterBankLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterBankLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterBankPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterBankLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterBankLocalService);
		}
	...
	protected MasterBankLocalService masterBankLocalService;
