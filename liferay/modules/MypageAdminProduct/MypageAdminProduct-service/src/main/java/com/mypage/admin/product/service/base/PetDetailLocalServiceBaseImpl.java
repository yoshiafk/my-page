...
import com.mypage.admin.product.service.PetDetailLocalService;
import com.mypage.admin.product.service.PetDetailLocalServiceUtil;
...
/**
 * Provides the base implementation for the pet detail local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetDetailLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetDetailLocalServiceImpl
 * @generated
 */
public abstract class PetDetailLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PetDetailLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetDetailLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetDetailLocalServiceUtil</code>.
	 */
	...
	@Override
	public PetDetail addPetDetail(PetDetail petDetail) {
		petDetail.setNew(true);

		return petDetailPersistence.update(petDetail);
	}
	...
	public PetDetail createPetDetail(long petDetailId) {
		return petDetailPersistence.create(petDetailId);
	}
	...
	@Override
	public PetDetail deletePetDetail(long petDetailId) throws PortalException {
		return petDetailPersistence.remove(petDetailId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PetDetail deletePetDetail(PetDetail petDetail) {
		return petDetailPersistence.remove(petDetail);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PetDetail.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return petDetailPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return petDetailPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return petDetailPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return petDetailPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PetDetail fetchPetDetail(long petDetailId) {
		return petDetailPersistence.fetchByPrimaryKey(petDetailId);
	}
	 ...
	 */
	@Override
	public PetDetail getPetDetail(long petDetailId) throws PortalException {
		return petDetailPersistence.findByPrimaryKey(petDetailId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(petDetailLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PetDetail.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("petDetailId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			petDetailLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PetDetail.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return petDetailPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return petDetailLocalService.deletePetDetail((PetDetail)persistedModel);
	}

	public BasePersistence<PetDetail> getBasePersistence() {
		return petDetailPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return petDetailPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PetDetail> getPetDetails(int start, int end) {
		return petDetailPersistence.findAll(start, end);
	}
	...
	public int getPetDetailsCount() {
		return petDetailPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PetDetail updatePetDetail(PetDetail petDetail) {
		return petDetailPersistence.update(petDetail);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetDetailLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		petDetailLocalService = (PetDetailLocalService)aopProxy;

		_setLocalServiceUtilService(petDetailLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetDetailLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = petDetailPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PetDetailLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, petDetailLocalService);
		}
	...
	protected PetDetailLocalService petDetailLocalService;
