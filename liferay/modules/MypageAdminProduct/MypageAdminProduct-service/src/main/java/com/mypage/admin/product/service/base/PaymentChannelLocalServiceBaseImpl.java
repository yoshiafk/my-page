...
/**
 * Provides the base implementation for the payment channel local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PaymentChannelLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PaymentChannelLocalServiceImpl
 * @generated
 */
public abstract class PaymentChannelLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PaymentChannelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PaymentChannelLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PaymentChannelLocalServiceUtil</code>.
	 */
	...
	@Override
	public PaymentChannel addPaymentChannel(PaymentChannel paymentChannel) {
		paymentChannel.setNew(true);

		return paymentChannelPersistence.update(paymentChannel);
	}
	...
	public PaymentChannel createPaymentChannel(long paymentChannelId) {
		return paymentChannelPersistence.create(paymentChannelId);
	}
	...
	@Override
	public PaymentChannel deletePaymentChannel(long paymentChannelId)
		throws PortalException {

		return paymentChannelPersistence.remove(paymentChannelId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public PaymentChannel deletePaymentChannel(PaymentChannel paymentChannel) {
		return paymentChannelPersistence.remove(paymentChannel);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PaymentChannel.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return paymentChannelPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return paymentChannelPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return paymentChannelPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return paymentChannelPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public PaymentChannel fetchPaymentChannel(long paymentChannelId) {
		return paymentChannelPersistence.fetchByPrimaryKey(paymentChannelId);
	}
	 ...
	 */
	@Override
	public PaymentChannel getPaymentChannel(long paymentChannelId)
		throws PortalException {

		return paymentChannelPersistence.findByPrimaryKey(paymentChannelId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(paymentChannelLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PaymentChannel.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("paymentChannelId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			paymentChannelLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PaymentChannel.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return paymentChannelPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return paymentChannelLocalService.deletePaymentChannel(
			(PaymentChannel)persistedModel);
	}

	public BasePersistence<PaymentChannel> getBasePersistence() {
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return paymentChannelPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<PaymentChannel> getPaymentChannels(int start, int end) {
		return paymentChannelPersistence.findAll(start, end);
	}
	...
	public int getPaymentChannelsCount() {
		return paymentChannelPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public PaymentChannel updatePaymentChannel(PaymentChannel paymentChannel) {
		return paymentChannelPersistence.update(paymentChannel);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PaymentChannelLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		paymentChannelLocalService = (PaymentChannelLocalService)aopProxy;

		_setLocalServiceUtilService(paymentChannelLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PaymentChannelLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = paymentChannelPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = PaymentChannelLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, paymentChannelLocalService);
		}
	...
	protected PaymentChannelLocalService paymentChannelLocalService;
