...
/**
 * Provides the base implementation for the company type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.CompanyTypeLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.CompanyTypeLocalServiceImpl
 * @generated
 */
public abstract class CompanyTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, CompanyTypeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CompanyTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CompanyTypeLocalServiceUtil</code>.
	 */
	...
	public CompanyType addCompanyType(CompanyType companyType) {
		...
		return companyTypePersistence.update(companyType);
	}
	...
	public CompanyType createCompanyType(long companyTypeId) {
		return companyTypePersistence.create(companyTypeId);
	}
	...
	@Override
	public CompanyType deleteCompanyType(long companyTypeId)
		throws PortalException {

		return companyTypePersistence.remove(companyTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public CompanyType deleteCompanyType(CompanyType companyType) {
		return companyTypePersistence.remove(companyType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			CompanyType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return companyTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return companyTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return companyTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return companyTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public CompanyType fetchCompanyType(long companyTypeId) {
		return companyTypePersistence.fetchByPrimaryKey(companyTypeId);
	}
	 ...
	 */
	@Override
	public CompanyType getCompanyType(long companyTypeId)
		throws PortalException {

		return companyTypePersistence.findByPrimaryKey(companyTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(companyTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(CompanyType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("companyTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			companyTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(CompanyType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return companyTypePersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return companyTypeLocalService.deleteCompanyType(
			(CompanyType)persistedModel);
	}

	public BasePersistence<CompanyType> getBasePersistence() {
		return companyTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return companyTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CompanyTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		companyTypeLocalService = (CompanyTypeLocalService)aopProxy;

		_setLocalServiceUtilService(companyTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CompanyTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = companyTypePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = CompanyTypeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, companyTypeLocalService);
		}
	...
	protected CompanyTypeLocalService companyTypeLocalService;
