...
/**
 * Provides the base implementation for the smart health plan local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthPlanLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthPlanLocalServiceImpl
 * @generated
 */
public abstract class SmartHealthPlanLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthPlanLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthPlanLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartHealthPlan addSmartHealthPlan(SmartHealthPlan smartHealthPlan) {
		smartHealthPlan.setNew(true);

		return smartHealthPlanPersistence.update(smartHealthPlan);
	}
	...
	public SmartHealthPlan createSmartHealthPlan(long smartHealthPlanId) {
		return smartHealthPlanPersistence.create(smartHealthPlanId);
	}
	...
	@Override
	public SmartHealthPlan deleteSmartHealthPlan(long smartHealthPlanId)
		throws PortalException {

		return smartHealthPlanPersistence.remove(smartHealthPlanId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public SmartHealthPlan deleteSmartHealthPlan(
		SmartHealthPlan smartHealthPlan) {

		return smartHealthPlanPersistence.remove(smartHealthPlan);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartHealthPlan.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartHealthPlanPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return smartHealthPlanPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartHealthPlanPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return smartHealthPlanPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public SmartHealthPlan fetchSmartHealthPlan(long smartHealthPlanId) {
		return smartHealthPlanPersistence.fetchByPrimaryKey(smartHealthPlanId);
	}
	 ...
	 */
	@Override
	public SmartHealthPlan getSmartHealthPlan(long smartHealthPlanId)
		throws PortalException {

		return smartHealthPlanPersistence.findByPrimaryKey(smartHealthPlanId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(smartHealthPlanLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(SmartHealthPlan.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("smartHealthPlanId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(SmartHealthPlan.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return smartHealthPlanPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartHealthPlanLocalService.deleteSmartHealthPlan(
			(SmartHealthPlan)persistedModel);
	}

	public BasePersistence<SmartHealthPlan> getBasePersistence() {
		return smartHealthPlanPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return smartHealthPlanPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<SmartHealthPlan> getSmartHealthPlans(int start, int end) {
		return smartHealthPlanPersistence.findAll(start, end);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartHealthPlan updateSmartHealthPlan(
		SmartHealthPlan smartHealthPlan) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthPlanLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartHealthPlanLocalService = (SmartHealthPlanLocalService)aopProxy;

		_setLocalServiceUtilService(smartHealthPlanLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthPlanLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = smartHealthPlanPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartHealthPlanLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, smartHealthPlanLocalService);
		}
	...
	protected SmartHealthPlanLocalService smartHealthPlanLocalService;
