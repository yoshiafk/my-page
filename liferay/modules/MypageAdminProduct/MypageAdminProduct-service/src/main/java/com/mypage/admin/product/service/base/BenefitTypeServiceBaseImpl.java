...
import com.mypage.admin.product.service.BenefitTypeService;
import com.mypage.admin.product.service.BenefitTypeServiceUtil;
...
/**
 * Provides the base implementation for the benefit type remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BenefitTypeServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BenefitTypeServiceImpl
 * @generated
 */
public abstract class BenefitTypeServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BenefitTypeService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BenefitTypeService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BenefitTypeServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BenefitTypeService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		benefitTypeService = (BenefitTypeService)aopProxy;

		_setServiceUtilService(benefitTypeService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenefitTypeService.class.getName();
	}
	...
	private void _setServiceUtilService(BenefitTypeService benefitTypeService) {
		try {
			Field field = BenefitTypeServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, benefitTypeService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.BenefitTypeLocalService
