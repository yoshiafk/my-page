...
import com.mypage.admin.product.service.IndustryCategoryService;
import com.mypage.admin.product.service.IndustryCategoryServiceUtil;
...
/**
 * Provides the base implementation for the industry category remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.IndustryCategoryServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.IndustryCategoryServiceImpl
 * @generated
 */
public abstract class IndustryCategoryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, IndustryCategoryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IndustryCategoryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>IndustryCategoryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IndustryCategoryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		industryCategoryService = (IndustryCategoryService)aopProxy;

		_setServiceUtilService(industryCategoryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IndustryCategoryService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = IndustryCategoryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, industryCategoryService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.IndustryCategoryLocalService
