...
/**
 * Provides the base implementation for the benefit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BenefitLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BenefitLocalServiceImpl
 * @generated
 */
public abstract class BenefitLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BenefitLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BenefitLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BenefitLocalServiceUtil</code>.
	 */
	...
	public Benefit addBenefit(Benefit benefit) {
		...
		return benefitPersistence.update(benefit);
	}
	...
	public Benefit createBenefit(long benefitId) {
		return benefitPersistence.create(benefitId);
	}
	...
	@Override
	public Benefit deleteBenefit(long benefitId) throws PortalException {
		return benefitPersistence.remove(benefitId);
	}
	...
	public Benefit deleteBenefit(Benefit benefit) {
		return benefitPersistence.remove(benefit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Benefit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return benefitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return benefitPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return benefitPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return benefitPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public Benefit fetchBenefit(long benefitId) {
		return benefitPersistence.fetchByPrimaryKey(benefitId);
	}
	 ...
	 */
	@Override
	public Benefit getBenefit(long benefitId) throws PortalException {
		return benefitPersistence.findByPrimaryKey(benefitId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(benefitLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Benefit.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(Benefit.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return benefitPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return benefitLocalService.deleteBenefit((Benefit)persistedModel);
	}

	public BasePersistence<Benefit> getBasePersistence() {
		return benefitPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return benefitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BenefitLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		benefitLocalService = (BenefitLocalService)aopProxy;

		_setLocalServiceUtilService(benefitLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenefitLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = benefitPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = BenefitLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, benefitLocalService);
		}
	...
	protected BenefitLocalService benefitLocalService;
