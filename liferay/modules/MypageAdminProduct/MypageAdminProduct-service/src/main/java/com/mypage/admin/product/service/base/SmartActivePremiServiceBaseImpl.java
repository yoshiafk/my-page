...
import com.mypage.admin.product.service.SmartActivePremiService;
import com.mypage.admin.product.service.SmartActivePremiServiceUtil;
...
/**
 * Provides the base implementation for the smart active premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActivePremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActivePremiServiceImpl
 * @generated
 */
public abstract class SmartActivePremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartActivePremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActivePremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActivePremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActivePremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartActivePremiService = (SmartActivePremiService)aopProxy;

		_setServiceUtilService(smartActivePremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActivePremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartActivePremiService smartActivePremiService) {

		try {
			Field field = SmartActivePremiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartActivePremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartActivePremiLocalService
		smartActivePremiLocalService;

	protected SmartActivePremiService smartActivePremiService;
