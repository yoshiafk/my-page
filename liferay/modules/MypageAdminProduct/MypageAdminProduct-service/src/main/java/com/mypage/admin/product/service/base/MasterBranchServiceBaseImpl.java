...
import com.mypage.admin.product.service.MasterBranchService;
import com.mypage.admin.product.service.MasterBranchServiceUtil;
...
/**
 * Provides the base implementation for the master branch remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterBranchServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterBranchServiceImpl
 * @generated
 */
public abstract class MasterBranchServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterBranchService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterBranchService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterBranchServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterBranchService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterBranchService = (MasterBranchService)aopProxy;

		_setServiceUtilService(masterBranchService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterBranchService.class.getName();
	}
	...
	private void _setServiceUtilService(
		MasterBranchService masterBranchService) {

		try {
			Field field = MasterBranchServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterBranchService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterBranchLocalService
		masterBranchLocalService;

	protected MasterBranchService masterBranchService;
