...
/**
 * Provides the base implementation for the premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PremiLocalServiceImpl
 * @generated
 */
public abstract class PremiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, PremiLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PremiLocalServiceUtil</code>.
	 */
	...
	public Premi addPremi(Premi premi) {
		...
		return premiPersistence.update(premi);
	}
	...
	public Premi createPremi(long premiId) {
		return premiPersistence.create(premiId);
	}
	...
	public Premi deletePremi(long premiId) throws PortalException {
		return premiPersistence.remove(premiId);
	}
	...
	public Premi deletePremi(Premi premi) {
		return premiPersistence.remove(premi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Premi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return premiPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return premiPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return premiPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return premiPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return premiPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public Premi fetchPremi(long premiId) {
		return premiPersistence.fetchByPrimaryKey(premiId);
	}
	...
	public Premi getPremi(long premiId) throws PortalException {
		return premiPersistence.findByPrimaryKey(premiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(premiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Premi.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(premiLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Premi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return premiPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return premiLocalService.deletePremi((Premi)persistedModel);
	}

	public BasePersistence<Premi> getBasePersistence() {
		return premiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return premiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PremiLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		premiLocalService = (PremiLocalService)aopProxy;

		_setLocalServiceUtilService(premiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = premiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		PremiLocalService premiLocalService) {

		try {
			Field field = PremiLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, premiLocalService);
		}
	...
	protected PremiLocalService premiLocalService;
