...
import com.mypage.admin.product.service.BenefitValueMappingService;
import com.mypage.admin.product.service.BenefitValueMappingServiceUtil;
...
/**
 * Provides the base implementation for the benefit value mapping remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BenefitValueMappingServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BenefitValueMappingServiceImpl
 * @generated
 */
public abstract class BenefitValueMappingServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BenefitValueMappingService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BenefitValueMappingService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BenefitValueMappingServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BenefitValueMappingService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		benefitValueMappingService = (BenefitValueMappingService)aopProxy;

		_setServiceUtilService(benefitValueMappingService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BenefitValueMappingService.class.getName();
	}
	...
	private void _setServiceUtilService(
		BenefitValueMappingService benefitValueMappingService) {

		try {
			Field field = BenefitValueMappingServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, benefitValueMappingService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.BenefitValueMappingLocalService
		benefitValueMappingLocalService;

	protected BenefitValueMappingService benefitValueMappingService;
