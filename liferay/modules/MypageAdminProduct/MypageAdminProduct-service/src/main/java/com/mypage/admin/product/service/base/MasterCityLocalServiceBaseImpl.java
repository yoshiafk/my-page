...
/**
 * Provides the base implementation for the master city local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterCityLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterCityLocalServiceImpl
 * @generated
 */
public abstract class MasterCityLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterCityLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterCityLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterCityLocalServiceUtil</code>.
	 */
	...
	public MasterCity addMasterCity(MasterCity masterCity) {
		...
		return masterCityPersistence.update(masterCity);
	}
	...
	public MasterCity createMasterCity(long masterCityId) {
		return masterCityPersistence.create(masterCityId);
	}
	...
	public MasterCity deleteMasterCity(long masterCityId)
		...
		return masterCityPersistence.remove(masterCityId);
	}
	...
	public MasterCity deleteMasterCity(MasterCity masterCity) {
		return masterCityPersistence.remove(masterCity);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterCity.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterCityPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterCityPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterCityPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterCityPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterCity fetchMasterCity(long masterCityId) {
		return masterCityPersistence.fetchByPrimaryKey(masterCityId);
	}
	...
	public MasterCity getMasterCity(long masterCityId) throws PortalException {
		return masterCityPersistence.findByPrimaryKey(masterCityId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterCityLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterCity.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterCityId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterCityLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterCity.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterCityPersistence.create(((Long)primaryKeyObj).longValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterCityLocalService.deleteMasterCity(
			(MasterCity)persistedModel);
	}

	public BasePersistence<MasterCity> getBasePersistence() {
		return masterCityPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterCityPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MasterCity> getMasterCities(int start, int end) {
		return masterCityPersistence.findAll(start, end);
	}
	...
	public int getMasterCitiesCount() {
		return masterCityPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterCityLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterCityLocalService = (MasterCityLocalService)aopProxy;

		_setLocalServiceUtilService(masterCityLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterCityLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterCityPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterCityLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterCityLocalService);
		}
	...
	protected MasterCityLocalService masterCityLocalService;
