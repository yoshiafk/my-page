...
import com.mypage.admin.product.service.MasterBankService;
import com.mypage.admin.product.service.MasterBankServiceUtil;
...
/**
 * Provides the base implementation for the master bank remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterBankServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterBankServiceImpl
 * @generated
 */
public abstract class MasterBankServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterBankService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterBankService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterBankServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterBankService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterBankService = (MasterBankService)aopProxy;

		_setServiceUtilService(masterBankService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterBankService.class.getName();
	}
	...
	private void _setServiceUtilService(MasterBankService masterBankService) {
		try {
			Field field = MasterBankServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterBankService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterBankLocalService
		masterBankLocalService;

	protected MasterBankService masterBankService;
