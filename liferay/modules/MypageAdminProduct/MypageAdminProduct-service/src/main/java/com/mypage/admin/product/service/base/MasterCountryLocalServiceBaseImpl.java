...
/**
 * Provides the base implementation for the master country local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterCountryLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterCountryLocalServiceImpl
 * @generated
 */
public abstract class MasterCountryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterCountryLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterCountryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterCountryLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterCountry addMasterCountry(MasterCountry masterCountry) {
		masterCountry.setNew(true);

		return masterCountryPersistence.update(masterCountry);
	}
	...
	public MasterCountry createMasterCountry(long countryId) {
		return masterCountryPersistence.create(countryId);
	}
	...
	@Override
	public MasterCountry deleteMasterCountry(long countryId)
		throws PortalException {

		return masterCountryPersistence.remove(countryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterCountry deleteMasterCountry(MasterCountry masterCountry) {
		return masterCountryPersistence.remove(masterCountry);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterCountry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterCountryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterCountryPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterCountryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterCountryPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterCountry fetchMasterCountry(long countryId) {
		return masterCountryPersistence.fetchByPrimaryKey(countryId);
	}
	 ...
	 */
	@Override
	public MasterCountry getMasterCountry(long countryId)
		throws PortalException {

		return masterCountryPersistence.findByPrimaryKey(countryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterCountryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterCountry.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterCountryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterCountry.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterCountryPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterCountryLocalService.deleteMasterCountry(
			(MasterCountry)persistedModel);
	}

	public BasePersistence<MasterCountry> getBasePersistence() {
		return masterCountryPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterCountryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterCountry> getMasterCountries(int start, int end) {
		return masterCountryPersistence.findAll(start, end);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterCountry updateMasterCountry(MasterCountry masterCountry) {
		return masterCountryPersistence.update(masterCountry);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterCountryLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterCountryLocalService = (MasterCountryLocalService)aopProxy;

		_setLocalServiceUtilService(masterCountryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterCountryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterCountryPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterCountryLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterCountryLocalService);
		}
	...
	protected MasterCountryLocalService masterCountryLocalService;
