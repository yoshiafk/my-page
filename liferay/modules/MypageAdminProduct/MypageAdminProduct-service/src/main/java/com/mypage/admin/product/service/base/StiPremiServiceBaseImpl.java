...
import com.mypage.admin.product.service.StiPremiService;
import com.mypage.admin.product.service.StiPremiServiceUtil;
...
/**
 * Provides the base implementation for the sti premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.StiPremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.StiPremiServiceImpl
 * @generated
 */
public abstract class StiPremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, StiPremiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>StiPremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>StiPremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			StiPremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		stiPremiService = (StiPremiService)aopProxy;

		_setServiceUtilService(stiPremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return StiPremiService.class.getName();
	}
	...
	private void _setServiceUtilService(StiPremiService stiPremiService) {
		try {
			Field field = StiPremiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, stiPremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.StiPremiLocalService
		stiPremiLocalService;

	protected StiPremiService stiPremiService;
