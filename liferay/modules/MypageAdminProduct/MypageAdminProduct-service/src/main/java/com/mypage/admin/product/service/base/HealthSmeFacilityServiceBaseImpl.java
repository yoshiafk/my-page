...
import com.mypage.admin.product.service.HealthSmeFacilityService;
import com.mypage.admin.product.service.HealthSmeFacilityServiceUtil;
...
/**
 * Provides the base implementation for the health sme facility remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmeFacilityServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmeFacilityServiceImpl
 * @generated
 */
public abstract class HealthSmeFacilityServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthSmeFacilityService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmeFacilityService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmeFacilityServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmeFacilityService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthSmeFacilityService = (HealthSmeFacilityService)aopProxy;

		_setServiceUtilService(healthSmeFacilityService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmeFacilityService.class.getName();
	}
	...
	private void _setServiceUtilService(
		HealthSmeFacilityService healthSmeFacilityService) {

		try {
			Field field = HealthSmeFacilityServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthSmeFacilityService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.HealthSmeFacilityLocalService
		healthSmeFacilityLocalService;

	protected HealthSmeFacilityService healthSmeFacilityService;
