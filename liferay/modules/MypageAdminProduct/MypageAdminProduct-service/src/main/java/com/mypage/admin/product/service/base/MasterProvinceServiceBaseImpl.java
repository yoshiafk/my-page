...
import com.mypage.admin.product.service.MasterProvinceService;
import com.mypage.admin.product.service.MasterProvinceServiceUtil;
...
/**
 * Provides the base implementation for the master province remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterProvinceServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterProvinceServiceImpl
 * @generated
 */
public abstract class MasterProvinceServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, MasterProvinceService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterProvinceService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterProvinceServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterProvinceService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		masterProvinceService = (MasterProvinceService)aopProxy;

		_setServiceUtilService(masterProvinceService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterProvinceService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = MasterProvinceServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterProvinceService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.MasterProvinceLocalService
		masterProvinceLocalService;

	protected MasterProvinceService masterProvinceService;
