...
import com.mypage.admin.product.service.TravelIntBenefitLocalService;
...
/**
 * Provides the base implementation for the travel int benefit local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelIntBenefitLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelIntBenefitLocalServiceImpl
 * @generated
 */
public abstract class TravelIntBenefitLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelIntBenefitLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelIntBenefitLocalServiceUtil</code>.
	 */
	...
	@Override
	public TravelIntBenefit addTravelIntBenefit(
		TravelIntBenefit travelIntBenefit) {

		travelIntBenefit.setNew(true);

		return travelIntBenefitPersistence.update(travelIntBenefit);
	}
	...
	public TravelIntBenefit createTravelIntBenefit(long travelIntBenefitId) {
		return travelIntBenefitPersistence.create(travelIntBenefitId);
	}
	...
	@Override
	public TravelIntBenefit deleteTravelIntBenefit(long travelIntBenefitId)
		throws PortalException {

		return travelIntBenefitPersistence.remove(travelIntBenefitId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TravelIntBenefit deleteTravelIntBenefit(
		TravelIntBenefit travelIntBenefit) {

		return travelIntBenefitPersistence.remove(travelIntBenefit);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			TravelIntBenefit.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return travelIntBenefitPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return travelIntBenefitPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return travelIntBenefitPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return travelIntBenefitPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public TravelIntBenefit fetchTravelIntBenefit(long travelIntBenefitId) {
		return travelIntBenefitPersistence.fetchByPrimaryKey(
			travelIntBenefitId);
	}
	 ...
	 */
	@Override
	public TravelIntBenefit getTravelIntBenefit(long travelIntBenefitId)
		throws PortalException {

		return travelIntBenefitPersistence.findByPrimaryKey(travelIntBenefitId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(TravelIntBenefit.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("travelIntBenefitId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(TravelIntBenefit.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return travelIntBenefitPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return travelIntBenefitLocalService.deleteTravelIntBenefit(
			(TravelIntBenefit)persistedModel);
	}

	public BasePersistence<TravelIntBenefit> getBasePersistence() {
		return travelIntBenefitPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return travelIntBenefitPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TravelIntBenefit updateTravelIntBenefit(
		TravelIntBenefit travelIntBenefit) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelIntBenefitLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		travelIntBenefitLocalService = (TravelIntBenefitLocalService)aopProxy;

		_setLocalServiceUtilService(travelIntBenefitLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelIntBenefitLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = travelIntBenefitPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				TravelIntBenefitLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, travelIntBenefitLocalService);
		}
	...
	protected TravelIntBenefitLocalService travelIntBenefitLocalService;
