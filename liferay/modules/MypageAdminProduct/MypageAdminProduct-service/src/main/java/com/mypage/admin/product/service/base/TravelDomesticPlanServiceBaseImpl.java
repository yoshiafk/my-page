...
import com.mypage.admin.product.service.TravelDomesticPlanService;
import com.mypage.admin.product.service.TravelDomesticPlanServiceUtil;
...
/**
 * Provides the base implementation for the travel domestic plan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.TravelDomesticPlanServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.TravelDomesticPlanServiceImpl
 * @generated
 */
public abstract class TravelDomesticPlanServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, TravelDomesticPlanService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>TravelDomesticPlanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TravelDomesticPlanServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			TravelDomesticPlanService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		travelDomesticPlanService = (TravelDomesticPlanService)aopProxy;

		_setServiceUtilService(travelDomesticPlanService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return TravelDomesticPlanService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = TravelDomesticPlanServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, travelDomesticPlanService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.TravelDomesticPlanLocalService
		travelDomesticPlanLocalService;

	protected TravelDomesticPlanService travelDomesticPlanService;
