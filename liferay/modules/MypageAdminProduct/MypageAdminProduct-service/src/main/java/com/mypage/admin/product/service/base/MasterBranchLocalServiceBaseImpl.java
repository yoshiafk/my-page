...
/**
 * Provides the base implementation for the master branch local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterBranchLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterBranchLocalServiceImpl
 * @generated
 */
public abstract class MasterBranchLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, MasterBranchLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterBranchLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterBranchLocalServiceUtil</code>.
	 */
	...
	@Override
	public MasterBranch addMasterBranch(MasterBranch masterBranch) {
	...
	public MasterBranch createMasterBranch(long masterBranchId) {
		return masterBranchPersistence.create(masterBranchId);
	}
	...
	@Override
	public MasterBranch deleteMasterBranch(long masterBranchId)
		throws PortalException {

		return masterBranchPersistence.remove(masterBranchId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public MasterBranch deleteMasterBranch(MasterBranch masterBranch) {
		return masterBranchPersistence.remove(masterBranch);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterBranch.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterBranchPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterBranchPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterBranchPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterBranchPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterBranch fetchMasterBranch(long masterBranchId) {
		return masterBranchPersistence.fetchByPrimaryKey(masterBranchId);
	}
	 ...
	 */
	@Override
	public MasterBranch getMasterBranch(long masterBranchId)
		throws PortalException {

		return masterBranchPersistence.findByPrimaryKey(masterBranchId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterBranchLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterBranch.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("masterBranchId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			masterBranchLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(MasterBranch.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterBranchPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterBranchLocalService.deleteMasterBranch(
			(MasterBranch)persistedModel);
	}

	public BasePersistence<MasterBranch> getBasePersistence() {
		return masterBranchPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterBranchPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<MasterBranch> getMasterBranches(int start, int end) {
		return masterBranchPersistence.findAll(start, end);
	}
	...
	public int getMasterBranchesCount() {
		return masterBranchPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public MasterBranch updateMasterBranch(MasterBranch masterBranch) {
		return masterBranchPersistence.update(masterBranch);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterBranchLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterBranchLocalService = (MasterBranchLocalService)aopProxy;

		_setLocalServiceUtilService(masterBranchLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterBranchLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterBranchPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = MasterBranchLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, masterBranchLocalService);
		}
	...
	protected MasterBranchLocalService masterBranchLocalService;
