...
/**
 * Provides the base implementation for the payment channel tenor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PaymentChannelTenorLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PaymentChannelTenorLocalServiceImpl
 * @generated
 */
public abstract class PaymentChannelTenorLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   PaymentChannelTenorLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PaymentChannelTenorLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PaymentChannelTenorLocalServiceUtil</code>.
	 */
	...
	public PaymentChannelTenor addPaymentChannelTenor(
		...
		return paymentChannelTenorPersistence.update(paymentChannelTenor);
	}
	...
	public PaymentChannelTenor createPaymentChannelTenor(
		...
		return paymentChannelTenorPersistence.create(paymentChannelTenorId);
	}
	...
	public PaymentChannelTenor deletePaymentChannelTenor(
		...
		return paymentChannelTenorPersistence.remove(paymentChannelTenorId);
	}
	...
	public PaymentChannelTenor deletePaymentChannelTenor(
		...
		return paymentChannelTenorPersistence.remove(paymentChannelTenor);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			PaymentChannelTenor.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return paymentChannelTenorPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return paymentChannelTenorPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public PaymentChannelTenor fetchPaymentChannelTenor(
		...
		return paymentChannelTenorPersistence.fetchByPrimaryKey(
	...
	public PaymentChannelTenor getPaymentChannelTenor(
		...
		return paymentChannelTenorPersistence.findByPrimaryKey(
			paymentChannelTenorId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(PaymentChannelTenor.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return paymentChannelTenorPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return paymentChannelTenorLocalService.deletePaymentChannelTenor(
			(PaymentChannelTenor)persistedModel);
	}

	public BasePersistence<PaymentChannelTenor> getBasePersistence() {
		return paymentChannelTenorPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return paymentChannelTenorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<PaymentChannelTenor> getPaymentChannelTenors(
		...
		return paymentChannelTenorPersistence.findAll(start, end);
	}
	...
	public int getPaymentChannelTenorsCount() {
		return paymentChannelTenorPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PaymentChannelTenorLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		paymentChannelTenorLocalService =
			(PaymentChannelTenorLocalService)aopProxy;

		_setLocalServiceUtilService(paymentChannelTenorLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PaymentChannelTenorLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				paymentChannelTenorPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				PaymentChannelTenorLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, paymentChannelTenorLocalService);
		}
	...
	protected PaymentChannelTenorLocalService paymentChannelTenorLocalService;
