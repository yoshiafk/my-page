...
import com.mypage.admin.product.service.PetRateService;
import com.mypage.admin.product.service.PetRateServiceUtil;
...
/**
 * Provides the base implementation for the pet rate remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.PetRateServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.PetRateServiceImpl
 * @generated
 */
public abstract class PetRateServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, PetRateService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>PetRateService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>PetRateServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			PetRateService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		petRateService = (PetRateService)aopProxy;

		_setServiceUtilService(petRateService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return PetRateService.class.getName();
	}
	...
	private void _setServiceUtilService(PetRateService petRateService) {
		try {
			Field field = PetRateServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, petRateService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.PetRateLocalService
		petRateLocalService;

	protected PetRateService petRateService;
