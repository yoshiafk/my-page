...
/**
 * Provides the base implementation for the master promo code local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.MasterPromoCodeLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.MasterPromoCodeLocalServiceImpl
 * @generated
 */
public abstract class MasterPromoCodeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService,
			   MasterPromoCodeLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>MasterPromoCodeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>MasterPromoCodeLocalServiceUtil</code>.
	 */
	...
	public MasterPromoCode addMasterPromoCode(MasterPromoCode masterPromoCode) {
		...
		return masterPromoCodePersistence.update(masterPromoCode);
	}
	...
	public MasterPromoCode createMasterPromoCode(long promoCodeId) {
		return masterPromoCodePersistence.create(promoCodeId);
	}
	...
	public MasterPromoCode deleteMasterPromoCode(long promoCodeId)
		...
		return masterPromoCodePersistence.remove(promoCodeId);
	}
	...
	public MasterPromoCode deleteMasterPromoCode(
		...
		return masterPromoCodePersistence.remove(masterPromoCode);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			MasterPromoCode.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return masterPromoCodePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return masterPromoCodePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return masterPromoCodePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return masterPromoCodePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public MasterPromoCode fetchMasterPromoCode(long promoCodeId) {
		return masterPromoCodePersistence.fetchByPrimaryKey(promoCodeId);
	}
	...
	public MasterPromoCode getMasterPromoCode(long promoCodeId)
		...
		return masterPromoCodePersistence.findByPrimaryKey(promoCodeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(masterPromoCodeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(MasterPromoCode.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("promoCodeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(MasterPromoCode.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return masterPromoCodePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return masterPromoCodeLocalService.deleteMasterPromoCode(
			(MasterPromoCode)persistedModel);
	}

	public BasePersistence<MasterPromoCode> getBasePersistence() {
		return masterPromoCodePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return masterPromoCodePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<MasterPromoCode> getMasterPromoCodes(int start, int end) {
		return masterPromoCodePersistence.findAll(start, end);
	}
	...
	public int getMasterPromoCodesCount() {
		return masterPromoCodePersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			MasterPromoCodeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		masterPromoCodeLocalService = (MasterPromoCodeLocalService)aopProxy;

		_setLocalServiceUtilService(masterPromoCodeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return MasterPromoCodeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = masterPromoCodePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				MasterPromoCodeLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, masterPromoCodeLocalService);
		}
	...
	protected MasterPromoCodeLocalService masterPromoCodeLocalService;
