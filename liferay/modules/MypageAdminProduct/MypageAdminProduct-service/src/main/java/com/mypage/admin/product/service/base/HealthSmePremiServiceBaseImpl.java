...
import com.mypage.admin.product.service.HealthSmePremiService;
import com.mypage.admin.product.service.HealthSmePremiServiceUtil;
...
/**
 * Provides the base implementation for the health sme premi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmePremiServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmePremiServiceImpl
 * @generated
 */
public abstract class HealthSmePremiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, HealthSmePremiService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmePremiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmePremiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmePremiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		healthSmePremiService = (HealthSmePremiService)aopProxy;

		_setServiceUtilService(healthSmePremiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmePremiService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = HealthSmePremiServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthSmePremiService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.HealthSmePremiLocalService
		healthSmePremiLocalService;

	protected HealthSmePremiService healthSmePremiService;
