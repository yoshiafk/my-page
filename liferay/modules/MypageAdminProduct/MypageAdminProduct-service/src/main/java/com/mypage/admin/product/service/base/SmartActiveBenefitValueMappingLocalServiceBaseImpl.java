...
/**
 * Provides the base implementation for the smart active benefit value mapping local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartActiveBenefitValueMappingLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartActiveBenefitValueMappingLocalServiceImpl
 * @generated
 */
public abstract class SmartActiveBenefitValueMappingLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartActiveBenefitValueMappingLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartActiveBenefitValueMappingLocalServiceUtil</code>.
	 */
	...
	@Override
	public SmartActiveBenefitValueMapping addSmartActiveBenefitValueMapping(
		SmartActiveBenefitValueMapping smartActiveBenefitValueMapping) {

		smartActiveBenefitValueMapping.setNew(true);

		return smartActiveBenefitValueMappingPersistence.update(
	...
	public SmartActiveBenefitValueMapping createSmartActiveBenefitValueMapping(
		long smartActiveBenefitValueMappingId) {

		return smartActiveBenefitValueMappingPersistence.create(
	...
	@Override
	public SmartActiveBenefitValueMapping deleteSmartActiveBenefitValueMapping(
			long smartActiveBenefitValueMappingId)
		throws PortalException {

		return smartActiveBenefitValueMappingPersistence.remove(
			smartActiveBenefitValueMappingId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			SmartActiveBenefitValueMapping.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return smartActiveBenefitValueMappingPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return smartActiveBenefitValueMappingPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public SmartActiveBenefitValueMapping fetchSmartActiveBenefitValueMapping(
		long smartActiveBenefitValueMappingId) {

		return smartActiveBenefitValueMappingPersistence.fetchByPrimaryKey(
			smartActiveBenefitValueMappingId);
	}
	 ...
	 */
	@Override
	public SmartActiveBenefitValueMapping getSmartActiveBenefitValueMapping(
			long smartActiveBenefitValueMappingId)
		throws PortalException {

		return smartActiveBenefitValueMappingPersistence.findByPrimaryKey(
			smartActiveBenefitValueMappingId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return smartActiveBenefitValueMappingLocalService.
			deleteSmartActiveBenefitValueMapping(
				(SmartActiveBenefitValueMapping)persistedModel);
	}

	public BasePersistence<SmartActiveBenefitValueMapping>
		getBasePersistence() {

		return smartActiveBenefitValueMappingPersistence;
	}
	 ...
	 */
	@Override
	public List<SmartActiveBenefitValueMapping>
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public SmartActiveBenefitValueMapping updateSmartActiveBenefitValueMapping(
		SmartActiveBenefitValueMapping smartActiveBenefitValueMapping) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartActiveBenefitValueMappingLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		smartActiveBenefitValueMappingLocalService =
			(SmartActiveBenefitValueMappingLocalService)aopProxy;

		_setLocalServiceUtilService(smartActiveBenefitValueMappingLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartActiveBenefitValueMappingLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				smartActiveBenefitValueMappingPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				SmartActiveBenefitValueMappingLocalServiceUtil.class.
					getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, smartActiveBenefitValueMappingLocalService);
		}
	...
	protected SmartActiveBenefitValueMappingLocalService
		smartActiveBenefitValueMappingLocalService;
