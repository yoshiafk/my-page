...
import com.mypage.admin.product.service.SmartHealthPlanService;
import com.mypage.admin.product.service.SmartHealthPlanServiceUtil;
...
/**
 * Provides the base implementation for the smart health plan remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.SmartHealthPlanServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.SmartHealthPlanServiceImpl
 * @generated
 */
public abstract class SmartHealthPlanServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, SmartHealthPlanService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>SmartHealthPlanService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>SmartHealthPlanServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			SmartHealthPlanService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		smartHealthPlanService = (SmartHealthPlanService)aopProxy;

		_setServiceUtilService(smartHealthPlanService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return SmartHealthPlanService.class.getName();
	}
	...
	private void _setServiceUtilService(
		SmartHealthPlanService smartHealthPlanService) {

		try {
			Field field = SmartHealthPlanServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, smartHealthPlanService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.SmartHealthPlanLocalService
		smartHealthPlanLocalService;

	protected SmartHealthPlanService smartHealthPlanService;
