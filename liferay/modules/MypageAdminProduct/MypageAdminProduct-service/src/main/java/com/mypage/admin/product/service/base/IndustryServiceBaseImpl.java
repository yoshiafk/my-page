...
import com.mypage.admin.product.service.IndustryService;
import com.mypage.admin.product.service.IndustryServiceUtil;
...
/**
 * Provides the base implementation for the industry remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.IndustryServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.IndustryServiceImpl
 * @generated
 */
public abstract class IndustryServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, IndustryService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>IndustryService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>IndustryServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			IndustryService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		industryService = (IndustryService)aopProxy;

		_setServiceUtilService(industryService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return IndustryService.class.getName();
	}
	...
	private void _setServiceUtilService(IndustryService industryService) {
		try {
			Field field = IndustryServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, industryService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.IndustryLocalService
