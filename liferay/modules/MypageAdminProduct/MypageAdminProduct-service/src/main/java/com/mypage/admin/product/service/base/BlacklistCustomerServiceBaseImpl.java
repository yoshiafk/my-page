...
import com.mypage.admin.product.service.BlacklistCustomerService;
import com.mypage.admin.product.service.BlacklistCustomerServiceUtil;
...
/**
 * Provides the base implementation for the blacklist customer remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BlacklistCustomerServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BlacklistCustomerServiceImpl
 * @generated
 */
public abstract class BlacklistCustomerServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BlacklistCustomerService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BlacklistCustomerService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BlacklistCustomerServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BlacklistCustomerService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		blacklistCustomerService = (BlacklistCustomerService)aopProxy;

		_setServiceUtilService(blacklistCustomerService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BlacklistCustomerService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = BlacklistCustomerServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, blacklistCustomerService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.BlacklistCustomerLocalService
		blacklistCustomerLocalService;

	protected BlacklistCustomerService blacklistCustomerService;
