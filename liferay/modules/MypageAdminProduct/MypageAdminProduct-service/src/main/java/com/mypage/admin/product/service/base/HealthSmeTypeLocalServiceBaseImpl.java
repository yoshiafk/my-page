...
import com.mypage.admin.product.service.HealthSmeTypeLocalService;
...
/**
 * Provides the base implementation for the health sme type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthSmeTypeLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthSmeTypeLocalServiceImpl
 * @generated
 */
public abstract class HealthSmeTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthSmeTypeLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthSmeTypeLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthSmeTypeLocalServiceUtil</code>.
	 */
	...
	@Override
	public HealthSmeType addHealthSmeType(HealthSmeType healthSmeType) {
		healthSmeType.setNew(true);

		return healthSmeTypePersistence.update(healthSmeType);
	}
	...
	public HealthSmeType createHealthSmeType(long healthSmeTypeId) {
		return healthSmeTypePersistence.create(healthSmeTypeId);
	}
	...
	@Override
	public HealthSmeType deleteHealthSmeType(long healthSmeTypeId)
		throws PortalException {

		return healthSmeTypePersistence.remove(healthSmeTypeId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public HealthSmeType deleteHealthSmeType(HealthSmeType healthSmeType) {
		return healthSmeTypePersistence.remove(healthSmeType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthSmeType.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthSmeTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return healthSmeTypePersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthSmeTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return healthSmeTypePersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public HealthSmeType fetchHealthSmeType(long healthSmeTypeId) {
		return healthSmeTypePersistence.fetchByPrimaryKey(healthSmeTypeId);
	}
	 ...
	 */
	@Override
	public HealthSmeType getHealthSmeType(long healthSmeTypeId)
		throws PortalException {

		return healthSmeTypePersistence.findByPrimaryKey(healthSmeTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(healthSmeTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HealthSmeType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("healthSmeTypeId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			healthSmeTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(HealthSmeType.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmeTypePersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return healthSmeTypeLocalService.deleteHealthSmeType(
			(HealthSmeType)persistedModel);
	}

	public BasePersistence<HealthSmeType> getBasePersistence() {
		return healthSmeTypePersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return healthSmeTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HealthSmeType> getHealthSmeTypes(int start, int end) {
		return healthSmeTypePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getHealthSmeTypesCount() {
		return healthSmeTypePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HealthSmeType updateHealthSmeType(HealthSmeType healthSmeType) {
		return healthSmeTypePersistence.update(healthSmeType);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthSmeTypeLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		healthSmeTypeLocalService = (HealthSmeTypeLocalService)aopProxy;

		_setLocalServiceUtilService(healthSmeTypeLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthSmeTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = healthSmeTypePersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		HealthSmeTypeLocalService healthSmeTypeLocalService) {

		try {
			Field field = HealthSmeTypeLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, healthSmeTypeLocalService);
		}
	...
	protected HealthSmeTypeLocalService healthSmeTypeLocalService;
