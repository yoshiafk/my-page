...
/**
 * Provides the base implementation for the blacklist customer local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.BlacklistCustomerLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.BlacklistCustomerLocalServiceImpl
 * @generated
 */
public abstract class BlacklistCustomerLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, BlacklistCustomerLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BlacklistCustomerLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BlacklistCustomerLocalServiceUtil</code>.
	 */
	...
	public BlacklistCustomer addBlacklistCustomer(
		...
		return blacklistCustomerPersistence.update(blacklistCustomer);
	}
	...
	public BlacklistCustomer createBlacklistCustomer(long blacklistCustomerId) {
		return blacklistCustomerPersistence.create(blacklistCustomerId);
	}
	...
	public BlacklistCustomer deleteBlacklistCustomer(long blacklistCustomerId)
		...
		return blacklistCustomerPersistence.remove(blacklistCustomerId);
	}
	...
	public BlacklistCustomer deleteBlacklistCustomer(
		...
		return blacklistCustomerPersistence.remove(blacklistCustomer);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			BlacklistCustomer.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return blacklistCustomerPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return blacklistCustomerPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return blacklistCustomerPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return blacklistCustomerPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public BlacklistCustomer fetchBlacklistCustomer(long blacklistCustomerId) {
		return blacklistCustomerPersistence.fetchByPrimaryKey(
			blacklistCustomerId);
	}
	...
	public BlacklistCustomer getBlacklistCustomer(long blacklistCustomerId)
		...
		return blacklistCustomerPersistence.findByPrimaryKey(
			blacklistCustomerId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			blacklistCustomerLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(BlacklistCustomer.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("blacklistCustomerId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(BlacklistCustomer.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return blacklistCustomerPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return blacklistCustomerLocalService.deleteBlacklistCustomer(
			(BlacklistCustomer)persistedModel);
	}

	public BasePersistence<BlacklistCustomer> getBasePersistence() {
		return blacklistCustomerPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return blacklistCustomerPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<BlacklistCustomer> getBlacklistCustomers(int start, int end) {
		return blacklistCustomerPersistence.findAll(start, end);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BlacklistCustomerLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		blacklistCustomerLocalService = (BlacklistCustomerLocalService)aopProxy;

		_setLocalServiceUtilService(blacklistCustomerLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BlacklistCustomerLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				blacklistCustomerPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				BlacklistCustomerLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, blacklistCustomerLocalService);
		}
	...
	protected BlacklistCustomerLocalService blacklistCustomerLocalService;
