...
import com.mypage.admin.product.service.ProductConfigurationService;
import com.mypage.admin.product.service.ProductConfigurationServiceUtil;
...
/**
 * Provides the base implementation for the product configuration remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.ProductConfigurationServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.ProductConfigurationServiceImpl
 * @generated
 */
public abstract class ProductConfigurationServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>ProductConfigurationService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>ProductConfigurationServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			ProductConfigurationService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		productConfigurationService = (ProductConfigurationService)aopProxy;

		_setServiceUtilService(productConfigurationService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProductConfigurationService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				ProductConfigurationServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, productConfigurationService);
		}
	...
	@Reference
	protected com.mypage.admin.product.service.ProductConfigurationLocalService
