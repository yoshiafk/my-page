...
import com.mypage.admin.product.service.HealthIndividuPremiLocalService;
import com.mypage.admin.product.service.HealthIndividuPremiLocalServiceUtil;
...
/**
 * Provides the base implementation for the health individu premi local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.mypage.admin.product.service.impl.HealthIndividuPremiLocalServiceImpl}.
 * </p>
 *
 * @author Gositus Team
 * @see com.mypage.admin.product.service.impl.HealthIndividuPremiLocalServiceImpl
 * @generated
 */
public abstract class HealthIndividuPremiLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, HealthIndividuPremiLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>HealthIndividuPremiLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>HealthIndividuPremiLocalServiceUtil</code>.
	 */
	...
	@Override
	public HealthIndividuPremi addHealthIndividuPremi(
		HealthIndividuPremi healthIndividuPremi) {

		healthIndividuPremi.setNew(true);

		return healthIndividuPremiPersistence.update(healthIndividuPremi);
	}
	...
	public HealthIndividuPremi createHealthIndividuPremi(
		long healthIndividuPremiId) {

		return healthIndividuPremiPersistence.create(healthIndividuPremiId);
	}
	...
	@Override
	public HealthIndividuPremi deleteHealthIndividuPremi(
			long healthIndividuPremiId)
		throws PortalException {

		return healthIndividuPremiPersistence.remove(healthIndividuPremiId);
	}
	...
	public HealthIndividuPremi deleteHealthIndividuPremi(
		...
		return healthIndividuPremiPersistence.remove(healthIndividuPremi);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			HealthIndividuPremi.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return healthIndividuPremiPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return healthIndividuPremiPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public HealthIndividuPremi fetchHealthIndividuPremi(
		long healthIndividuPremiId) {

		return healthIndividuPremiPersistence.fetchByPrimaryKey(
	 ...
	 */
	@Override
	public HealthIndividuPremi getHealthIndividuPremi(
			long healthIndividuPremiId)
		throws PortalException {

		return healthIndividuPremiPersistence.findByPrimaryKey(
			healthIndividuPremiId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			healthIndividuPremiLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(HealthIndividuPremi.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return healthIndividuPremiPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return healthIndividuPremiLocalService.deleteHealthIndividuPremi(
			(HealthIndividuPremi)persistedModel);
	}

	public BasePersistence<HealthIndividuPremi> getBasePersistence() {
		return healthIndividuPremiPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return healthIndividuPremiPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<HealthIndividuPremi> getHealthIndividuPremis(
		int start, int end) {

		return healthIndividuPremiPersistence.findAll(start, end);
	}
	...
	public int getHealthIndividuPremisCount() {
		return healthIndividuPremiPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public HealthIndividuPremi updateHealthIndividuPremi(
		HealthIndividuPremi healthIndividuPremi) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			HealthIndividuPremiLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		healthIndividuPremiLocalService =
			(HealthIndividuPremiLocalService)aopProxy;

		_setLocalServiceUtilService(healthIndividuPremiLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return HealthIndividuPremiLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				healthIndividuPremiPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				HealthIndividuPremiLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, healthIndividuPremiLocalService);
		}
	...
	protected HealthIndividuPremiLocalService healthIndividuPremiLocalService;
