...
@Component(immediate = true, property = { "panel.category.key=" + PanelCategoryKeys.SITE_ADMINISTRATION,
		"panel.category.order:Integer=10" }, service = PanelCategory.class)
public class MyPageAdminProductPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return MyPageAdminProductPanelCategoryKeys.MYPAGE_ADMIN_PRODUCT_CATEGORY;
	}

	@Override
	public String getLabel(Locale locale) {
		ResourceBundle resourceBundle = ResourceBundleUtil.getBundle("content.Language", locale, getClass());
		return LanguageUtil.get(resourceBundle, "mypage_admin_product_category");
	}
	...
	private static final Log log = LogFactoryUtil.getLog(MyPageAdminProductPanelCategory.class);
}
