...
<div class="container-fluid container-fluid-max-xl container-view">
	<div class="row">
		...
		<div class="col-lg-9">
			<portlet:actionURL name="importBenefitValue" var="importBenefitValueURL" />
			<aui:form method="post" action="<%= importBenefitValueURL %>"
						...
						<div class="col-md-6">
							<h2 class="sheet-title">
								<div class="d-flex">
									...
									<span class="pl-2 text-truncate">Import Benefit Value</span>
								</div>
							</h2>
						</div>
					</div>
