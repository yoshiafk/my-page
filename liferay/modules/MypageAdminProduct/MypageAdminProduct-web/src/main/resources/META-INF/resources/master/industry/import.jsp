...
<div class="container-fluid container-fluid-max-xl container-view">
	<div class="row">
		...
		<div class="col-lg-9">
			<portlet:actionURL name="importIndustry" var="importIndustryURL" />
			<aui:form method="post" action="<%=importIndustryURL%>"
						...
						<div class="col-md-6">
							<h2 class="sheet-title">
								<div class="d-flex">
									...
									<span class="pl-2 text-truncate">Import Master Industry</span>
								</div>
							</h2>
						</div>
					</div>
