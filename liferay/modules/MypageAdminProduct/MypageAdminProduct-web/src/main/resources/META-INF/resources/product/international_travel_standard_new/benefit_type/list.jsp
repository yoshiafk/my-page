...
<%
	...
	//Search Container
	SearchContainer entriesSearchContainerBenefitType = smartTravelInternationalDisplayContext.benefitTypeSearchContainer();
				...
				<aui:form action="<%=updateURL%>" name="fm">
					...
					<liferay-ui:search-container id="benefitTypeSearchContainer"
						...
						<liferay-ui:search-container-row
							className="com.mypage.admin.product.model.BenefitType"
							modelVar="benefitType" keyProperty="benefitTypeId">
							...
							<portlet:renderURL var="rowURL">
								...
								<portlet:param name="benefitTypeId"
									value="<%=String.valueOf(benefitType.getBenefitTypeId())%>" />
							</portlet:renderURL>
							...
							<liferay-ui:search-container-column-text property="benefitTypeId"
							...
							<liferay-ui:search-container-column-jsp name="Action"
								align="right" path="/product/international_travel_standard_new/benefit_type/action.jsp" />
