...
<%
	...
	if (benefitTypeId > 0) {
		benefitType = BenefitTypeLocalServiceUtil.fetchBenefitType(benefitTypeId);
	}
%>
				...
				<div class="sheet sheet-full">
					...
					<h2 class="sheet-title">
						<div class="row">
							...
							<div class="col-lg-4">
								<aui:input
									checked="<%=benefitTypeId != 0 && benefitType != null ? benefitType.getActive() == 1 ? true : false
						: true%>"
					...
					<div class="sheet-section">
						...
						<%
							if (benefitType != null) {
						%>
						<aui:input type="hidden" name="benefitTypeId"
