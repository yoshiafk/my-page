...
<div class="container-fluid container-fluid-max-xl container-view">
	<div class="row">
		...
		<div class="col-lg-9">
			<portlet:actionURL name="importOccupation" var="importOccupationURL" />
			<aui:form method="post" action="<%= importOccupationURL %>"
						...
						<div class="col-md-6">
							<h2 class="sheet-title">
								<div class="d-flex">
									...
									<span class="pl-2 text-truncate">Import Occupation</span>
								</div>
							</h2>
						</div>
					</div>
