...
<div class="container-fluid container-fluid-max-xl container-view">
	<div class="row">
		...
		<div class="col-lg-9">
			<portlet:actionURL name="importMasterCurrency"
				var="importMasterCurrencyURL" />
			<aui:form method="post" action="<%=importMasterCurrencyURL%>"
						...
						<div class="col-md-6">
							<h2 class="sheet-title">
								<div class="d-flex">
									...
									<span class="pl-2 text-truncate">Import Master Currency</span>
								</div>
							</h2>
						</div>
					</div>
