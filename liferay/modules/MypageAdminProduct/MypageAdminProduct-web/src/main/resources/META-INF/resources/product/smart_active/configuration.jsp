...
<%
	String _code = "SA";
	ProductConfiguration _config = ProductConfigurationLocalServiceUtil.getConfigByCode(_code);
%>
					...
					<div id="general" class="tab-items">
						<aui:fieldset-group markupView="lexicon">
							<aui:fieldset cssClass="pt-4 pl-4">
								...
								<aui:row>			
									<aui:col width="50">
										<aui:input value="<%= _code %>" label="Product Code" name="product_code" type="text" required="true" readonly="true" />
									</aui:col>
									<aui:col width="50">
