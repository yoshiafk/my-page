...
/**
 * Provides the local service interface for PaymentChannel. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see PaymentChannelLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PaymentChannelLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.PaymentChannelLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the payment channel local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PaymentChannelLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PaymentChannel setActive(
			long paymentChannelId, int active, ServiceContext serviceContext)
		throws PortalException;

	public PaymentChannel updatePaymentChannel(
