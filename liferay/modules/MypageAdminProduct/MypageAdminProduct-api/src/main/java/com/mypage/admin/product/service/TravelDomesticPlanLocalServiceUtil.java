...
/**
 * Provides the local service utility for TravelDomesticPlan. This utility wraps
 * <code>com.mypage.admin.product.service.impl.TravelDomesticPlanLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TravelDomesticPlanLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.TravelDomesticPlanLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static TravelDomesticPlan addTravelDomesticPlan(
		String name, String code, int toproTsi, int toproAtsi, int sort,
		int active) {

		return getService().addTravelDomesticPlan(
	...
	public static TravelDomesticPlan addTravelDomesticPlan(
		...
		return getService().addTravelDomesticPlan(travelDomesticPlan);
	}
	 ...
	 */
	public static TravelDomesticPlan createTravelDomesticPlan(
		long travelDomesticPlanId) {

		return getService().createTravelDomesticPlan(travelDomesticPlanId);
	}
	 ...
	 */
	public static TravelDomesticPlan deleteTravelDomesticPlan(
			long travelDomesticPlanId)
		throws PortalException {

		return getService().deleteTravelDomesticPlan(travelDomesticPlanId);
	}
	...
	public static TravelDomesticPlan deleteTravelDomesticPlan(
		...
		return getService().deleteTravelDomesticPlan(travelDomesticPlan);
	}
	...
	public static TravelDomesticPlan fetchTravelDomesticPlan(
		long travelDomesticPlanId) {

		return getService().fetchTravelDomesticPlan(travelDomesticPlanId);
	}
	 ...
	 * @throws PortalException if a travel domestic plan with the primary key could not be found
	 */
	public static TravelDomesticPlan getTravelDomesticPlan(
			long travelDomesticPlanId)
		throws PortalException {

		return getService().getTravelDomesticPlan(travelDomesticPlanId);
	}
	 ...
	 */
	public static List<TravelDomesticPlan> getTravelDomesticPlans(
		int start, int end) {

		return getService().getTravelDomesticPlans(start, end);
	}
	 ...
	 */
	public static int getTravelDomesticPlansCount() {
		return getService().getTravelDomesticPlansCount();
	}

	public static List<TravelDomesticPlan> searchByCode(String code) {
		return getService().searchByCode(code);
	}

	public static TravelDomesticPlan setActive(
	...
	public static TravelDomesticPlan updateTravelDomesticPlan(
		long travelDomesticPlanId, String name, String code, int toproTsi,
		int toproAtsi, int sort, int active) {

		return getService().updateTravelDomesticPlan(
	...
	public static TravelDomesticPlan updateTravelDomesticPlan(
		...
		return getService().updateTravelDomesticPlan(travelDomesticPlan);
	}

	public static TravelDomesticPlanLocalService getService() {
		return _service;
	}

	private static volatile TravelDomesticPlanLocalService _service;
