...
/**
 * Provides the local service interface for SmartActiveTopro. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartActiveToproLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartActiveToproLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveToproLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart active topro local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartActiveToproLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SmartActiveTopro addSmartActiveTopro(
		SmartActiveTopro smartActiveTopro);

	public SmartActiveTopro addTopro(
	...
	public SmartActiveTopro createSmartActiveTopro(long smartActiveToproId);
	...
	public SmartActiveTopro deleteSmartActiveTopro(long smartActiveToproId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public SmartActiveTopro deleteSmartActiveTopro(
		SmartActiveTopro smartActiveTopro);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SmartActiveTopro fetchSmartActiveTopro(long smartActiveToproId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SmartActiveTopro getSmartActiveTopro(long smartActiveToproId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SmartActiveTopro> getSmartActiveTopros(int start, int end);
	...
	public SmartActiveTopro setActive(
			long toproId, int active, ServiceContext serviceContext)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public SmartActiveTopro updateSmartActiveTopro(
		SmartActiveTopro smartActiveTopro);

	public SmartActiveTopro updateTopro(
