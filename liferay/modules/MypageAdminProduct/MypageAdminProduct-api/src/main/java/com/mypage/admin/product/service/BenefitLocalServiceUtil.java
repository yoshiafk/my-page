...
/**
 * Provides the local service utility for Benefit. This utility wraps
 * <code>com.mypage.admin.product.service.impl.BenefitLocalServiceImpl</code> and
 ...
 * @generated
 */
public class BenefitLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.BenefitLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Benefit addBenefit(Benefit benefit) {
		return getService().addBenefit(benefit);
	}

	public static Benefit addBenefit(
	 ...
	 */
	public static Benefit createBenefit(long benefitId) {
		return getService().createBenefit(benefitId);
	}
	 ...
	 */
	public static Benefit deleteBenefit(Benefit benefit) {
		return getService().deleteBenefit(benefit);
	}
	 ...
	 */
	public static Benefit deleteBenefit(long benefitId) throws PortalException {
		return getService().deleteBenefit(benefitId);
	}
	...
	public static Benefit fetchBenefit(long benefitId) {
		return getService().fetchBenefit(benefitId);
	}
	...
	public static List<Benefit> getActiveBenefit() {
	 ...
	 * @throws PortalException if a benefit with the primary key could not be found
	 */
	public static Benefit getBenefit(long benefitId) throws PortalException {
		return getService().getBenefit(benefitId);
	}

	public static List<Benefit> getBenefitByPlan(String plan, long typeId) {
		return getService().getBenefitByPlan(plan, typeId);
	}

	public static List<Benefit> getBenefitByTypeId(long typeId) {
	 ...
	 */
	public static List<Benefit> getBenefits(int start, int end) {
	 ...
	 */
	public static int getBenefitsCount() {
		return getService().getBenefitsCount();
	}
	...
	public static Benefit setActive(
	 ...
	 */
	public static Benefit updateBenefit(Benefit benefit) {
		return getService().updateBenefit(benefit);
	}

	public static Benefit updateBenefit(
	...
	public static BenefitLocalService getService() {
		return _service;
	}

	private static volatile BenefitLocalService _service;
