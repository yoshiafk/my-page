...
/**
 * Provides the local service interface for MasterGlobalVariable. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see MasterGlobalVariableLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MasterGlobalVariableLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterGlobalVariableLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the master global variable local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MasterGlobalVariableLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MasterGlobalVariable> getActiveGlobalVariableByGroup(
		String groupName);
	...
	public MasterGlobalVariable setActive(
