...
/**
 * Provides the local service utility for MasterCurrency. This utility wraps
 * <code>com.mypage.admin.product.service.impl.MasterCurrencyLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MasterCurrencyLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterCurrencyLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MasterCurrency addMasterCurrency(
		MasterCurrency masterCurrency) {

		return getService().addMasterCurrency(masterCurrency);
	}
	...
	public static MasterCurrency addMasterCurrency(
		...
		return getService().addMasterCurrency(
	 ...
	 */
	public static MasterCurrency createMasterCurrency(long currencyId) {
		return getService().createMasterCurrency(currencyId);
	}
	 ...
	 */
	public static MasterCurrency deleteMasterCurrency(long currencyId)
		throws PortalException {

		return getService().deleteMasterCurrency(currencyId);
	}
	 ...
	 * @return the master currency that was removed
	 */
	public static MasterCurrency deleteMasterCurrency(
		MasterCurrency masterCurrency) {

		return getService().deleteMasterCurrency(masterCurrency);
	}
	...
	public static MasterCurrency fetchMasterCurrency(long currencyId) {
		return getService().fetchMasterCurrency(currencyId);
	}
	...
	public static List<MasterCurrency> getMasterCurrencies() {
		return getService().getMasterCurrencies();
	}
	 ...
	 */
	public static List<MasterCurrency> getMasterCurrencies(int start, int end) {
		return getService().getMasterCurrencies(start, end);
	}
	 ...
	 */
	public static int getMasterCurrenciesCount() {
		return getService().getMasterCurrenciesCount();
	}
	 ...
	 * @throws PortalException if a master currency with the primary key could not be found
	 */
	public static MasterCurrency getMasterCurrency(long currencyId)
		throws PortalException {

		return getService().getMasterCurrency(currencyId);
	}

	public static int getMasterCurrencyCount() {
		return getService().getMasterCurrencyCount();
	}
	...
	public static MasterCurrency searchCurrency(String _currency) {
		return getService().searchCurrency(_currency);
	}

	public static MasterCurrency setActive(
			long currencyId, int active,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().setActive(currencyId, active, serviceContext);
	}

	public static MasterCurrency updateMasterCurrency(
			long currencyId, String currencyName, double amount, int isDefault,
			int active)
		throws PortalException {

		return getService().updateMasterCurrency(
	...
	public static MasterCurrency updateMasterCurrency(
		...
		return getService().updateMasterCurrency(masterCurrency);
	}

	public static MasterCurrencyLocalService getService() {
		return _service;
	}

	private static volatile MasterCurrencyLocalService _service;
