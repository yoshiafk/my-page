...
/**
 * Provides the local service interface for TravelDomesticDuration. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see TravelDomesticDurationLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TravelDomesticDurationLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.TravelDomesticDurationLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the travel domestic duration local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TravelDomesticDurationLocalServiceUtil} if injection and service tracking are not available.
	 */
