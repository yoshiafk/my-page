...
/**
 * Provides the local service interface for MasterProvince. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see MasterProvinceLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MasterProvinceLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterProvinceLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the master province local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MasterProvinceLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MasterProvince addMasterProvince(
	...
	public MasterProvince setActive(
			long masterProvinceId, int active, ServiceContext serviceContext)
		throws PortalException;

	public MasterProvince updateMasterProvince(
