...
/**
 * Provides the local service utility for MasterOccupation. This utility wraps
 * <code>com.mypage.admin.product.service.impl.MasterOccupationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class MasterOccupationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterOccupationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static MasterOccupation addMasterOccupation(
		MasterOccupation masterOccupation) {

		return getService().addMasterOccupation(masterOccupation);
	}

	public static MasterOccupation addMasterOccupation(
		String name, long masterOccupationCategoryId, int active) {

		return getService().addMasterOccupation(
	 ...
	 */
	public static MasterOccupation createMasterOccupation(
		long masterOccupationId) {

		return getService().createMasterOccupation(masterOccupationId);
	}
	 ...
	 */
	public static MasterOccupation deleteMasterOccupation(
			long masterOccupationId)
		throws PortalException {

		return getService().deleteMasterOccupation(masterOccupationId);
	}
	...
	public static MasterOccupation deleteMasterOccupation(
		...
		return getService().deleteMasterOccupation(masterOccupation);
	}
	...
	public static MasterOccupation fetchMasterOccupation(
		long masterOccupationId) {

		return getService().fetchMasterOccupation(masterOccupationId);
	}
	 ...
	 * @throws PortalException if a master occupation with the primary key could not be found
	 */
	public static MasterOccupation getMasterOccupation(long masterOccupationId)
		throws PortalException {

		return getService().getMasterOccupation(masterOccupationId);
	}
	 ...
	 */
	public static List<MasterOccupation> getMasterOccupations(
		int start, int end) {

		return getService().getMasterOccupations(start, end);
	}
	 ...
	 */
	public static int getMasterOccupationsCount() {
		return getService().getMasterOccupationsCount();
	}
	...
	public static List<MasterOccupation> searchByActive(int active) {
		return getService().searchByActive(active);
	}

	public static List<MasterOccupation> searchByMasterOccupationCategoryId(
		long masterOccupationCategoryId) {

		return getService().searchByMasterOccupationCategoryId(
			masterOccupationCategoryId);
	}

	public static MasterOccupation setActive(
		long masterOccupationId, int active) {

		return getService().setActive(masterOccupationId, active);
	}

	public static MasterOccupation updateMasterOccupation(
		...
		return getService().updateMasterOccupation(
	...
	public static MasterOccupation updateMasterOccupation(
		...
		return getService().updateMasterOccupation(masterOccupation);
	}

	public static MasterOccupationLocalService getService() {
		return _service;
	}

	private static volatile MasterOccupationLocalService _service;
