...
/**
 * Provides the local service interface for JobPosition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see JobPositionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface JobPositionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.JobPositionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the job position local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link JobPositionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public JobPosition addJobPosition(String name, int active)
	...
	public JobPosition setActive(
			long jobPositionId, int active, ServiceContext serviceContext)
		throws PortalException;
