...
/**
 * Provides the local service interface for Promocodes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see PromocodesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PromocodesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.PromocodesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the promocodes local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PromocodesLocalServiceUtil} if injection and service tracking are not available.
	 */
	public Promocodes addPromocodes(
			long promocodeId, JSONObject data, ServiceContext serviceContext)
	...
	public Promocodes addPromocodes(Promocodes promocodes);
	...
	public Promocodes createPromocodes(long promocodeId);
	...
	public Promocodes deletePromocodes(long promocodeId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Promocodes deletePromocodes(Promocodes promocodes);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocodes fetchPromocodes(long promocodeId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocodes fetchPromocodesByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocodes getPromocodes(long promocodeId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Promocodes getPromocodesByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Promocodes> getPromocodeses(int start, int end);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Promocodes> getPromocodesesByUuidAndCompanyId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Promocodes> searchB2CPromo(
		String promocode, Date startDate, Date endDate, String products);

	public Promocodes setActive(
			long userId, long promocodeId, int active,
			ServiceContext serviceContext)
		throws PortalException;

	public Promocodes updatePromocodes(long promocodeId, JSONObject data)
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Promocodes updatePromocodes(Promocodes promocodes);
