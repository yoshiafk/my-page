...
/**
 * The persistence interface for the health sme facility service.
 *
 * <p>
 ...
 *
 * @author Gositus Team
 * @see HealthSmeFacilityUtil
 * @generated
 */
@ProviderType
public interface HealthSmeFacilityPersistence
	extends BasePersistence<HealthSmeFacility> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HealthSmeFacilityUtil} to access the health sme facility persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<HealthSmeFacility> healthSmeFacilities);
	 ...
	 */
	public java.util.List<HealthSmeFacility> findAll();
	 ...
	 */
	public java.util.List<HealthSmeFacility> findAll(int start, int end);
	...
	public java.util.List<HealthSmeFacility> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<HealthSmeFacility>
			orderByComparator);
