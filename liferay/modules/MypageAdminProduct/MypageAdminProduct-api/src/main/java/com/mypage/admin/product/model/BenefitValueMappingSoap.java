...
/**
 * This class is used by SOAP remote services, specifically {@link com.mypage.admin.product.service.http.BenefitValueMappingServiceSoap}.
 *
 * @author Gositus Team
 ...
 */
@Deprecated
public class BenefitValueMappingSoap implements Serializable {

	public static BenefitValueMappingSoap toSoapModel(
		BenefitValueMapping model) {

		BenefitValueMappingSoap soapModel = new BenefitValueMappingSoap();
	...
	public static BenefitValueMappingSoap[] toSoapModels(
		BenefitValueMapping[] models) {

		BenefitValueMappingSoap[] soapModels =
			new BenefitValueMappingSoap[models.length];
	...
	public static BenefitValueMappingSoap[][] toSoapModels(
		...
		BenefitValueMappingSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels =
				new BenefitValueMappingSoap[models.length][models[0].length];
		}
		else {
			soapModels = new BenefitValueMappingSoap[0][0];
		}
	...
	public static BenefitValueMappingSoap[] toSoapModels(
		List<BenefitValueMapping> models) {

		List<BenefitValueMappingSoap> soapModels =
			new ArrayList<BenefitValueMappingSoap>(models.size());

		for (BenefitValueMapping model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(
			new BenefitValueMappingSoap[soapModels.size()]);
	}

	public BenefitValueMappingSoap() {
	}
