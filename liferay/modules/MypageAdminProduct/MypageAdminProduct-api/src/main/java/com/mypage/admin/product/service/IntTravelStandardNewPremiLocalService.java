...
/**
 * Provides the local service interface for IntTravelStandardNewPremi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see IntTravelStandardNewPremiLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IntTravelStandardNewPremiLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.IntTravelStandardNewPremiLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the int travel standard new premi local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IntTravelStandardNewPremiLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public IntTravelStandardNewPremi addIntTravelStandardNewPremi(
			...
			BigDecimal amount, BigDecimal additionalPrice, int active)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public IntTravelStandardNewPremi searchSpesificPremi(
		String travelType, String packageType, String peopleType,
		String currency, int mainInsured, int spouse, int child);

	public IntTravelStandardNewPremi setActive(
	...
	public IntTravelStandardNewPremi updateIntTravelStandardNewPremi(
			...
			int child, String currency, BigDecimal amount,
			BigDecimal additionalPrice, int active)
		throws PortalException;
