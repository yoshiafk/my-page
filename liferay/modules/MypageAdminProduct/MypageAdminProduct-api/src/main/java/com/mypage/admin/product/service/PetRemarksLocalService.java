...
/**
 * Provides the local service interface for PetRemarks. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see PetRemarksLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PetRemarksLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.PetRemarksLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pet remarks local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PetRemarksLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 */
	public PetRemarks addPetRemarks(String name, String code, int active)
		throws PortalException;
	 ...
	 * @throws PortalException
	 */
	public PetRemarks updatePetRemarks(
