...
/**
 * Provides the local service utility for HealthSmePremi. This utility wraps
 * <code>com.mypage.admin.product.service.impl.HealthSmePremiLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HealthSmePremiLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.HealthSmePremiLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HealthSmePremi addHealthSmePremi(
		HealthSmePremi healthSmePremi) {

		return getService().addHealthSmePremi(healthSmePremi);
	}
	 ...
	 */
	public static HealthSmePremi createHealthSmePremi(long healthSmePremiId) {
		return getService().createHealthSmePremi(healthSmePremiId);
	}
	 ...
	 */
	public static HealthSmePremi deleteHealthSmePremi(
		HealthSmePremi healthSmePremi) {

		return getService().deleteHealthSmePremi(healthSmePremi);
	}
	 ...
	 */
	public static HealthSmePremi deleteHealthSmePremi(long healthSmePremiId)
		throws PortalException {

		return getService().deleteHealthSmePremi(healthSmePremiId);
	}
	...
	public static HealthSmePremi fetchHealthSmePremi(long healthSmePremiId) {
		return getService().fetchHealthSmePremi(healthSmePremiId);
	}
	 ...
	 * @throws PortalException if a health sme premi with the primary key could not be found
	 */
	public static HealthSmePremi getHealthSmePremi(long healthSmePremiId)
		throws PortalException {

		return getService().getHealthSmePremi(healthSmePremiId);
	}
	 ...
	 */
	public static List<HealthSmePremi> getHealthSmePremis(int start, int end) {
		return getService().getHealthSmePremis(start, end);
	}
	 ...
	 */
	public static int getHealthSmePremisCount() {
		return getService().getHealthSmePremisCount();
	}
	 ...
	 */
	public static HealthSmePremi updateHealthSmePremi(
		HealthSmePremi healthSmePremi) {

		return getService().updateHealthSmePremi(healthSmePremi);
	}

	public static HealthSmePremiLocalService getService() {
		return _service;
	}

	private static volatile HealthSmePremiLocalService _service;
