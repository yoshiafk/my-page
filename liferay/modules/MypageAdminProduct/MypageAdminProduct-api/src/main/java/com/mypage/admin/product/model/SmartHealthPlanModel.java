...
/**
 * The base model interface for the SmartHealthPlan service. Represents a row in the &quot;SmartHealthPlan&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.SmartHealthPlanModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.SmartHealthPlanImpl</code>.
 * </p>
 *
 * @author Gositus Team
 * @see SmartHealthPlan
 ...
 */
@ProviderType
public interface SmartHealthPlanModel
	extends BaseModel<SmartHealthPlan>, GroupedModel, ShardedModel,
			TrashedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a smart health plan model instance should use the {@link SmartHealthPlan} interface instead.
	 */
