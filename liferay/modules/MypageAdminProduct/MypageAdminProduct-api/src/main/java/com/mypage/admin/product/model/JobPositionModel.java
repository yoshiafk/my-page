...
/**
 * The base model interface for the JobPosition service. Represents a row in the &quot;JobPosition&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.JobPositionModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.JobPositionImpl</code>.
 * </p>
 *
 * @author Gositus Team
 * @see JobPosition
 ...
 */
@ProviderType
public interface JobPositionModel
	extends BaseModel<JobPosition>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a job position model instance should use the {@link JobPosition} interface instead.
	 */
