...
/**
 * Provides the local service interface for IndustryCategory. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see IndustryCategoryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface IndustryCategoryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.IndustryCategoryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the industry category local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link IndustryCategoryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public IndustryCategory addIndustryCategory(String name, int active)
	...
	public IndustryCategory setActive(
			long industryCategoryId, int active, ServiceContext serviceContext)
		throws PortalException;
