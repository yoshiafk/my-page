...
/**
 * Provides the local service utility for TravelDomesticDuration. This utility wraps
 * <code>com.mypage.admin.product.service.impl.TravelDomesticDurationLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TravelDomesticDurationLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.TravelDomesticDurationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TravelDomesticDuration addTravelDomesticDuration(
		TravelDomesticDuration travelDomesticDuration) {

		return getService().addTravelDomesticDuration(travelDomesticDuration);
	}
	 ...
	 */
	public static TravelDomesticDuration createTravelDomesticDuration(
		long travelDomesticDurationId) {

		return getService().createTravelDomesticDuration(
	 ...
	 */
	public static TravelDomesticDuration deleteTravelDomesticDuration(
			long travelDomesticDurationId)
		throws PortalException {

		return getService().deleteTravelDomesticDuration(
			travelDomesticDurationId);
	}
	...
	public static TravelDomesticDuration fetchTravelDomesticDuration(
		long travelDomesticDurationId) {

		return getService().fetchTravelDomesticDuration(
			travelDomesticDurationId);
	}
	 ...
	 * @throws PortalException if a travel domestic duration with the primary key could not be found
	 */
	public static TravelDomesticDuration getTravelDomesticDuration(
			long travelDomesticDurationId)
		throws PortalException {

		return getService().getTravelDomesticDuration(travelDomesticDurationId);
	}
	 ...
	 */
	public static List<TravelDomesticDuration> getTravelDomesticDurations(
		int start, int end) {

		return getService().getTravelDomesticDurations(start, end);
	}
	 ...
	 */
	public static int getTravelDomesticDurationsCount() {
		return getService().getTravelDomesticDurationsCount();
	}
	 ...
	 */
	public static TravelDomesticDuration updateTravelDomesticDuration(
		TravelDomesticDuration travelDomesticDuration) {

		return getService().updateTravelDomesticDuration(
			travelDomesticDuration);
	}

	public static TravelDomesticDurationLocalService getService() {
		return _service;
	}

	private static volatile TravelDomesticDurationLocalService _service;
