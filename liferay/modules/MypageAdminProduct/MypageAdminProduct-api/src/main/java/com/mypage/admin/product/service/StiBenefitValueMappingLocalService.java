...
/**
 * Provides the local service interface for StiBenefitValueMapping. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see StiBenefitValueMappingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface StiBenefitValueMappingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.StiBenefitValueMappingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sti benefit value mapping local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link StiBenefitValueMappingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StiBenefitValueMapping> getAllBenefitValueMappingByBenefitType(
		long benefitTypeId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<StiBenefitValueMapping> getBenefitValueMappings(
		int start, int end);
	...
	public StiBenefitValueMapping setActive(
