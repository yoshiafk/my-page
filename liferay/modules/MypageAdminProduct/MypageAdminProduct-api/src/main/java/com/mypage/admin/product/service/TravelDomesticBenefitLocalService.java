...
/**
 * Provides the local service interface for TravelDomesticBenefit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see TravelDomesticBenefitLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TravelDomesticBenefitLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.TravelDomesticBenefitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the travel domestic benefit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link TravelDomesticBenefitLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public TravelDomesticBenefit setActive(
