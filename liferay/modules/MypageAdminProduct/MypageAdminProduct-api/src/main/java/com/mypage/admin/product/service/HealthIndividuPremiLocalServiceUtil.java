...
/**
 * Provides the local service utility for HealthIndividuPremi. This utility wraps
 * <code>com.mypage.admin.product.service.impl.HealthIndividuPremiLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HealthIndividuPremiLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.HealthIndividuPremiLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HealthIndividuPremi addHealthIndividuPremi(
		HealthIndividuPremi healthIndividuPremi) {

		return getService().addHealthIndividuPremi(healthIndividuPremi);
	}
	 ...
	 */
	public static HealthIndividuPremi createHealthIndividuPremi(
		long healthIndividuPremiId) {

		return getService().createHealthIndividuPremi(healthIndividuPremiId);
	}
	 ...
	 */
	public static HealthIndividuPremi deleteHealthIndividuPremi(
		HealthIndividuPremi healthIndividuPremi) {

		return getService().deleteHealthIndividuPremi(healthIndividuPremi);
	}
	...
	public static HealthIndividuPremi deleteHealthIndividuPremi(
		...
		return getService().deleteHealthIndividuPremi(healthIndividuPremiId);
	}
	...
	public static HealthIndividuPremi fetchHealthIndividuPremi(
		long healthIndividuPremiId) {

		return getService().fetchHealthIndividuPremi(healthIndividuPremiId);
	}
	 ...
	 * @throws PortalException if a health individu premi with the primary key could not be found
	 */
	public static HealthIndividuPremi getHealthIndividuPremi(
			long healthIndividuPremiId)
		throws PortalException {

		return getService().getHealthIndividuPremi(healthIndividuPremiId);
	}
	 ...
	 */
	public static List<HealthIndividuPremi> getHealthIndividuPremis(
		int start, int end) {

		return getService().getHealthIndividuPremis(start, end);
	}
	 ...
	 */
	public static int getHealthIndividuPremisCount() {
		return getService().getHealthIndividuPremisCount();
	}
	 ...
	 */
	public static HealthIndividuPremi updateHealthIndividuPremi(
		HealthIndividuPremi healthIndividuPremi) {

		return getService().updateHealthIndividuPremi(healthIndividuPremi);
	}

	public static HealthIndividuPremiLocalService getService() {
		return _service;
	}

	private static volatile HealthIndividuPremiLocalService _service;
