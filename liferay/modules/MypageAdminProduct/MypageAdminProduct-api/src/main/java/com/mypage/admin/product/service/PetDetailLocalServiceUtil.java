...
/**
 * Provides the local service utility for PetDetail. This utility wraps
 * <code>com.mypage.admin.product.service.impl.PetDetailLocalServiceImpl</code> and
 ...
 * @generated
 */
public class PetDetailLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.PetDetailLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static PetDetail addPetDetail(PetDetail petDetail) {
		return getService().addPetDetail(petDetail);
	}
	 ...
	 */
	public static PetDetail createPetDetail(long petDetailId) {
		return getService().createPetDetail(petDetailId);
	}
	 ...
	 */
	public static PetDetail deletePetDetail(long petDetailId)
		throws PortalException {

		return getService().deletePetDetail(petDetailId);
	}
	 ...
	 * @return the pet detail that was removed
	 */
	public static PetDetail deletePetDetail(PetDetail petDetail) {
		return getService().deletePetDetail(petDetail);
	}
	...
	public static PetDetail fetchPetDetail(long petDetailId) {
		return getService().fetchPetDetail(petDetailId);
	}
	 ...
	 * @throws PortalException if a pet detail with the primary key could not be found
	 */
	public static PetDetail getPetDetail(long petDetailId)
		throws PortalException {

		return getService().getPetDetail(petDetailId);
	}
	 ...
	 */
	public static List<PetDetail> getPetDetails(int start, int end) {
		return getService().getPetDetails(start, end);
	}
	 ...
	 */
	public static int getPetDetailsCount() {
		return getService().getPetDetailsCount();
	}
	 ...
	 */
	public static PetDetail updatePetDetail(PetDetail petDetail) {
		return getService().updatePetDetail(petDetail);
	}

	public static PetDetailLocalService getService() {
		return _service;
	}

	private static volatile PetDetailLocalService _service;
