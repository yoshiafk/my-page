...
/**
 * Provides the local service interface for MasterCurrency. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see MasterCurrencyLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MasterCurrencyLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterCurrencyLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the master currency local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MasterCurrencyLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MasterCurrency addMasterCurrency(
	...
	public MasterCurrency setActive(
			long currencyId, int active, ServiceContext serviceContext)
		throws PortalException;

	public MasterCurrency updateMasterCurrency(
