...
/**
 * This class is used by SOAP remote services, specifically {@link com.mypage.admin.product.service.http.StiBenefitServiceSoap}.
 *
 * @author Gositus Team
 ...
 */
@Deprecated
public class StiBenefitSoap implements Serializable {

	public static StiBenefitSoap toSoapModel(StiBenefit model) {
		StiBenefitSoap soapModel = new StiBenefitSoap();
	...
	public static StiBenefitSoap[] toSoapModels(StiBenefit[] models) {
		StiBenefitSoap[] soapModels = new StiBenefitSoap[models.length];
	...
	public static StiBenefitSoap[][] toSoapModels(StiBenefit[][] models) {
		StiBenefitSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new StiBenefitSoap[models.length][models[0].length];
		}
		else {
			soapModels = new StiBenefitSoap[0][0];
		}
	...
	public static StiBenefitSoap[] toSoapModels(List<StiBenefit> models) {
		List<StiBenefitSoap> soapModels = new ArrayList<StiBenefitSoap>(
			models.size());

		for (StiBenefit model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new StiBenefitSoap[soapModels.size()]);
	}

	public StiBenefitSoap() {
	}
