...
/**
 * Provides the local service interface for BenefitValueMapping. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see BenefitValueMappingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface BenefitValueMappingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.BenefitValueMappingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the benefit value mapping local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BenefitValueMappingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<BenefitValueMapping> getAllBenefitValueMappingByBenefitType(
		long benefitTypeId);
	...
	public BenefitValueMapping setActive(
			long benefitValueMappingId, int active,
			ServiceContext serviceContext)
		throws PortalException;

	public BenefitValueMapping updateBenefit(
