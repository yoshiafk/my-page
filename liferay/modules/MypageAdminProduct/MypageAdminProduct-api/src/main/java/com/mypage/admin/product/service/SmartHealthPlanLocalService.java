...
/**
 * Provides the local service interface for SmartHealthPlan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartHealthPlanLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartHealthPlanLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartHealthPlanLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart health plan local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartHealthPlanLocalServiceUtil} if injection and service tracking are not available.
	 */
	 ...
	 * Add Plan
	 */
	public SmartHealthPlan addSmartHealthPlan(
	...
	public SmartHealthPlan setActive(
			long smartHealthPlanId, int active, ServiceContext serviceContext)
		throws PortalException;
