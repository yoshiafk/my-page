...
/**
 * Provides the local service interface for SmartActiveBenefit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartActiveBenefitLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartActiveBenefitLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveBenefitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart active benefit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartActiveBenefitLocalServiceUtil} if injection and service tracking are not available.
	 */
	public SmartActiveBenefit addBenefit(
	...
	public SmartActiveBenefit setActive(
			long benefitId, int active, ServiceContext serviceContext)
		throws PortalException;

	public SmartActiveBenefit updateBenefit(
