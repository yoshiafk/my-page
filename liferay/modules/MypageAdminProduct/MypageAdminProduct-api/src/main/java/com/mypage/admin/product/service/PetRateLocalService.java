...
/**
 * Provides the local service interface for PetRate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see PetRateLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PetRateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.PetRateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pet rate local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PetRateLocalServiceUtil} if injection and service tracking are not available.
	 */

	/**
	 * Add New Pet Rate
	 */
	public PetRate addPetRate(
	 ...
	 */
	public PetRate setActive(
			long userId, long petRateId, int active,
			ServiceContext serviceContext)
		throws PortalException;

	public PetRate updatePetRate(
