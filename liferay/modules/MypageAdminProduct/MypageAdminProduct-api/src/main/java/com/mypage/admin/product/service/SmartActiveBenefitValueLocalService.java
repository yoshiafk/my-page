...
/**
 * Provides the local service interface for SmartActiveBenefitValue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartActiveBenefitValueLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartActiveBenefitValueLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveBenefitValueLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart active benefit value local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartActiveBenefitValueLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SmartActiveBenefitValue setActive(
			long benefitValueId, int active, ServiceContext serviceContext)
		throws PortalException;

	public SmartActiveBenefitValue updateBenefitValue(
