...
/**
 * Provides the local service interface for SmartTravelIntLink. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartTravelIntLinkLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartTravelIntLinkLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartTravelIntLinkLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart travel int link local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartTravelIntLinkLocalServiceUtil} if injection and service tracking are not available.
	 */
	public SmartTravelIntLink addLink(
	...
	public SmartTravelIntLink updateLink(
