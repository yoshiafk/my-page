...
/**
 * Provides the local service utility for TravelDomesticTravellerType. This utility wraps
 * <code>com.mypage.admin.product.service.impl.TravelDomesticTravellerTypeLocalServiceImpl</code> and
 ...
 * @generated
 */
public class TravelDomesticTravellerTypeLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.TravelDomesticTravellerTypeLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static TravelDomesticTravellerType addTravelDomesticTravellerType(
		TravelDomesticTravellerType travelDomesticTravellerType) {

		return getService().addTravelDomesticTravellerType(
	 ...
	 */
	public static TravelDomesticTravellerType createTravelDomesticTravellerType(
		long travellerTypeId) {

		return getService().createTravelDomesticTravellerType(travellerTypeId);
	}
	 ...
	 */
	public static TravelDomesticTravellerType deleteTravelDomesticTravellerType(
			long travellerTypeId)
		throws PortalException {

		return getService().deleteTravelDomesticTravellerType(travellerTypeId);
	}
	...
	public static TravelDomesticTravellerType deleteTravelDomesticTravellerType(
		...
		return getService().deleteTravelDomesticTravellerType(
			travelDomesticTravellerType);
	}
	...
	public static TravelDomesticTravellerType fetchTravelDomesticTravellerType(
		long travellerTypeId) {

		return getService().fetchTravelDomesticTravellerType(travellerTypeId);
	}
	 ...
	 * @throws PortalException if a travel domestic traveller type with the primary key could not be found
	 */
	public static TravelDomesticTravellerType getTravelDomesticTravellerType(
			long travellerTypeId)
		throws PortalException {

		return getService().getTravelDomesticTravellerType(travellerTypeId);
	}
	 ...
	 */
	public static List<TravelDomesticTravellerType>
		getTravelDomesticTravellerTypes(int start, int end) {

		return getService().getTravelDomesticTravellerTypes(start, end);
	}
	 ...
	 */
	public static int getTravelDomesticTravellerTypesCount() {
		return getService().getTravelDomesticTravellerTypesCount();
	}
	 ...
	 */
	public static TravelDomesticTravellerType updateTravelDomesticTravellerType(
		TravelDomesticTravellerType travelDomesticTravellerType) {

		return getService().updateTravelDomesticTravellerType(
			travelDomesticTravellerType);
	}

	public static TravelDomesticTravellerTypeLocalService getService() {
		return _service;
	}

	private static volatile TravelDomesticTravellerTypeLocalService _service;
