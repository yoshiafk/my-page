...
/**
 * Provides the local service interface for SmartHealthBenefit. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartHealthBenefitLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartHealthBenefitLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartHealthBenefitLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart health benefit local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartHealthBenefitLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SmartHealthBenefit setActive(
