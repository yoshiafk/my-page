...
/**
 * The persistence interface for the smart active benefit type service.
 *
 * <p>
 ...
 *
 * @author Gositus Team
 * @see SmartActiveBenefitTypeUtil
 * @generated
 */
@ProviderType
public interface SmartActiveBenefitTypePersistence
	extends BasePersistence<SmartActiveBenefitType> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SmartActiveBenefitTypeUtil} to access the smart active benefit type persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<SmartActiveBenefitType> smartActiveBenefitTypes);
	 ...
	 */
	public java.util.List<SmartActiveBenefitType> findAll();
	 ...
	 */
	public java.util.List<SmartActiveBenefitType> findAll(int start, int end);
	...
	public java.util.List<SmartActiveBenefitType> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<SmartActiveBenefitType>
			orderByComparator);
