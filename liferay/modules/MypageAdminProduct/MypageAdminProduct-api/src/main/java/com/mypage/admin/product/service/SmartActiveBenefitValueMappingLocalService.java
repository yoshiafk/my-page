...
/**
 * Provides the local service interface for SmartActiveBenefitValueMapping. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartActiveBenefitValueMappingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartActiveBenefitValueMappingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveBenefitValueMappingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart active benefit value mapping local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartActiveBenefitValueMappingLocalServiceUtil} if injection and service tracking are not available.
	 */
	public SmartActiveBenefitValueMapping addBenefitValueMapping(
			long benefitTypeId, long benefitId, long benefitValueId,
			String benefitValue, BigDecimal limitValue, int active)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SmartActiveBenefitValueMapping> getAllByBenefitValue(
		long benefitValueId);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SmartActiveBenefitValueMapping
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SmartActiveBenefitValueMapping> getBenefitValueMappings(
		int start, int end);
	...
	public SmartActiveBenefitValueMapping setActive(
			long benefitValueMappingId, int active,
			ServiceContext serviceContext)
		throws PortalException;

	public SmartActiveBenefitValueMapping updateBenefitValueMapping(
			long benefitValueMappingId, long benefitTypeId, long benefitId,
			long benefitValueId, String benefitValue, BigDecimal limitValue,
			int active)
		throws PortalException;
