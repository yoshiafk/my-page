...
/**
 * The base model interface for the TravelDomesticTravellerType service. Represents a row in the &quot;TravelDomesticTravellerType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.TravelDomesticTravellerTypeModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.TravelDomesticTravellerTypeImpl</code>.
 * </p>
 *
 * @author Gositus Team
 ...
 */
@ProviderType
public interface TravelDomesticTravellerTypeModel
	extends BaseModel<TravelDomesticTravellerType>, GroupedModel, ShardedModel,
			TrashedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a travel domestic traveller type model instance should use the {@link TravelDomesticTravellerType} interface instead.
	 */
