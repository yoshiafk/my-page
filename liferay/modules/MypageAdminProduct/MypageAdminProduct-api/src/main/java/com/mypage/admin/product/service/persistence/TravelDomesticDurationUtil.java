...
/**
 * The persistence utility for the travel domestic duration service. This utility wraps <code>com.mypage.admin.product.service.persistence.impl.TravelDomesticDurationPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 *
 * @author Gositus Team
 * @see TravelDomesticDurationPersistence
 * @generated
 */
public class TravelDomesticDurationUtil {
	...
	public static void clearCache(
		...
		getPersistence().clearCache(travelDomesticDuration);
	}
	 ...
	 */
	public static Map<Serializable, TravelDomesticDuration> fetchByPrimaryKeys(
	 ...
	 */
	public static List<TravelDomesticDuration> findWithDynamicQuery(
	 ...
	 */
	public static TravelDomesticDuration update(
		TravelDomesticDuration travelDomesticDuration) {

		return getPersistence().update(travelDomesticDuration);
	}
	...
	public static TravelDomesticDuration update(
		...
		return getPersistence().update(travelDomesticDuration, serviceContext);
	}
	 ...
	 */
	public static List<TravelDomesticDuration> findBysearchDuration(
		long travelDomesticDurationId, String code, int dayFrom, int dayTo,
		String label) {

		return getPersistence().findBysearchDuration(
	 ...
	 */
	public static TravelDomesticDuration findBysearchDuration_First(
			long travelDomesticDurationId, String code, int dayFrom, int dayTo,
			String label,
			OrderByComparator<TravelDomesticDuration> orderByComparator)
		throws com.mypage.admin.product.exception.
			NoSuchTravelDomesticDurationException {

		return getPersistence().findBysearchDuration_First(
			travelDomesticDurationId, code, dayFrom, dayTo, label,
			orderByComparator);
	}
	 ...
	 */
	public static TravelDomesticDuration fetchBysearchDuration_First(
		long travelDomesticDurationId, String code, int dayFrom, int dayTo,
		String label,
		OrderByComparator<TravelDomesticDuration> orderByComparator) {

		return getPersistence().fetchBysearchDuration_First(
			travelDomesticDurationId, code, dayFrom, dayTo, label,
			orderByComparator);
	}
	 ...
	 * @throws NoSuchTravelDomesticDurationException if a matching travel domestic duration could not be found
	 */
	public static TravelDomesticDuration findBysearchDuration_Last(
			long travelDomesticDurationId, String code, int dayFrom, int dayTo,
			String label,
			OrderByComparator<TravelDomesticDuration> orderByComparator)
		throws com.mypage.admin.product.exception.
		...
		return getPersistence().findBysearchDuration_Last(
			travelDomesticDurationId, code, dayFrom, dayTo, label,
			orderByComparator);
	}
	 ...
	 */
	public static TravelDomesticDuration fetchBysearchDuration_Last(
		long travelDomesticDurationId, String code, int dayFrom, int dayTo,
		String label,
		OrderByComparator<TravelDomesticDuration> orderByComparator) {

		return getPersistence().fetchBysearchDuration_Last(
			travelDomesticDurationId, code, dayFrom, dayTo, label,
			orderByComparator);
	}
	 ...
	 * @param label the label
	 */
	public static void removeBysearchDuration(
		long travelDomesticDurationId, String code, int dayFrom, int dayTo,
		String label) {

		getPersistence().removeBysearchDuration(
			travelDomesticDurationId, code, dayFrom, dayTo, label);
	}
	 ...
	 */
	public static int countBysearchDuration(
		long travelDomesticDurationId, String code, int dayFrom, int dayTo,
		String label) {

		return getPersistence().countBysearchDuration(
			travelDomesticDurationId, code, dayFrom, dayTo, label);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(travelDomesticDuration);
	}
	...
	public static void cacheResult(
		...
		getPersistence().cacheResult(travelDomesticDurations);
	}
	 ...
	 */
	public static TravelDomesticDuration create(long travelDomesticDurationId) {
		return getPersistence().create(travelDomesticDurationId);
	}
	 ...
	 */
	public static TravelDomesticDuration remove(long travelDomesticDurationId)
		throws com.mypage.admin.product.exception.
			NoSuchTravelDomesticDurationException {

		return getPersistence().remove(travelDomesticDurationId);
	}

	public static TravelDomesticDuration updateImpl(
		TravelDomesticDuration travelDomesticDuration) {

		return getPersistence().updateImpl(travelDomesticDuration);
	}
	 ...
	 * @throws NoSuchTravelDomesticDurationException if a travel domestic duration with the primary key could not be found
	 */
	public static TravelDomesticDuration findByPrimaryKey(
			long travelDomesticDurationId)
		throws com.mypage.admin.product.exception.
			NoSuchTravelDomesticDurationException {

		return getPersistence().findByPrimaryKey(travelDomesticDurationId);
	}
	 ...
	 */
	public static TravelDomesticDuration fetchByPrimaryKey(
		long travelDomesticDurationId) {

		return getPersistence().fetchByPrimaryKey(travelDomesticDurationId);
	}
	 ...
	 */
	public static List<TravelDomesticDuration> findAll() {
	 ...
	 */
	public static List<TravelDomesticDuration> findAll(int start, int end) {
	...
	public static TravelDomesticDurationPersistence getPersistence() {
		return _persistence;
	}

	private static volatile TravelDomesticDurationPersistence _persistence;
