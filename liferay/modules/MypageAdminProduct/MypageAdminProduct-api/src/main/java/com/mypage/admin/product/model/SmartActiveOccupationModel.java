...
/**
 * The base model interface for the SmartActiveOccupation service. Represents a row in the &quot;SmartActiveOccupation&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.SmartActiveOccupationModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.SmartActiveOccupationImpl</code>.
 * </p>
 *
 * @author Gositus Team
 ...
 */
@ProviderType
public interface SmartActiveOccupationModel
	extends BaseModel<SmartActiveOccupation>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a smart active occupation model instance should use the {@link SmartActiveOccupation} interface instead.
	 */
