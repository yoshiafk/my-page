...
/**
 * The base model interface for the SmartHealthBenefitGroup service. Represents a row in the &quot;SmartHealthBenefitGroup&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.SmartHealthBenefitGroupModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.SmartHealthBenefitGroupImpl</code>.
 * </p>
 *
 * @author Gositus Team
 ...
 */
@ProviderType
public interface SmartHealthBenefitGroupModel
	extends BaseModel<SmartHealthBenefitGroup>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a smart health benefit group model instance should use the {@link SmartHealthBenefitGroup} interface instead.
	 */
