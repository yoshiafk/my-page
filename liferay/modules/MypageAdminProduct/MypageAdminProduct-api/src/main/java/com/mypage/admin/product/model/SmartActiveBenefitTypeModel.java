...
/**
 * The base model interface for the SmartActiveBenefitType service. Represents a row in the &quot;SmartActiveBenefitType&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.SmartActiveBenefitTypeModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.SmartActiveBenefitTypeImpl</code>.
 * </p>
 *
 * @author Gositus Team
 ...
 */
@ProviderType
public interface SmartActiveBenefitTypeModel
	extends BaseModel<SmartActiveBenefitType>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a smart active benefit type model instance should use the {@link SmartActiveBenefitType} interface instead.
	 */
