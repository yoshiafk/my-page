...
/**
 * Provides the local service utility for IndustryCategory. This utility wraps
 * <code>com.mypage.admin.product.service.impl.IndustryCategoryLocalServiceImpl</code> and
 ...
 * @generated
 */
public class IndustryCategoryLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.IndustryCategoryLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static IndustryCategory addIndustryCategory(
		IndustryCategory industryCategory) {

		return getService().addIndustryCategory(industryCategory);
	}

	public static IndustryCategory addIndustryCategory(String name, int active)
		throws PortalException {

		return getService().addIndustryCategory(name, active);
	}
	 ...
	 */
	public static IndustryCategory createIndustryCategory(
		long industryCategoryId) {

		return getService().createIndustryCategory(industryCategoryId);
	}
	 ...
	 */
	public static IndustryCategory deleteIndustryCategory(
		IndustryCategory industryCategory) {

		return getService().deleteIndustryCategory(industryCategory);
	}
	...
	public static IndustryCategory deleteIndustryCategory(
		...
		return getService().deleteIndustryCategory(industryCategoryId);
	}
	...
	public static IndustryCategory fetchIndustryCategory(
		long industryCategoryId) {

		return getService().fetchIndustryCategory(industryCategoryId);
	}
	...
	public static List<IndustryCategory> getActiveIndustryCategories() {
		return getService().getActiveIndustryCategories();
	}
	...
	public static List<IndustryCategory> getIndustryCategories() {
		return getService().getIndustryCategories();
	}
	...
	public static List<IndustryCategory> getIndustryCategories(
		...
		return getService().getIndustryCategories(start, end);
	}
	 ...
	 */
	public static int getIndustryCategoriesCount() {
		return getService().getIndustryCategoriesCount();
	}
	 ...
	 * @throws PortalException if a industry category with the primary key could not be found
	 */
	public static IndustryCategory getIndustryCategory(long industryCategoryId)
		throws PortalException {

		return getService().getIndustryCategory(industryCategoryId);
	}

	public static int getIndustryCategoryCount() {
		return getService().getIndustryCategoryCount();
	}
	...
	public static IndustryCategory setActive(
	 ...
	 */
	public static IndustryCategory updateIndustryCategory(
		IndustryCategory industryCategory) {

		return getService().updateIndustryCategory(industryCategory);
	}
	...
	public static IndustryCategory updateIndustryCategory(
		...
		return getService().updateIndustryCategory(
			industryCategoryId, name, active);
	}

	public static IndustryCategoryLocalService getService() {
		return _service;
	}

	private static volatile IndustryCategoryLocalService _service;
