...
/**
 * The persistence interface for the industry category service.
 *
 * <p>
 ...
 *
 * @author Gositus Team
 * @see IndustryCategoryUtil
 * @generated
 */
@ProviderType
public interface IndustryCategoryPersistence
	extends BasePersistence<IndustryCategory> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link IndustryCategoryUtil} to access the industry category persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<IndustryCategory> industryCategories);
	 ...
	 */
	public java.util.List<IndustryCategory> findAll();
	 ...
	 */
	public java.util.List<IndustryCategory> findAll(int start, int end);
	...
	public java.util.List<IndustryCategory> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<IndustryCategory>
			orderByComparator);
