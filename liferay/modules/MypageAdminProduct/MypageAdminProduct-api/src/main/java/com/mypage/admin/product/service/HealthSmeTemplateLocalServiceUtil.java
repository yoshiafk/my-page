...
/**
 * Provides the local service utility for HealthSmeTemplate. This utility wraps
 * <code>com.mypage.admin.product.service.impl.HealthSmeTemplateLocalServiceImpl</code> and
 ...
 * @generated
 */
public class HealthSmeTemplateLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.HealthSmeTemplateLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static HealthSmeTemplate addHealthSmeTemplate(
		HealthSmeTemplate healthSmeTemplate) {

		return getService().addHealthSmeTemplate(healthSmeTemplate);
	}
	 ...
	 */
	public static HealthSmeTemplate createHealthSmeTemplate(
		long healthSmeTemplateId) {

		return getService().createHealthSmeTemplate(healthSmeTemplateId);
	}
	 ...
	 */
	public static HealthSmeTemplate deleteHealthSmeTemplate(
		HealthSmeTemplate healthSmeTemplate) {

		return getService().deleteHealthSmeTemplate(healthSmeTemplate);
	}
	...
	public static HealthSmeTemplate deleteHealthSmeTemplate(
		...
		return getService().deleteHealthSmeTemplate(healthSmeTemplateId);
	}
	...
	public static HealthSmeTemplate fetchHealthSmeTemplate(
		long healthSmeTemplateId) {

		return getService().fetchHealthSmeTemplate(healthSmeTemplateId);
	}
	 ...
	 * @throws PortalException if a health sme template with the primary key could not be found
	 */
	public static HealthSmeTemplate getHealthSmeTemplate(
			long healthSmeTemplateId)
		throws PortalException {

		return getService().getHealthSmeTemplate(healthSmeTemplateId);
	}
	 ...
	 */
	public static List<HealthSmeTemplate> getHealthSmeTemplates(
		int start, int end) {

		return getService().getHealthSmeTemplates(start, end);
	}
	 ...
	 */
	public static int getHealthSmeTemplatesCount() {
		return getService().getHealthSmeTemplatesCount();
	}
	 ...
	 */
	public static HealthSmeTemplate updateHealthSmeTemplate(
		HealthSmeTemplate healthSmeTemplate) {

		return getService().updateHealthSmeTemplate(healthSmeTemplate);
	}

	public static HealthSmeTemplateLocalService getService() {
		return _service;
	}

	private static volatile HealthSmeTemplateLocalService _service;
