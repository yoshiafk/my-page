...
/**
 * The base model interface for the BenefitValueMapping service. Represents a row in the &quot;BenefitValueMapping&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.mypage.admin.product.model.impl.BenefitValueMappingModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.mypage.admin.product.model.impl.BenefitValueMappingImpl</code>.
 * </p>
 *
 * @author Gositus Team
 ...
 */
@ProviderType
public interface BenefitValueMappingModel
	extends BaseModel<BenefitValueMapping>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a benefit value mapping model instance should use the {@link BenefitValueMapping} interface instead.
	 */
