...
/**
 * Provides the local service interface for MasterCountry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see MasterCountryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MasterCountryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterCountryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the master country local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MasterCountryLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MasterCountry addMasterCountry(
	...
	public MasterCountry setActive(
			long countryId, int active, ServiceContext serviceContext)
		throws PortalException;

	public MasterCountry updateMasterCountry(
