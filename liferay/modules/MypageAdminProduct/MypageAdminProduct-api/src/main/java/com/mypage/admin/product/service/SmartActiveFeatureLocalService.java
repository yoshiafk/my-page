...
/**
 * Provides the local service interface for SmartActiveFeature. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartActiveFeatureLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartActiveFeatureLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveFeatureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart active feature local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartActiveFeatureLocalServiceUtil} if injection and service tracking are not available.
	 */
	public SmartActiveFeature addFeature(
	...
	public SmartActiveFeature setActive(
		long featureId, int active, ServiceContext serviceContext);

	public SmartActiveFeature updateFeature(
