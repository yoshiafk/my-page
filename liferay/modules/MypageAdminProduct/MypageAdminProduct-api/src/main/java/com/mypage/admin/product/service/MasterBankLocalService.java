...
/**
 * Provides the local service interface for MasterBank. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see MasterBankLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface MasterBankLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.MasterBankLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the master bank local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link MasterBankLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public MasterBank addMasterBank(
	...
	public MasterBank setActive(
			long masterBankId, int active, ServiceContext serviceContext)
		throws PortalException;

	public MasterBank updateMasterBank(
