...
/**
 * This class is used by SOAP remote services, specifically {@link com.mypage.admin.product.service.http.PremiServiceSoap}.
 *
 * @author Gositus Team
 ...
 */
@Deprecated
public class PremiSoap implements Serializable {

	public static PremiSoap toSoapModel(Premi model) {
		PremiSoap soapModel = new PremiSoap();
	...
	public static PremiSoap[] toSoapModels(Premi[] models) {
		PremiSoap[] soapModels = new PremiSoap[models.length];
	...
	public static PremiSoap[][] toSoapModels(Premi[][] models) {
		PremiSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new PremiSoap[models.length][models[0].length];
		}
		else {
			soapModels = new PremiSoap[0][0];
		}
	...
	public static PremiSoap[] toSoapModels(List<Premi> models) {
		List<PremiSoap> soapModels = new ArrayList<PremiSoap>(models.size());

		for (Premi model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new PremiSoap[soapModels.size()]);
	}
