...
/**
 * The persistence interface for the smart active feature service.
 *
 * <p>
 ...
 *
 * @author Gositus Team
 * @see SmartActiveFeatureUtil
 * @generated
 */
@ProviderType
public interface SmartActiveFeaturePersistence
	extends BasePersistence<SmartActiveFeature> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SmartActiveFeatureUtil} to access the smart active feature persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<SmartActiveFeature> smartActiveFeatures);
	...
	public SmartActiveFeature updateImpl(SmartActiveFeature smartActiveFeature);
	 ...
	 */
	public java.util.List<SmartActiveFeature> findAll();
	 ...
	 */
	public java.util.List<SmartActiveFeature> findAll(int start, int end);
	...
	public java.util.List<SmartActiveFeature> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<SmartActiveFeature>
			orderByComparator);
