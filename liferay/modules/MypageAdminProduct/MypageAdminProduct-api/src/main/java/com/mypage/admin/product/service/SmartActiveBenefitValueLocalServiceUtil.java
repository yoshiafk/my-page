...
/**
 * Provides the local service utility for SmartActiveBenefitValue. This utility wraps
 * <code>com.mypage.admin.product.service.impl.SmartActiveBenefitValueLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SmartActiveBenefitValueLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveBenefitValueLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	public static SmartActiveBenefitValue addBenefitValue(
			long value, int active)
		throws PortalException {

		return getService().addBenefitValue(value, active);
	}
	 ...
	 */
	public static SmartActiveBenefitValue addSmartActiveBenefitValue(
		SmartActiveBenefitValue smartActiveBenefitValue) {

		return getService().addSmartActiveBenefitValue(smartActiveBenefitValue);
	}
	 ...
	 */
	public static SmartActiveBenefitValue createSmartActiveBenefitValue(
		long smartActiveBenefitValueId) {

		return getService().createSmartActiveBenefitValue(
	 ...
	 */
	public static SmartActiveBenefitValue deleteSmartActiveBenefitValue(
			long smartActiveBenefitValueId)
		throws PortalException {

		return getService().deleteSmartActiveBenefitValue(
			smartActiveBenefitValueId);
	}
	...
	public static SmartActiveBenefitValue fetchSmartActiveBenefitValue(
		long smartActiveBenefitValueId) {

		return getService().fetchSmartActiveBenefitValue(
			smartActiveBenefitValueId);
	}
	...
	public static SmartActiveBenefitValue getActiveBenefitByValue(long val) {
		return getService().getActiveBenefitByValue(val);
	}

	public static List<SmartActiveBenefitValue> getActiveBenefitValue() {
		return getService().getActiveBenefitValue();
	}
	 ...
	 * @throws PortalException if a smart active benefit value with the primary key could not be found
	 */
	public static SmartActiveBenefitValue getSmartActiveBenefitValue(
			long smartActiveBenefitValueId)
		throws PortalException {

		return getService().getSmartActiveBenefitValue(
			smartActiveBenefitValueId);
	}
	 ...
	 */
	public static List<SmartActiveBenefitValue> getSmartActiveBenefitValues(
		int start, int end) {

		return getService().getSmartActiveBenefitValues(start, end);
	}
	 ...
	 */
	public static int getSmartActiveBenefitValuesCount() {
		return getService().getSmartActiveBenefitValuesCount();
	}

	public static SmartActiveBenefitValue setActive(
			long benefitValueId, int active,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().setActive(benefitValueId, active, serviceContext);
	}

	public static SmartActiveBenefitValue updateBenefitValue(
			long benefitValueId, long value, int active)
		throws PortalException {

		return getService().updateBenefitValue(benefitValueId, value, active);
	}
	 ...
	 */
	public static SmartActiveBenefitValue updateSmartActiveBenefitValue(
		SmartActiveBenefitValue smartActiveBenefitValue) {

		return getService().updateSmartActiveBenefitValue(
			smartActiveBenefitValue);
	}

	public static SmartActiveBenefitValueLocalService getService() {
		return _service;
	}

	private static volatile SmartActiveBenefitValueLocalService _service;
