...
/**
 * Provides the local service interface for SmartActiveToproBenefitMapping. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see SmartActiveToproBenefitMappingLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface SmartActiveToproBenefitMappingLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.SmartActiveToproBenefitMappingLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the smart active topro benefit mapping local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SmartActiveToproBenefitMappingLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public SmartActiveToproBenefitMapping addToproBenefitMapping(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SmartActiveToproBenefitMapping> getToproBenefitMappings(
		int start, int end);

	public SmartActiveToproBenefitMapping setActive(
	...
	public SmartActiveToproBenefitMapping updateToproBenefitMapping(
