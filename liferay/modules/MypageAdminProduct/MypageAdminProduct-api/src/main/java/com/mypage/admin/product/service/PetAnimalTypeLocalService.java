...
/**
 * Provides the local service interface for PetAnimalType. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Gositus Team
 * @see PetAnimalTypeLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface PetAnimalTypeLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.mypage.admin.product.service.impl.PetAnimalTypeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the pet animal type local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link PetAnimalTypeLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public PetAnimalType addPetAnimalType(String name, int active)
	...
	public PetAnimalType setActive(
			long petAnimalTypeId, int active, ServiceContext serviceContext)
		throws PortalException;

	public PetAnimalType updatePetAnimalType(
