...
<%
	...
	String restApiUrl = portalURL + "/o/api/sti2/step3"; ///o access from osgi, /api/sti/kyc is path api 
	String restApiOcrUrl = portalURL + "/o/api/sti2/ocr";
	String restApiProcessUrl = portalURL + "/o/api/sti2/process";
	String restApiCalculateUrl = portalURL + "/o/api/sti2/calculate";
	...
	String restApiCountriesUrl = portalURL + "/o/api/sti2/countries";
	String restApiImageUrl = portalURL + "/o/api/sti2/images";
