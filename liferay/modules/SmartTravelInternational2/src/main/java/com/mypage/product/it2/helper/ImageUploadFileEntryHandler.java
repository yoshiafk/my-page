...
public class ImageUploadFileEntryHandler implements UploadFileEntryHandler {
    ...
    protected FileEntry uploadImage(UploadPortletRequest uploadPortletRequest) throws PortalException {
        ...
        String uniqueFileName = uniqueFileNameProvider.provide(
                fileName, curFileName -> exists(themeDisplay, folderId, curFileName));
    ...
    private boolean exists(ThemeDisplay themeDisplay, long folderId, String curFileName) {
        try {
    ...
    private void validateFile(String fileName, String contentType, long size)
        ...
        long blogsImageMaxSize = IMAGE_MAX_SIZE;
    ...
    @Reference
    private UniqueFileNameProvider uniqueFileNameProvider;
}
