...
function setSessionData(_sessionName,data) {
	SessionStorage.set(_sessionName, data);
}

function getSessionData(_sessionName) {
	return SessionStorage.get(_sessionName);
}